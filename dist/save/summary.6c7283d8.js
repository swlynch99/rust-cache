var $cS8AX$os = require("os");
var $cS8AX$fs = require("fs");

"use strict";
var $9a534b3df2038504$var$__awaiter = module.exports && module.exports.__awaiter || function(thisArg, _arguments, P, generator) {
...
const { access: $9a534b3df2038504$var$access, appendFile: $9a534b3df2038504$var$appendFile, writeFile: $9a534b3df2038504$var$writeFile } = $cS8AX$fs.promises;
...
class $9a534b3df2038504$var$Summary {
    constructor(){
        this._buffer = '';
    }
    /**
     ...
     */ filePath() {
        return $9a534b3df2038504$var$__awaiter(this, void 0, void 0, function*() {
            ...
            try {
                yield $9a534b3df2038504$var$access(pathFromEnv, $cS8AX$fs.constants.R_OK | $cS8AX$fs.constants.W_OK);
            } catch (_a) {
     ...
     */ write(options) {
        return $9a534b3df2038504$var$__awaiter(this, void 0, void 0, function*() {
            ...
            const writeFunc = overwrite ? $9a534b3df2038504$var$writeFile : $9a534b3df2038504$var$appendFile;
     ...
     * @returns {Summary} summary instance
     */ addEOL() {
        return this.addRaw($cS8AX$os.EOL);
    }
    /**
...
const $9a534b3df2038504$var$_summary = new $9a534b3df2038504$var$Summary();
/**
 * @deprecated use `core.summary`
 */ module.exports.markdownSummary = $9a534b3df2038504$var$_summary;
module.exports.summary = $9a534b3df2038504$var$_summary;
