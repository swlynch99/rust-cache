var $dj2uv$os = require("os");
var $dj2uv$fs = require("fs");

"use strict";
var $d12749a46d6f1937$var$__awaiter = module.exports && module.exports.__awaiter || function(thisArg, _arguments, P, generator) {
...
const { access: $d12749a46d6f1937$var$access, appendFile: $d12749a46d6f1937$var$appendFile, writeFile: $d12749a46d6f1937$var$writeFile } = $dj2uv$fs.promises;
...
class $d12749a46d6f1937$var$Summary {
    constructor(){
        this._buffer = '';
    }
    /**
     ...
     */ filePath() {
        return $d12749a46d6f1937$var$__awaiter(this, void 0, void 0, function*() {
            ...
            try {
                yield $d12749a46d6f1937$var$access(pathFromEnv, $dj2uv$fs.constants.R_OK | $dj2uv$fs.constants.W_OK);
            } catch (_a) {
     ...
     */ write(options) {
        return $d12749a46d6f1937$var$__awaiter(this, void 0, void 0, function*() {
            ...
            const writeFunc = overwrite ? $d12749a46d6f1937$var$writeFile : $d12749a46d6f1937$var$appendFile;
     ...
     * @returns {Summary} summary instance
     */ addEOL() {
        return this.addRaw($dj2uv$os.EOL);
    }
    /**
...
const $d12749a46d6f1937$var$_summary = new $d12749a46d6f1937$var$Summary();
/**
 * @deprecated use `core.summary`
 */ module.exports.markdownSummary = $d12749a46d6f1937$var$_summary;
module.exports.summary = $d12749a46d6f1937$var$_summary;


//# sourceMappingURL=summary.4d2a0862.js.map
