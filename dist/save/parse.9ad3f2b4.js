...
var $3ae4288355919b89$var$BigNumber = null;
// regexpxs extracted from
// (c) BSD-3-Clause
// https://github.com/fastify/secure-json-parse/graphs/contributors and https://github.com/hapijs/bourne/graphs/contributors
const $3ae4288355919b89$var$suspectProtoRx = /(?:_|\\u005[Ff])(?:_|\\u005[Ff])(?:p|\\u0070)(?:r|\\u0072)(?:o|\\u006[Ff])(?:t|\\u0074)(?:o|\\u006[Ff])(?:_|\\u005[Ff])(?:_|\\u005[Ff])/;
const $3ae4288355919b89$var$suspectConstructorRx = /(?:c|\\u0063)(?:o|\\u006[Ff])(?:n|\\u006[Ee])(?:s|\\u0073)(?:t|\\u0074)(?:r|\\u0072)(?:u|\\u0075)(?:c|\\u0063)(?:t|\\u0074)(?:o|\\u006[Ff])(?:r|\\u0072)/;
...
*/ var $3ae4288355919b89$var$json_parse = function(options) {
    'use strict';
    ...
    var at, ch, escapee = {
        ...
        if (!isFinite(number)) error('Bad number');
            ...
            if ($3ae4288355919b89$var$BigNumber == null) $3ae4288355919b89$var$BigNumber = (parcelRequire("9LuBf"));
            //if (number > 9007199254740992 || number < -9007199254740992)
            // Bignumber has stricter check: everything with length > 15 digits disallowed
            if (string.length > 15) return _options.storeAsString ? string : _options.useNativeBigInt ? BigInt(string) : new $3ae4288355919b89$var$BigNumber(string);
            else return !_options.alwaysParseAsBig ? number : _options.useNativeBigInt ? BigInt(number) : new $3ae4288355919b89$var$BigNumber(number);
        }
    }, string = function() {
        ...
        if (ch === '{') {
            ...
            while(ch){
                ...
                if ($3ae4288355919b89$var$suspectProtoRx.test(key) === true) {
                ...
                } else if ($3ae4288355919b89$var$suspectConstructorRx.test(key) === true) {
...
module.exports = $3ae4288355919b89$var$json_parse;


//# sourceMappingURL=parse.9ad3f2b4.js.map
