...
var $j2DCE$fs = require("fs");
var $j2DCE$path = require("path");
var $j2DCE$util = require("util");
var $j2DCE$stream = require("stream");
var $j2DCE$url = require("url");
...
parcelRegister("eB70m", function(module, exports) {
module.exports = new URL("mime.784b9fa4.js", "file:" + __filename).toString();

});

parcelRegister("gY7q6", function(module, exports) {
module.exports = new URL("p-limit.d2bcb030.js", "file:" + __filename).toString();

});

parcelRegister("7f1zp", function(module, exports) {
module.exports = new URL("async-retry.1806164e.js", "file:" + __filename).toString();
...
var $05c1e322e19d3eba$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
...
var $05c1e322e19d3eba$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
...
var $05c1e322e19d3eba$var$__importStar = module.exports && module.exports.__importStar || function() {
    ...
    return function(mod) {
        ...
        var result = {};
        if (mod != null) {
            for(var k = ownKeys(mod), i = 0; i < k.length; i++)if (k[i] !== "default") $05c1e322e19d3eba$var$__createBinding(result, mod, k[i]);
        }
        $05c1e322e19d3eba$var$__setModuleDefault(result, mod);
        return result;
    };
}();
var $05c1e322e19d3eba$var$__importDefault = module.exports && module.exports.__importDefault || function(mod) {
...
module.exports.Bucket = module.exports.BucketExceptionMessages = module.exports.AvailableServiceObjectMethods = module.exports.BucketActionToHTTPMethod = void 0;

var $f9fHL = parcelRequire("f9fHL");

var $gHCiv = parcelRequire("gHCiv");

var $e4oRo = parcelRequire("e4oRo");

const $05c1e322e19d3eba$var$fs = $05c1e322e19d3eba$var$__importStar($j2DCE$fs);

const $05c1e322e19d3eba$var$mime_1 = $05c1e322e19d3eba$var$__importDefault((parcelRequire("eB70m")));

const $05c1e322e19d3eba$var$path = $05c1e322e19d3eba$var$__importStar($j2DCE$path);

const $05c1e322e19d3eba$var$p_limit_1 = $05c1e322e19d3eba$var$__importDefault((parcelRequire("gY7q6")));


const $05c1e322e19d3eba$var$async_retry_1 = $05c1e322e19d3eba$var$__importDefault((parcelRequire("7f1zp")));

var $dY7Uc = parcelRequire("dY7Uc");
var $80aee16ec990ff21$exports = {};
$80aee16ec990ff21$exports = new URL("acl.df1f4474.js", "file:" + __filename).toString();


var $e2d2e07be5b47906$exports = {};
$e2d2e07be5b47906$exports = new URL("file.253e2c46.js", "file:" + __filename).toString();


var $d306b8f35d041124$exports = {};
$d306b8f35d041124$exports = new URL("iam.5a6b7327.js", "file:" + __filename).toString();


var $1a2827a82064727c$exports = {};
$1a2827a82064727c$exports = new URL("notification.d63b210c.js", "file:" + __filename).toString();



var $cZVWD = parcelRequire("cZVWD");

var $j2aNq = parcelRequire("j2aNq");


var $05c1e322e19d3eba$var$BucketActionToHTTPMethod;
(function(BucketActionToHTTPMethod) {
    BucketActionToHTTPMethod["list"] = "GET";
})($05c1e322e19d3eba$var$BucketActionToHTTPMethod || (module.exports.BucketActionToHTTPMethod = $05c1e322e19d3eba$var$BucketActionToHTTPMethod = {}));
var $05c1e322e19d3eba$var$AvailableServiceObjectMethods;
...
})($05c1e322e19d3eba$var$AvailableServiceObjectMethods || (module.exports.AvailableServiceObjectMethods = $05c1e322e19d3eba$var$AvailableServiceObjectMethods = {}));
var $05c1e322e19d3eba$var$BucketExceptionMessages;
...
})($05c1e322e19d3eba$var$BucketExceptionMessages || (module.exports.BucketExceptionMessages = $05c1e322e19d3eba$var$BucketExceptionMessages = {}));
/**
 ...
 * const bucket = storage.bucket('albums');
 * ```
 */ class $05c1e322e19d3eba$var$Bucket extends $f9fHL.ServiceObject {
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    getFilesStream(query) {
        // placeholder body, overwritten in constructor
        return new $j2DCE$stream.Readable();
    }
    constructor(storage, name, options){
        ...
        this.acl = new $80aee16ec990ff21$exports.Acl({
            request: this.request.bind(this),
            pathPrefix: '/acl'
        });
        this.acl.default = new $80aee16ec990ff21$exports.Acl({
            request: this.request.bind(this),
            pathPrefix: '/defaultObjectAcl'
        });
        this.crc32cGenerator = options.crc32cGenerator || this.storage.crc32cGenerator;
        this.iam = new $d306b8f35d041124$exports.Iam(this);
        this.getFilesStream = $gHCiv.paginator.streamify('getFiles');
     ...
     * ```
     */ get cloudStorageURI() {
        const uri = new $j2DCE$url.URL('gs://');
        uri.host = this.name;
        return uri;
    }
    /**
     ...
     */ combine(sources, destination, optionsOrCallback, callback) {
        var _a;
        if (!Array.isArray(sources) || sources.length === 0) throw new Error($05c1e322e19d3eba$var$BucketExceptionMessages.PROVIDE_SOURCE_FILE);
        if (!destination) throw new Error($05c1e322e19d3eba$var$BucketExceptionMessages.DESTINATION_FILE_NOT_SPECIFIED);
        let options = {};
        if (typeof optionsOrCallback === 'function') callback = optionsOrCallback;
        else if (optionsOrCallback) options = optionsOrCallback;
        this.disableAutoRetryConditionallyIdempotent_(this.methods.setMetadata, $05c1e322e19d3eba$var$AvailableServiceObjectMethods.setMetadata, options);
        const convertToFile = (file)=>{
            if (file instanceof $e2d2e07be5b47906$exports.File) return file;
        ...
        if (!destinationFile.metadata.contentType) {
            const destinationContentType = $05c1e322e19d3eba$var$mime_1.default.getType(destinationFile.name) || undefined;
        ...
        if (options.ifGenerationMatch === undefined) Object.assign(options, destinationFile.instancePreconditionOpts, options);
     ...
     */ createChannel(id, config, optionsOrCallback, callback) {
        if (typeof id !== 'string') throw new Error($05c1e322e19d3eba$var$BucketExceptionMessages.CHANNEL_ID_REQUIRED);
        let options = {};
        if (typeof optionsOrCallback === 'function') callback = optionsOrCallback;
        else if (optionsOrCallback) options = optionsOrCallback;
        this.request({
     ...
     */ createNotification(topic, optionsOrCallback, callback) {
        ...
        if (topicIsObject && $f9fHL.util.isCustomType(topic, 'pubsub/topic')) // eslint-disable-next-line @typescript-eslint/no-explicit-any
        topic = topic.name;
        if (typeof topic !== 'string') throw new Error($05c1e322e19d3eba$var$BucketExceptionMessages.TOPIC_NAME_REQUIRED);
        ...
        this.request({
            ...
            json: (0, $dY7Uc.convertObjKeysToSnakeCase)(body),
            qs: query,
            maxRetries: 0
        }, (err, apiResponse)=>{
            if (err) {
     ...
     */ deleteFiles(queryOrCallback, callback) {
        ...
        (async ()=>{
            try {
                let promises = [];
                const limit = (0, $05c1e322e19d3eba$var$p_limit_1.default)(MAX_PARALLEL_LIMIT);
     ...
     */ deleteLabels(labelsOrCallbackOrOptions, optionsOrCallback, callback) {
        ...
        else if (typeof labelsOrCallbackOrOptions === 'string') labels = [
        ...
        const deleteLabels = (labels)=>{
            ...
            if ((options === null || options === void 0 ? void 0 : options.ifMetagenerationMatch) !== undefined) this.setLabels(nullLabelMap, options, callback);
     ...
     */ enableLogging(config, callback) {
        if (!config || typeof config === 'function' || typeof config.prefix === 'undefined') throw new Error($05c1e322e19d3eba$var$BucketExceptionMessages.CONFIGURATION_OBJECT_PREFIX_REQUIRED);
        let logBucket = this.id;
        if (config.bucket && config.bucket instanceof $05c1e322e19d3eba$var$Bucket) logBucket = config.bucket.id;
     ...
     * ```
     */ file(name, options) {
        if (!name) throw Error($05c1e322e19d3eba$var$BucketExceptionMessages.SPECIFY_FILE_NAME);
        return new $e2d2e07be5b47906$exports.File(this, name, options);
    }
    /**
     ...
     */ getFiles(queryOrCallback, callback) {
        ...
        this.request({
            ...
            let nextQuery = null;
            if (resp.nextPageToken) nextQuery = Object.assign({}, query, {
     ...
     */ getSignedUrl(cfg, callback) {
        const method = $05c1e322e19d3eba$var$BucketActionToHTTPMethod[cfg.action];
        const signConfig = {
            method: method,
            expires: cfg.expires,
            version: cfg.version,
        ...
        if (!this.signer) this.signer = new $j2aNq.URLSigner(this.storage.authClient, this, undefined, this.storage);
     ...
     */ lock(metageneration, callback) {
        ...
        if (metatype !== 'number' && metatype !== 'string') throw new Error($05c1e322e19d3eba$var$BucketExceptionMessages.METAGENERATION_NOT_PROVIDED);
        this.request({
            method: 'POST',
     ...
     */ makePrivate(optionsOrCallback, callback) {
        ...
        this.setMetadata(metadata, query, (err)=>{
            if (err) callback(err);
            const internalCall = ()=>{
                if (options.includeFiles) return (0, $j2DCE$util.promisify)(this.makeAllFilesPublicPrivate_).call(this, options);
     ...
     */ makePublic(optionsOrCallback, callback) {
        ...
        this.acl.add({
            ...
            if (req.includeFiles) return (0, $j2DCE$util.promisify)(this.makeAllFilesPublicPrivate_).call(this, req);
            return [];
     ...
     * ```
     */ notification(id) {
        if (!id) throw new Error($05c1e322e19d3eba$var$BucketExceptionMessages.SUPPLY_NOTIFICATION_ID);
        return new $1a2827a82064727c$exports.Notification(this, id);
    }
    /**
     ...
     */ setUserProject(userProject) {
        ...
        methods.forEach((method)=>{
            ...
            if (typeof methodConfig === 'object') {
                if (typeof methodConfig.reqOpts === 'object') Object.assign(methodConfig.reqOpts.qs, {
                    userProject: userProject
                });
                else methodConfig.reqOpts = {
                    qs: {
                        userProject: userProject
                    }
                };
     ...
     */ upload(pathString, optionsOrCallback, callback) {
        ...
        const upload = (numberOfRetries)=>{
            const returnValue = (0, $05c1e322e19d3eba$var$async_retry_1.default)(async (bail)=>{
                await new Promise((resolve, reject)=>{
                    ...
                    $05c1e322e19d3eba$var$fs.createReadStream(pathString).on('error', bail).pipe(writable).on('error', (err)=>{
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        if ($parcel$global['GCLOUD_SANDBOX_ENV']) return;
        ...
        let newFile;
        if (options.destination instanceof $e2d2e07be5b47906$exports.File) newFile = options.destination;
        else if (options.destination !== null && typeof options.destination === 'string') // Use the string as the name of the file.
        newFile = this.file(options.destination, {
            ...
            const destination = $05c1e322e19d3eba$var$path.basename(pathString);
    ...
    methodType, localPreconditionOptions) {
        var _a, _b;
        if (typeof coreOpts === 'object' && ((_b = (_a = coreOpts === null || coreOpts === void 0 ? void 0 : coreOpts.reqOpts) === null || _a === void 0 ? void 0 : _a.qs) === null || _b === void 0 ? void 0 : _b.ifMetagenerationMatch) === undefined && (localPreconditionOptions === null || localPreconditionOptions === void 0 ? void 0 : localPreconditionOptions.ifMetagenerationMatch) === undefined && (methodType === $05c1e322e19d3eba$var$AvailableServiceObjectMethods.setMetadata || methodType === $05c1e322e19d3eba$var$AvailableServiceObjectMethods.delete) && this.storage.retryOptions.idempotencyStrategy === $cZVWD.IdempotencyStrategy.RetryConditional) this.storage.retryOptions.autoRetry = false;
        else if (this.storage.retryOptions.idempotencyStrategy === $cZVWD.IdempotencyStrategy.RetryNever) this.storage.retryOptions.autoRetry = false;
    }
}
module.exports.Bucket = $05c1e322e19d3eba$var$Bucket;
/*! Developer Documentation
 *
 * These methods can be auto-paginated.
 */ $gHCiv.paginator.extend($05c1e322e19d3eba$var$Bucket, 'getFiles');
/*! Developer Documentation
 *
 * All async methods (except for streams) will return a Promise in the event
 * that a callback is omitted.
 */ (0, $e4oRo.promisifyAll)($05c1e322e19d3eba$var$Bucket, {
    exclude: [
        'cloudStorageURI',
        'request',
        'file',
...
//# sourceMappingURL=bucket.192ef05d.js.map
