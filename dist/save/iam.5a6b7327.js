...
module.exports.Iam = module.exports.IAMExceptionMessages = void 0;

var $e4oRo = parcelRequire("e4oRo");

var $dY7Uc = parcelRequire("dY7Uc");
var $eef4c948be998f49$var$IAMExceptionMessages;
...
})($eef4c948be998f49$var$IAMExceptionMessages || (module.exports.IAMExceptionMessages = $eef4c948be998f49$var$IAMExceptionMessages = {}));
/**
 ...
 * // bucket.iam
 * ```
 */ class $eef4c948be998f49$var$Iam {
    constructor(bucket){
     ...
     */ getPolicy(optionsOrCallback, callback) {
        const { options: options, callback: cb } = (0, $dY7Uc.normalize)(optionsOrCallback, callback);
        const qs = {};
        if (options.userProject) qs.userProject = options.userProject;
        if (options.requestedPolicyVersion !== null && options.requestedPolicyVersion !== undefined) qs.optionsRequestedPolicyVersion = options.requestedPolicyVersion;
        this.request_({
            uri: '/iam',
            qs: qs
        }, cb);
     ...
     */ setPolicy(policy, optionsOrCallback, callback) {
        if (policy === null || typeof policy !== 'object') throw new Error($eef4c948be998f49$var$IAMExceptionMessages.POLICY_OBJECT_REQUIRED);
        const { options: options, callback: cb } = (0, $dY7Uc.normalize)(optionsOrCallback, callback);
        let maxRetries;
        if (policy.etag === undefined) maxRetries = 0;
        this.request_({
            method: 'PUT',
            uri: '/iam',
     ...
     */ testPermissions(permissions, optionsOrCallback, callback) {
        if (!Array.isArray(permissions) && typeof permissions !== 'string') throw new Error($eef4c948be998f49$var$IAMExceptionMessages.PERMISSIONS_REQUIRED);
        const { options: options, callback: cb } = (0, $dY7Uc.normalize)(optionsOrCallback, callback);
...
module.exports.Iam = $eef4c948be998f49$var$Iam;
/*! Developer Documentation
 *
 * All async methods (except for streams) will return a Promise in the event
 * that a callback is omitted.
 */ (0, $e4oRo.promisifyAll)($eef4c948be998f49$var$Iam);


//# sourceMappingURL=iam.5a6b7327.js.map
