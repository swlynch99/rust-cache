...
module.exports.TeenyStatistics = module.exports.TeenyStatisticsWarning = void 0;
/**
 ...
 */ class $ca4e59744d90912b$var$TeenyStatisticsWarning extends Error {
    /**
...
module.exports.TeenyStatisticsWarning = $ca4e59744d90912b$var$TeenyStatisticsWarning;
$ca4e59744d90912b$var$TeenyStatisticsWarning.CONCURRENT_REQUESTS = 'ConcurrentRequestsExceededWarning';
/**
 ...
 */ class $ca4e59744d90912b$var$TeenyStatistics {
    /**
     ...
     */ constructor(opts){
        ...
        this._options = $ca4e59744d90912b$var$TeenyStatistics._prepareOptions(opts);
    }
    /**
     ...
     */ requestStarting() {
        ...
        if (this._options.concurrentRequests > 0 && this._concurrentRequests >= this._options.concurrentRequests && !this._didConcurrentRequestWarn) {
            ...
            const warning = new $ca4e59744d90912b$var$TeenyStatisticsWarning('Possible excessive concurrent requests detected. ' + this._concurrentRequests + ' requests in-flight, which exceeds the configured threshold of ' + this._options.concurrentRequests + '. Use the TEENY_REQUEST_WARN_CONCURRENT_REQUESTS environment ' + 'variable or the concurrentRequests option of teeny-request to ' + 'increase or disable (0) this warning.');
            warning.type = $ca4e59744d90912b$var$TeenyStatisticsWarning.CONCURRENT_REQUESTS;
     ...
     */ static _prepareOptions({ concurrentRequests: diConcurrentRequests } = {}) {
        ...
        if (diConcurrentRequests !== undefined) concurrentRequests = diConcurrentRequests;
...
module.exports.TeenyStatistics = $ca4e59744d90912b$var$TeenyStatistics;
/**
 ...
 * @readonly
 * @default 5000
 */ $ca4e59744d90912b$var$TeenyStatistics.DEFAULT_WARN_CONCURRENT_REQUESTS = 5000;


//# sourceMappingURL=TeenyStatistics.186e737b.js.map
