...
const $7d37b29f618c7d0e$var$ValidPhaseNames = new Set([
    "Deserialize",
    "Serialize",
    "Retry",
    "Sign"
 ...
 * @internal
 */ class $7d37b29f618c7d0e$var$HttpPipeline {
    ...
    addPolicy(policy, options = {}) {
        ...
        if (options.phase && !$7d37b29f618c7d0e$var$ValidPhaseNames.has(options.phase)) throw new Error(`Invalid phase name: ${options.phase}`);
        if (options.afterPhase && !$7d37b29f618c7d0e$var$ValidPhaseNames.has(options.afterPhase)) throw new Error(`Invalid afterPhase name: ${options.afterPhase}`);
        this._policies.push({
            policy: policy,
            options: options
        });
    ...
    clone() {
        return new $7d37b29f618c7d0e$var$HttpPipeline(this._policies);
    }
    static create() {
        return new $7d37b29f618c7d0e$var$HttpPipeline();
    }
    orderPolicies() {
        /**
...
function $7d37b29f618c7d0e$export$d1727d948a2aa6e7() {
    return $7d37b29f618c7d0e$var$HttpPipeline.create();
}
