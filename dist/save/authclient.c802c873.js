...
var $6vgOd$events = require("events");
...
var $eee8188db3eb69cb$exports = {};
$eee8188db3eb69cb$exports = new URL("util.3b565878.js", "file:" + __filename).toString();
...
class $32a0e5fc770a63ac$var$AuthClient extends $6vgOd$events.EventEmitter {
    constructor(opts = {}){
        var _a, _b, _c, _d, _e;
        super();
        this.credentials = {};
        ...
        const options = (0, $eee8188db3eb69cb$exports.originalOrCamelOptions)(opts);
        // Shared auth options
        ...
        this.transporter = (_d = opts.transporter) !== null && _d !== void 0 ? _d : new $1icVl.DefaultTransporter();
     ...
     * @expiremental
     */ get gaxios() {
        if (this.transporter instanceof $47hCt.Gaxios) return this.transporter;
        else if (this.transporter instanceof $1icVl.DefaultTransporter) return this.transporter.instance;
        else if ('instance' in this.transporter && this.transporter.instance instanceof $47hCt.Gaxios) return this.transporter.instance;
        return null;
    }
    /**
...
module.exports.AuthClient = $32a0e5fc770a63ac$var$AuthClient;


//# sourceMappingURL=authclient.c802c873.js.map
