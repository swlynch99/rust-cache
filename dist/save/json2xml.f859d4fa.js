require("./orderedJs2Xml.48616245.js");
...
'use strict';
var $d6fd956ec6614542$exports = {};
$d6fd956ec6614542$exports = new URL("orderedJs2Xml.48616245.js", "file:" + __filename).toString();



var $hfDCX = parcelRequire("hfDCX");
const $0cd87438cf40dd00$var$defaultOptions = {
...
function $0cd87438cf40dd00$var$Builder(options) {
    this.options = Object.assign({}, $0cd87438cf40dd00$var$defaultOptions, options);
    if (this.options.ignoreAttributes === true || this.options.attributesGroupName) this.isAttribute = function() {
        return false;
    };
    else {
        this.ignoreAttributesFn = $hfDCX(this.options.ignoreAttributes);
        this.attrPrefixLen = this.options.attributeNamePrefix.length;
        this.isAttribute = $0cd87438cf40dd00$var$isAttribute;
    }
    this.processTextOrObjNode = $0cd87438cf40dd00$var$processTextOrObjNode;
    if (this.options.format) {
        this.indentate = $0cd87438cf40dd00$var$indentate;
        this.tagEndChar = '>\n';
        this.newLine = '\n';
    } else {
...
$0cd87438cf40dd00$var$Builder.prototype.build = function(jObj) {
    if (this.options.preserveOrder) return $d6fd956ec6614542$exports(jObj, this.options);
    else {
...
$0cd87438cf40dd00$var$Builder.prototype.j2x = function(jObj, level, ajPath) {
    let attrStr = '';
    let val = '';
...
$0cd87438cf40dd00$var$Builder.prototype.buildAttrPairStr = function(attrName, val) {
    val = this.options.attributeValueProcessor(attrName, '' + val);
    val = this.replaceEntitiesValue(val);
    if (this.options.suppressBooleanAttributes && val === "true") return ' ' + attrName;
    else return ' ' + attrName + '="' + val + '"';
};
function $0cd87438cf40dd00$var$processTextOrObjNode(object, key, level, ajPath) {
...
$0cd87438cf40dd00$var$Builder.prototype.buildObjectNode = function(val, key, attrStr, level) {
    if (val === "") {
...
$0cd87438cf40dd00$var$Builder.prototype.closeTag = function(key) {
    let closeTag = "";
...
function $0cd87438cf40dd00$var$buildEmptyObjNode(val, key, attrStr, level) {
...
$0cd87438cf40dd00$var$Builder.prototype.buildTextValNode = function(val, key, attrStr, level) {
...
$0cd87438cf40dd00$var$Builder.prototype.replaceEntitiesValue = function(textValue) {
...
function $0cd87438cf40dd00$var$indentate(level) {
    return this.options.indentBy.repeat(level);
}
function $0cd87438cf40dd00$var$isAttribute(name /*, options*/ ) {
    if (name.startsWith(this.options.attributeNamePrefix) && name !== this.options.textNodeName) return name.substr(this.attrPrefixLen);
    else return false;
}
module.exports = $0cd87438cf40dd00$var$Builder;


//# sourceMappingURL=json2xml.f859d4fa.js.map
