...
var $9f64c838e61b3134$var$BigNumber = null;
// regexpxs extracted from
// (c) BSD-3-Clause
// https://github.com/fastify/secure-json-parse/graphs/contributors and https://github.com/hapijs/bourne/graphs/contributors
const $9f64c838e61b3134$var$suspectProtoRx = /(?:_|\\u005[Ff])(?:_|\\u005[Ff])(?:p|\\u0070)(?:r|\\u0072)(?:o|\\u006[Ff])(?:t|\\u0074)(?:o|\\u006[Ff])(?:_|\\u005[Ff])(?:_|\\u005[Ff])/;
const $9f64c838e61b3134$var$suspectConstructorRx = /(?:c|\\u0063)(?:o|\\u006[Ff])(?:n|\\u006[Ee])(?:s|\\u0073)(?:t|\\u0074)(?:r|\\u0072)(?:u|\\u0075)(?:c|\\u0063)(?:t|\\u0074)(?:o|\\u006[Ff])(?:r|\\u0072)/;
...
*/ var $9f64c838e61b3134$var$json_parse = function(options) {
    'use strict';
    ...
    var at, ch, escapee = {
        ...
        if (!isFinite(number)) error('Bad number');
            ...
            if ($9f64c838e61b3134$var$BigNumber == null) $9f64c838e61b3134$var$BigNumber = (parcelRequire("6rhFz"));
            //if (number > 9007199254740992 || number < -9007199254740992)
            // Bignumber has stricter check: everything with length > 15 digits disallowed
            if (string.length > 15) return _options.storeAsString ? string : _options.useNativeBigInt ? BigInt(string) : new $9f64c838e61b3134$var$BigNumber(string);
            else return !_options.alwaysParseAsBig ? number : _options.useNativeBigInt ? BigInt(number) : new $9f64c838e61b3134$var$BigNumber(number);
        }
    }, string = function() {
        ...
        if (ch === '{') {
            ...
            while(ch){
                ...
                if ($9f64c838e61b3134$var$suspectProtoRx.test(key) === true) {
                ...
                } else if ($9f64c838e61b3134$var$suspectConstructorRx.test(key) === true) {
...
module.exports = $9f64c838e61b3134$var$json_parse;
