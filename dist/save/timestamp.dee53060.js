...
class $7f729a75cde9bf8e$var$Timestamp$Type extends $8iddM.MessageType {
    constructor(){
     ...
     */ now() {
        ...
        const ms = Date.now();
        msg.seconds = $eCO4F.PbLong.from(Math.floor(ms / 1000)).toString();
     ...
     */ toDate(message) {
        return new Date($eCO4F.PbLong.from(message.seconds).toNumber() * 1000 + Math.ceil(message.nanos / 1000000));
    }
    /**
     ...
     */ internalJsonWrite(message, options) {
        let ms = $eCO4F.PbLong.from(message.seconds).toNumber() * 1000;
     ...
     */ internalJsonRead(json, options, target) {
        if (typeof json !== "string") throw new Error("Unable to parse Timestamp from JSON " + (0, $7nPm8.typeofJsonValue)(json) + ".");
        ...
        target.seconds = $eCO4F.PbLong.from(ms / 1000).toString();
        target.nanos = 0;
    ...
    internalBinaryWrite(message, writer, options) {
        /* int64 seconds = 1; */ if (message.seconds !== "0") writer.tag(1, $6pQ37.WireType.Varint).int64(message.seconds);
        /* int32 nanos = 2; */ if (message.nanos !== 0) writer.tag(2, $6pQ37.WireType.Varint).int32(message.nanos);
 ...
 */ module.exports.Timestamp = new $7f729a75cde9bf8e$var$Timestamp$Type();
