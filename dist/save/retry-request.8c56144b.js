...
var $l3jw1$stream = require("stream");
...
parcelRegister("3VYXM", function(module, exports) {
'use strict';

var $2dd5fc01dc50cd7c$require$PassThrough = $l3jw1$stream.PassThrough;

var $ehr3Q = parcelRequire("ehr3Q");
let $2dd5fc01dc50cd7c$var$debug = ()=>{};
if (typeof process !== 'undefined' && 'env' in process && typeof process.env === 'object' && process.env.DEBUG === 'retry-request') $2dd5fc01dc50cd7c$var$debug = (message)=>{
    console.log('retry-request:', message);
};
const $2dd5fc01dc50cd7c$var$DEFAULTS = {
    objectMode: false,
    retries: 2,
    /*
  ...
  */ retryDelayMultiplier: 2,
   ...
   */ totalTimeout: 600,
    ...
    shouldRetryFn: function(response) {
        ...
        $2dd5fc01dc50cd7c$var$debug(`Response status: ${statusCode}`);
        let range;
...
function $2dd5fc01dc50cd7c$var$retryRequest(requestOpts, opts, callback) {
    ...
    opts = $ehr3Q({}, $2dd5fc01dc50cd7c$var$DEFAULTS, opts);
    ...
    if (streamMode) {
        retryStream = new $2dd5fc01dc50cd7c$require$PassThrough({
    ...
    function makeRequest() {
        ...
        currentRetryAttempt++;
        $2dd5fc01dc50cd7c$var$debug(`Current retry attempt: ${currentRetryAttempt}`);
        ...
        if (streamMode) {
            ...
            delayStream = new $2dd5fc01dc50cd7c$require$PassThrough({
                objectMode: opts.objectMode
            });
    ...
    function retryAfterDelay(currentRetryAttempt) {
        ...
        const nextRetryDelay = $2dd5fc01dc50cd7c$var$getNextRetryDelay({
        ...
        $2dd5fc01dc50cd7c$var$debug(`Next retry delay: ${nextRetryDelay}`);
        if (nextRetryDelay <= 0) {
...
module.exports = $2dd5fc01dc50cd7c$var$retryRequest;
function $2dd5fc01dc50cd7c$var$getNextRetryDelay(config) {
...
module.exports.defaults = $2dd5fc01dc50cd7c$var$DEFAULTS;
module.exports.getNextRetryDelay = $2dd5fc01dc50cd7c$var$getNextRetryDelay;

});


//# sourceMappingURL=retry-request.8c56144b.js.map
