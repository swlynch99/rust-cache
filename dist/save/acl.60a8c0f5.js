 ...
 *
 * @private
 */ class $c2e69a8a9acffc38$var$AclRoleAccessorMethods {
    constructor(){
        this.owners = {};
        this.readers = {};
        this.writers = {};
         ...
         * ```
         */ this.writers = {};
        $c2e69a8a9acffc38$var$AclRoleAccessorMethods.roles.forEach(this._assignAccessMethods.bind(this));
    }
    _assignAccessMethods(role) {
        const accessMethods = $c2e69a8a9acffc38$var$AclRoleAccessorMethods.accessMethods;
        const entities = $c2e69a8a9acffc38$var$AclRoleAccessorMethods.entities;
...
module.exports.AclRoleAccessorMethods = $c2e69a8a9acffc38$var$AclRoleAccessorMethods;
$c2e69a8a9acffc38$var$AclRoleAccessorMethods.accessMethods = [
    'add',
    'delete'
];
$c2e69a8a9acffc38$var$AclRoleAccessorMethods.entities = [
...
$c2e69a8a9acffc38$var$AclRoleAccessorMethods.roles = [
    'OWNER',
    'READER',
    'WRITER'
];
 ...
 */ class $c2e69a8a9acffc38$var$Acl extends $c2e69a8a9acffc38$var$AclRoleAccessorMethods {
    constructor(options){
        super();
...
module.exports.Acl = $c2e69a8a9acffc38$var$Acl;
/*! Developer Documentation
 *
 * All async methods (except for streams) will return a Promise in the event
 * that a callback is omitted.
 */ (0, $gt46O.promisifyAll)($c2e69a8a9acffc38$var$Acl, {
    exclude: [
        'request'
    ]
});
