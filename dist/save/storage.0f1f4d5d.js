...
var $5oWAf$stream = require("stream");
...
var $b5d009cfbac0587d$exports = {};
$b5d009cfbac0587d$exports = new URL("build.06bd9a2b.js", "file:" + __filename).toString();



var $e4oRo = parcelRequire("e4oRo");

var $879c44646e097ca0$exports = {};
$879c44646e097ca0$exports = new URL("bucket.192ef05d.js", "file:" + __filename).toString();


var $59f107dc62564c25$exports = {};
$59f107dc62564c25$exports = new URL("channel.005bed05.js", "file:" + __filename).toString();
...
var $bf39d0a2d471cd55$exports = {};
$bf39d0a2d471cd55$exports = new URL("hmacKey.0bf705b9.js", "file:" + __filename).toString();
...
var $976821242ca44b0a$var$IdempotencyStrategy;
...
})($976821242ca44b0a$var$IdempotencyStrategy || (module.exports.IdempotencyStrategy = $976821242ca44b0a$var$IdempotencyStrategy = {}));
var $976821242ca44b0a$var$ExceptionMessages;
...
})($976821242ca44b0a$var$ExceptionMessages || (module.exports.ExceptionMessages = $976821242ca44b0a$var$ExceptionMessages = {}));
var $976821242ca44b0a$var$StorageExceptionMessages;
...
})($976821242ca44b0a$var$StorageExceptionMessages || (module.exports.StorageExceptionMessages = $976821242ca44b0a$var$StorageExceptionMessages = {}));
 ...
 * @const {enum}
 * @private
 */ const $976821242ca44b0a$var$IDEMPOTENCY_STRATEGY_DEFAULT = $976821242ca44b0a$var$IdempotencyStrategy.RetryConditional;
/**
 ...
 */ const $976821242ca44b0a$var$RETRYABLE_ERR_FN_DEFAULT = function(err) {
    var _a;
...
module.exports.RETRYABLE_ERR_FN_DEFAULT = $976821242ca44b0a$var$RETRYABLE_ERR_FN_DEFAULT;
 ...
 *
 * @class
 */ class $976821242ca44b0a$var$Storage extends $f9fHL.Service {
    getBucketsStream() {
        // placeholder body, overwritten in constructor
        return new $5oWAf$stream.Readable();
    }
    getHmacKeysStream() {
        // placeholder body, overwritten in constructor
        return new $5oWAf$stream.Readable();
     ...
     */ constructor(options = {}){
        ...
        const universe = options.universeDomain || $4gMhs.DEFAULT_UNIVERSE;
        let apiEndpoint = `https://storage.${universe}`;
        let customEndpoint = false;
        // Note: EMULATOR_HOST is an experimental configuration variable. Use apiEndpoint instead.
        const EMULATOR_HOST = process.env.STORAGE_EMULATOR_HOST;
        if (typeof EMULATOR_HOST === 'string') {
            apiEndpoint = $976821242ca44b0a$var$Storage.sanitizeEndpoint(EMULATOR_HOST);
            customEndpoint = true;
        }
        if (options.apiEndpoint && options.apiEndpoint !== apiEndpoint) {
            apiEndpoint = $976821242ca44b0a$var$Storage.sanitizeEndpoint(options.apiEndpoint);
            customEndpoint = true;
        }
        ...
        const config = {
            ...
            retryOptions: {
                ...
                idempotencyStrategy: ((_o = options.retryOptions) === null || _o === void 0 ? void 0 : _o.idempotencyStrategy) !== undefined ? (_p = options.retryOptions) === null || _p === void 0 ? void 0 : _p.idempotencyStrategy : $976821242ca44b0a$var$IDEMPOTENCY_STRATEGY_DEFAULT
            },
            baseUrl: baseUrl,
            ...
            packageJson: (0, $7OYF7.getPackageJSON)()
        };
         ...
         * @name Storage#acl
         * @see Storage.acl
         */ this.acl = $976821242ca44b0a$var$Storage.acl;
        this.crc32cGenerator = options.crc32cGenerator || $jL9jF.CRC32C_DEFAULT_VALIDATOR_GENERATOR;
        this.retryOptions = config.retryOptions;
        this.getBucketsStream = $b5d009cfbac0587d$exports.paginator.streamify('getBuckets');
        this.getHmacKeysStream = $b5d009cfbac0587d$exports.paginator.streamify('getHmacKeys');
    }
     ...
     * ```
     */ bucket(name, options) {
        if (!name) throw new Error($976821242ca44b0a$var$StorageExceptionMessages.BUCKET_NAME_REQUIRED);
        return new $879c44646e097ca0$exports.Bucket(this, name, options);
    }
    /**
     ...
     */ channel(id, resourceId) {
        return new $59f107dc62564c25$exports.Channel(this, id, resourceId);
    }
    /**
     ...
     */ createBucket(name, metadataOrCallback, callback) {
        if (!name) throw new Error($976821242ca44b0a$var$StorageExceptionMessages.BUCKET_NAME_REQUIRED_CREATE);
        let metadata;
        if (!callback) {
     ...
     */ createHmacKey(serviceAccountEmail, optionsOrCb, cb) {
        if (typeof serviceAccountEmail !== 'string') throw new Error($976821242ca44b0a$var$StorageExceptionMessages.HMAC_SERVICE_ACCOUNT);
        const { options: options, callback: callback } = (0, $dY7Uc.normalize)(optionsOrCb, cb);
     ...
     */ getBuckets(optionsOrCallback, cb) {
        const { options: options, callback: callback } = (0, $dY7Uc.normalize)(optionsOrCallback, cb);
     ...
     */ hmacKey(accessId, options) {
        if (!accessId) throw new Error($976821242ca44b0a$var$StorageExceptionMessages.HMAC_ACCESS_ID);
        return new $bf39d0a2d471cd55$exports.HmacKey(this, accessId, options);
    }
}
module.exports.Storage = $976821242ca44b0a$var$Storage;
/**
 * {@link Bucket} class.
 *
 * @name Storage.Bucket
 * @see Bucket
 * @type {Constructor}
 */ $976821242ca44b0a$var$Storage.Bucket = $879c44646e097ca0$exports.Bucket;
/**
 * {@link Channel} class.
 *
 ...
 * @see Channel
 * @type {Constructor}
 */ $976821242ca44b0a$var$Storage.Channel = $59f107dc62564c25$exports.Channel;
/**
 * {@link File} class.
 *
 * @name Storage.File
 * @see File
 * @type {Constructor}
 */ $976821242ca44b0a$var$Storage.File = $lJUcF.File;
/**
 * {@link HmacKey} class.
 *
 ...
 * @see HmacKey
 * @type {Constructor}
 */ $976821242ca44b0a$var$Storage.HmacKey = $bf39d0a2d471cd55$exports.HmacKey;
$976821242ca44b0a$var$Storage.acl = {
    OWNER_ROLE: 'OWNER',
    READER_ROLE: 'READER',
    WRITER_ROLE: 'WRITER'
};
 ...
 */ $b5d009cfbac0587d$exports.paginator.extend($976821242ca44b0a$var$Storage, [
    'getBuckets',
    'getHmacKeys'
]);
/*! Developer Documentation
 ...
 */ (0, $e4oRo.promisifyAll)($976821242ca44b0a$var$Storage, {
    exclude: [
        'bucket',
        'channel',
        'hmacKey'
...
//# sourceMappingURL=storage.0f1f4d5d.js.map
