...
module.exports.JWTAccess = void 0;

var $jIFtH = parcelRequire("jIFtH");

var $7miiN = parcelRequire("7miiN");
const $115002c35d0d9c9f$var$DEFAULT_HEADER = {
    alg: 'RS256',
    typ: 'JWT'
};
class $115002c35d0d9c9f$var$JWTAccess {
    /**
     ...
     */ constructor(email, key, keyId, eagerRefreshThresholdMillis){
        ...
        this.key = key;
        this.keyId = keyId;
        this.eagerRefreshThresholdMillis = eagerRefreshThresholdMillis !== null && eagerRefreshThresholdMillis !== void 0 ? eagerRefreshThresholdMillis : 300000;
    }
    /**
     ...
     */ getRequestHeaders(url, additionalClaims, scopes) {
        ...
        const exp = $115002c35d0d9c9f$var$JWTAccess.getExpirationTime(iat);
        let defaultClaims;
        ...
        if (additionalClaims) for(const claim in defaultClaims){
            if (additionalClaims[claim]) throw new Error(`The '${claim}' property is not allowed when passing additionalClaims. This claim is included in the JWT by default.`);
        }
        const header = this.keyId ? {
            ...$115002c35d0d9c9f$var$DEFAULT_HEADER,
            kid: this.keyId
        } : $115002c35d0d9c9f$var$DEFAULT_HEADER;
        const payload = Object.assign(defaultClaims, additionalClaims);
        // Sign the jwt and add it to the cache
        const signedJWT = $jIFtH.sign({
            header: header,
            payload: payload,
            secret: this.key
        });
...
module.exports.JWTAccess = $115002c35d0d9c9f$var$JWTAccess;


//# sourceMappingURL=jwtaccess.d32d1331.js.map
