var $5MWQi$nodeevents = require("node:events");
var $5MWQi$nodeutil = require("node:util");

'use strict';

var $8090b55949deebbd$require$EventEmitter = $5MWQi$nodeevents.EventEmitter;

var $8090b55949deebbd$require$inherits = $5MWQi$nodeutil.inherits;
function $8090b55949deebbd$var$SBMH(needle) {
...
$8090b55949deebbd$require$inherits($8090b55949deebbd$var$SBMH, $8090b55949deebbd$require$EventEmitter);
$8090b55949deebbd$var$SBMH.prototype.reset = function() {
    this._lookbehind_size = 0;
    this.matches = 0;
    this._bufpos = 0;
};
$8090b55949deebbd$var$SBMH.prototype.push = function(chunk, pos) {
...
$8090b55949deebbd$var$SBMH.prototype._sbmh_feed = function(data) {
...
$8090b55949deebbd$var$SBMH.prototype._sbmh_lookup_char = function(data, pos) {
    return pos < 0 ? this._lookbehind[this._lookbehind_size + pos] : data[pos];
};
$8090b55949deebbd$var$SBMH.prototype._sbmh_memcmp = function(data, pos, len) {
    for(var i = 0; i < len; ++i){
        if (this._sbmh_lookup_char(data, pos + i) !== this._needle[i]) return false;
    }
    return true;
};
module.exports = $8090b55949deebbd$var$SBMH;
