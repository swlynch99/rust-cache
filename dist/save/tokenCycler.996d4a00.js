...
const $cdfb6d73a8bbd66d$export$52bca39539a4d010 = {
 ...
 */ async function $cdfb6d73a8bbd66d$var$beginRefresh(getAccessToken, retryIntervalInMs, refreshTimeout) {
    ...
    while(token === null){
        await (0, $aRMMH.delay)(retryIntervalInMs);
        token = await tryGetAccessToken();
    }
    return token;
}
function $cdfb6d73a8bbd66d$export$95b8567f1f70eca(credential, tokenCyclerOptions) {
    let refreshWorker = null;
    let token = null;
    let tenantId;
    const options = Object.assign(Object.assign({}, $cdfb6d73a8bbd66d$export$52bca39539a4d010), tokenCyclerOptions);
    /**
     ...
     */ function refresh(scopes, getTokenOptions) {
        ...
        if (!cycler.isRefreshing) {
            ...
            refreshWorker = $cdfb6d73a8bbd66d$var$beginRefresh(tryGetAccessToken, options.retryIntervalInMs, // If we don't have a token, then we should timeout immediately
...
//# sourceMappingURL=tokenCycler.996d4a00.js.map
