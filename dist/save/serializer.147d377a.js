...
parcelRegister("8ZqUD", function(module, exports) {
module.exports = new URL("base64.69432b39.js", "file:" + __filename).toString();
...
module.exports.MapperTypeNames = module.exports.createSerializer = void 0;

var $7PS2Y = parcelRequire("7PS2Y");

const $b3f39cc1daade20f$var$base64 = $7PS2Y.__importStar((parcelRequire("8ZqUD")));
var $56ed367df77acd67$exports = {};
$56ed367df77acd67$exports = new URL("interfaces.bb5077b3.js", "file:" + __filename).toString();


var $380bbf154a1c25b0$exports = {};
$380bbf154a1c25b0$exports = new URL("utils.29a29b51.js", "file:" + __filename).toString();


class $b3f39cc1daade20f$var$SerializerImpl {
     ...
     */ serialize(mapper, object, objectName, options = {
        ...
        const updatedOptions = {
            xml: {
                ...
                xmlCharKey: (_c = options.xml.xmlCharKey) !== null && _c !== void 0 ? _c : $56ed367df77acd67$exports.XML_CHARKEY
            }
        };
        let payload = {};
        ...
        if (object === undefined || object === null) payload = object;
            ...
            else if (mapperType.match(/^(Number|String|Boolean|Object|Stream|Uuid)$/i) !== null) payload = $b3f39cc1daade20f$var$serializeBasicTypes(mapperType, objectName, object);
            else if (mapperType.match(/^Enum$/i) !== null) {
                const enumMapper = mapper;
                payload = $b3f39cc1daade20f$var$serializeEnumType(objectName, enumMapper.type.allowedValues, object);
            } else if (mapperType.match(/^(Date|DateTime|TimeSpan|DateTimeRfc1123|UnixTime)$/i) !== null) payload = $b3f39cc1daade20f$var$serializeDateTypes(mapperType, object, objectName);
            else if (mapperType.match(/^ByteArray$/i) !== null) payload = $b3f39cc1daade20f$var$serializeByteArrayType(objectName, object);
            else if (mapperType.match(/^Base64Url$/i) !== null) payload = $b3f39cc1daade20f$var$serializeBase64UrlType(objectName, object);
            else if (mapperType.match(/^Sequence$/i) !== null) payload = $b3f39cc1daade20f$var$serializeSequenceType(this, mapper, object, objectName, Boolean(this.isXML), updatedOptions);
            else if (mapperType.match(/^Dictionary$/i) !== null) payload = $b3f39cc1daade20f$var$serializeDictionaryType(this, mapper, object, objectName, Boolean(this.isXML), updatedOptions);
            else if (mapperType.match(/^Composite$/i) !== null) payload = $b3f39cc1daade20f$var$serializeCompositeType(this, mapper, object, objectName, Boolean(this.isXML), updatedOptions);
        }
        return payload;
    }
    /**
     ...
     */ deserialize(mapper, responseBody, objectName, options = {
        ...
        const mapperType = mapper.type.name;
        if (!objectName) objectName = mapper.serializedName;
        if (mapperType.match(/^Composite$/i) !== null) payload = $b3f39cc1daade20f$var$deserializeCompositeType(this, mapper, responseBody, objectName, updatedOptions);
        else {
            if (this.isXML) {
                 ...
                 */ if (responseBody[$56ed367df77acd67$exports.XML_ATTRKEY] !== undefined && responseBody[xmlCharKey] !== undefined) responseBody = responseBody[xmlCharKey];
            }
            ...
            else if (mapperType.match(/^UnixTime$/i) !== null) payload = $b3f39cc1daade20f$var$unixTimeToDate(responseBody);
            else if (mapperType.match(/^ByteArray$/i) !== null) payload = $b3f39cc1daade20f$var$base64.decodeString(responseBody);
            else if (mapperType.match(/^Base64Url$/i) !== null) payload = $b3f39cc1daade20f$var$base64UrlToByteArray(responseBody);
            else if (mapperType.match(/^Sequence$/i) !== null) payload = $b3f39cc1daade20f$var$deserializeSequenceType(this, mapper, responseBody, objectName, updatedOptions);
            else if (mapperType.match(/^Dictionary$/i) !== null) payload = $b3f39cc1daade20f$var$deserializeDictionaryType(this, mapper, responseBody, objectName, updatedOptions);
        }
 ...
 */ function $b3f39cc1daade20f$var$createSerializer(modelMappers = {}, isXML = false) {
    return new $b3f39cc1daade20f$var$SerializerImpl(modelMappers, isXML);
}
module.exports.createSerializer = $b3f39cc1daade20f$var$createSerializer;
function $b3f39cc1daade20f$var$trimEnd(str, ch) {
    let len = str.length;
    while(len - 1 >= 0 && str[len - 1] === ch)--len;
    return str.substr(0, len);
}
function $b3f39cc1daade20f$var$bufferToBase64Url(buffer) {
    ...
    const str = $b3f39cc1daade20f$var$base64.encodeByteArray(buffer);
    // Base64 to Base64Url.
    return $b3f39cc1daade20f$var$trimEnd(str, "=").replace(/\+/g, "-").replace(/\//g, "_");
}
function $b3f39cc1daade20f$var$base64UrlToByteArray(str) {
    ...
    return $b3f39cc1daade20f$var$base64.decodeString(str);
}
function $b3f39cc1daade20f$var$splitSerializeName(prop) {
    const classes = [];
    let partialclass = "";
    if (prop) {
...
function $b3f39cc1daade20f$var$dateToUnixTime(d) {
    if (!d) return undefined;
    if (typeof d.valueOf() === "string") d = new Date(d);
    return Math.floor(d.getTime() / 1000);
}
function $b3f39cc1daade20f$var$unixTimeToDate(n) {
    if (!n) return undefined;
    return new Date(n * 1000);
}
function $b3f39cc1daade20f$var$serializeBasicTypes(typeName, objectName, value) {
    if (value !== null && value !== undefined) {
        if (typeName.match(/^Number$/i) !== null) {
            ...
            if (!(typeof value.valueOf() === "string" && (0, $380bbf154a1c25b0$exports.isValidUuid)(value))) throw new Error(`${objectName} with value "${value}" must be of type string and a valid uuid.`);
...
function $b3f39cc1daade20f$var$serializeEnumType(objectName, allowedValues, value) {
...
function $b3f39cc1daade20f$var$serializeByteArrayType(objectName, value) {
    if (value !== undefined && value !== null) {
        if (!(value instanceof Uint8Array)) throw new Error(`${objectName} must be of type Uint8Array.`);
        value = $b3f39cc1daade20f$var$base64.encodeByteArray(value);
    }
    return value;
}
function $b3f39cc1daade20f$var$serializeBase64UrlType(objectName, value) {
    if (value !== undefined && value !== null) {
        if (!(value instanceof Uint8Array)) throw new Error(`${objectName} must be of type Uint8Array.`);
        value = $b3f39cc1daade20f$var$bufferToBase64Url(value);
    }
    return value;
}
function $b3f39cc1daade20f$var$serializeDateTypes(typeName, value, objectName) {
    if (value !== undefined && value !== null) {
        if (typeName.match(/^Date$/i) !== null) {
            ...
            value = $b3f39cc1daade20f$var$dateToUnixTime(value);
        } else if (typeName.match(/^TimeSpan$/i) !== null) {
            if (!(0, $380bbf154a1c25b0$exports.isDuration)(value)) throw new Error(`${objectName} must be a string in ISO 8601 format. Instead was "${value}".`);
        }
    }
    return value;
}
function $b3f39cc1daade20f$var$serializeSequenceType(serializer, mapper, object, objectName, isXml, options) {
    var _a;
    ...
    for(let i = 0; i < object.length; i++){
        ...
        if (isXml && elementType.xmlNamespace) {
            ...
            if (elementType.type.name === "Composite") {
                ...
                tempArray[i][$56ed367df77acd67$exports.XML_ATTRKEY] = {
...
function $b3f39cc1daade20f$var$serializeDictionaryType(serializer, mapper, object, objectName, isXml, options) {
    ...
    for (const key of Object.keys(object)){
        ...
        tempDictionary[key] = $b3f39cc1daade20f$var$getXmlObjectValue(valueType, serializedValue, isXml, options);
    }
    // Add the namespace to the root element if needed
    if (isXml && mapper.xmlNamespace) {
        const xmlnsKey = mapper.xmlNamespacePrefix ? `xmlns:${mapper.xmlNamespacePrefix}` : "xmlns";
        const result = tempDictionary;
        result[$56ed367df77acd67$exports.XML_ATTRKEY] = {
 ...
 */ function $b3f39cc1daade20f$var$resolveAdditionalProperties(serializer, mapper, objectName) {
    const additionalProperties = mapper.type.additionalProperties;
    if (!additionalProperties && mapper.type.className) {
        const modelMapper = $b3f39cc1daade20f$var$resolveReferencedMapper(serializer, mapper, objectName);
 ...
 * @param mapper - the composite mapper to resolve
 * @param objectName - name of the object being serialized
 */ function $b3f39cc1daade20f$var$resolveReferencedMapper(serializer, mapper, objectName) {
 ...
 * @param serializer - the serializer containing the entire set of mappers
 * @param mapper - the composite mapper to resolve
 */ function $b3f39cc1daade20f$var$resolveModelProperties(serializer, mapper, objectName) {
...
function $b3f39cc1daade20f$var$serializeCompositeType(serializer, mapper, object, objectName, isXml, options) {
    if ($b3f39cc1daade20f$var$getPolymorphicDiscriminatorRecursively(serializer, mapper)) mapper = $b3f39cc1daade20f$var$getPolymorphicMapper(serializer, mapper, object, "clientName");
    if (object !== undefined && object !== null) {
        const payload = {};
        const modelProps = $b3f39cc1daade20f$var$resolveModelProperties(serializer, mapper, objectName);
        for (const key of Object.keys(modelProps)){
            ...
            if (serializer.isXML) {
                ...
                const paths = $b3f39cc1daade20f$var$splitSerializeName(propertyMapper.serializedName);
                propName = paths.pop();
            ...
            if (parentObject !== undefined && parentObject !== null) {
                if (isXml && mapper.xmlNamespace) {
                    const xmlnsKey = mapper.xmlNamespacePrefix ? `xmlns:${mapper.xmlNamespacePrefix}` : "xmlns";
                    parentObject[$56ed367df77acd67$exports.XML_ATTRKEY] = Object.assign(Object.assign({}, parentObject[$56ed367df77acd67$exports.XML_ATTRKEY]), {
                        [xmlnsKey]: mapper.xmlNamespace
                    });
                }
                const propertyObjectName = propertyMapper.serializedName !== "" ? objectName + "." + propertyMapper.serializedName : objectName;
                let toSerialize = object[key];
                const polymorphicDiscriminator = $b3f39cc1daade20f$var$getPolymorphicDiscriminatorRecursively(serializer, mapper);
                ...
                if (serializedValue !== undefined && propName !== undefined && propName !== null) {
                    const value = $b3f39cc1daade20f$var$getXmlObjectValue(propertyMapper, serializedValue, isXml, options);
                    if (isXml && propertyMapper.xmlIsAttribute) {
                        // XML_ATTRKEY, i.e., $ is the key attributes are kept under in xml2js.
                        // This keeps things simple while preventing name collision
                        // with names in user documents.
                        parentObject[$56ed367df77acd67$exports.XML_ATTRKEY] = parentObject[$56ed367df77acd67$exports.XML_ATTRKEY] || {};
                        parentObject[$56ed367df77acd67$exports.XML_ATTRKEY][propName] = serializedValue;
        ...
        const additionalPropertiesMapper = $b3f39cc1daade20f$var$resolveAdditionalProperties(serializer, mapper, objectName);
...
function $b3f39cc1daade20f$var$getXmlObjectValue(propertyMapper, serializedValue, isXml, options) {
    ...
    if ([
        ...
        if (serializedValue[$56ed367df77acd67$exports.XML_ATTRKEY]) return serializedValue;
        else {
            const result = Object.assign({}, serializedValue);
            result[$56ed367df77acd67$exports.XML_ATTRKEY] = xmlNamespace;
            return result;
        }
    }
    const result = {};
...
function $b3f39cc1daade20f$var$isSpecialXmlProperty(propertyName, options) {
    return [
        $56ed367df77acd67$exports.XML_ATTRKEY,
        options.xml.xmlCharKey
    ].includes(propertyName);
}
function $b3f39cc1daade20f$var$deserializeCompositeType(serializer, mapper, responseBody, objectName, options) {
    var _a, _b;
    const xmlCharKey = (_a = options.xml.xmlCharKey) !== null && _a !== void 0 ? _a : $56ed367df77acd67$exports.XML_CHARKEY;
    if ($b3f39cc1daade20f$var$getPolymorphicDiscriminatorRecursively(serializer, mapper)) mapper = $b3f39cc1daade20f$var$getPolymorphicMapper(serializer, mapper, responseBody, "serializedName");
    const modelProps = $b3f39cc1daade20f$var$resolveModelProperties(serializer, mapper, objectName);
    let instance = {};
    const handledPropertyNames = [];
    for (const key of Object.keys(modelProps)){
        const propertyMapper = modelProps[key];
        const paths = $b3f39cc1daade20f$var$splitSerializeName(modelProps[key].serializedName);
        ...
        if (headerCollectionPrefix) {
            ...
            if (propertyMapper.xmlIsAttribute && responseBody[$56ed367df77acd67$exports.XML_ATTRKEY]) instance[key] = serializer.deserialize(propertyMapper, responseBody[$56ed367df77acd67$exports.XML_ATTRKEY][xmlName], propertyObjectName, options);
    ...
    if (additionalPropertiesMapper) {
        const isAdditionalProperty = (responsePropName)=>{
            for(const clientPropName in modelProps){
                const paths = $b3f39cc1daade20f$var$splitSerializeName(modelProps[clientPropName].serializedName);
        ...
        for (const key of Object.keys(responseBody))if (instance[key] === undefined && !handledPropertyNames.includes(key) && !$b3f39cc1daade20f$var$isSpecialXmlProperty(key, options)) instance[key] = responseBody[key];
    }
    return instance;
}
function $b3f39cc1daade20f$var$deserializeDictionaryType(serializer, mapper, responseBody, objectName, options) {
...
function $b3f39cc1daade20f$var$deserializeSequenceType(serializer, mapper, responseBody, objectName, options) {
    var _a;
...
function $b3f39cc1daade20f$var$getIndexDiscriminator(discriminators, discriminatorValue, typeName) {
...
function $b3f39cc1daade20f$var$getPolymorphicMapper(serializer, mapper, object, polymorphicPropertyName) {
    var _a;
    const polymorphicDiscriminator = $b3f39cc1daade20f$var$getPolymorphicDiscriminatorRecursively(serializer, mapper);
    if (polymorphicDiscriminator) {
        ...
        if (discriminatorName) {
            ...
            if (typeof discriminatorValue === "string" && typeName) {
                const polymorphicMapper = $b3f39cc1daade20f$var$getIndexDiscriminator(serializer.modelMappers.discriminators, discriminatorValue, typeName);
...
function $b3f39cc1daade20f$var$getPolymorphicDiscriminatorRecursively(serializer, mapper) {
    return mapper.type.polymorphicDiscriminator || $b3f39cc1daade20f$var$getPolymorphicDiscriminatorSafely(serializer, mapper.type.uberParent) || $b3f39cc1daade20f$var$getPolymorphicDiscriminatorSafely(serializer, mapper.type.className);
}
function $b3f39cc1daade20f$var$getPolymorphicDiscriminatorSafely(serializer, typeName) {
    return typeName && serializer.modelMappers[typeName] && serializer.modelMappers[typeName].type.polymorphicDiscriminator;
}
/**
 * Known types of Mappers
 */ module.exports.MapperTypeNames = {
    Base64Url: "Base64Url",
    Boolean: "Boolean",
    ByteArray: "ByteArray",
    Composite: "Composite",
...
//# sourceMappingURL=serializer.147d377a.js.map
