require("./PooledBuffer.764651cb.js");
var $731R9$events = require("events");

// Copyright (c) Microsoft Corporation.
// Licensed under the MIT License.

var $05d847b8af24057e$exports = {};
$05d847b8af24057e$exports = new URL("PooledBuffer.764651cb.js", "file:" + __filename).toString();


class $3beee31a2265cf4f$export$fa926c67c806d36a {
    /**
     ...
     */ constructor(readable, bufferSize, maxBuffers, outgoingHandler, concurrency, encoding){
         ...
         */ this.emitter = new (0, $731R9$events.EventEmitter)();
        /**
     ...
     */ shiftBufferFromUnresolvedDataArray(buffer) {
        if (!buffer) buffer = new (0, $05d847b8af24057e$exports.PooledBuffer)(this.bufferSize, this.unresolvedDataArray, this.unresolvedLength);
        ...
        while(this.unresolvedLength >= this.bufferSize){
            ...
            if (this.incoming.length > 0) {
                ...
                if (this.numBuffers < this.maxBuffers) {
                    ...
                    this.numBuffers++;
                } else // No available buffer, wait for buffer returned
                return false;
            }
...
//# sourceMappingURL=BufferScheduler.5205d0ec.js.map
