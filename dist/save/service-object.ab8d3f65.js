...
var $4SiII$events = require("events");
...
module.exports.ServiceObject = void 0;
var $45e265cc919a0590$exports = {};
$45e265cc919a0590$exports = new URL("build.da3d7c56.js", "file:" + __filename).toString();
...
class $9dd983e58e1438bb$var$ServiceObject extends $4SiII$events.EventEmitter {
    /*
     * @constructor
     ...
     */ constructor(config){
        ...
        if (config.methods) // This filters the ServiceObject instance (e.g. a "File") to only have
        // the configured methods. We make a couple of exceptions for core-
        // functionality ("request()" and "getRequestInterceptors()")
        Object.getOwnPropertyNames($9dd983e58e1438bb$var$ServiceObject.prototype).filter((methodName)=>{
            ...
            $9dd983e58e1438bb$var$ServiceObject.prototype[methodName] && // This method isn't wanted.
    ...
    delete(optionsOrCallback, cb) {
        var _a;
        const [options, callback] = $fJ9ES.util.maybeOptionsOrCallback(optionsOrCallback, cb);
        ...
        $9dd983e58e1438bb$var$ServiceObject.prototype.request.call(this, reqOpts, (err, body, res)=>{
            if (err) {
    ...
    get(optionsOrCallback, cb) {
        // eslint-disable-next-line @typescript-eslint/no-this-alias
        const self = this;
        const [opts, callback] = $fJ9ES.util.maybeOptionsOrCallback(optionsOrCallback, cb);
...
module.exports.ServiceObject = $9dd983e58e1438bb$var$ServiceObject;
(0, $45e265cc919a0590$exports.promisifyAll)($9dd983e58e1438bb$var$ServiceObject, {
    exclude: [
        'getRequestInterceptors'
    ]
});
...
//# sourceMappingURL=service-object.ab8d3f65.js.map
