...
var $14MHb$stream = require("stream");
...
var $aYpZr = parcelRequire("aYpZr");
/**
 * The required token exchange grant_type: rfc8693#section-2.1
 */ const $26f732260e2f73c6$var$STS_GRANT_TYPE = 'urn:ietf:params:oauth:grant-type:token-exchange';
/**
 * The requested token exchange requested_token_type: rfc8693#section-2.1
 */ const $26f732260e2f73c6$var$STS_REQUEST_TOKEN_TYPE = 'urn:ietf:params:oauth:token-type:access_token';
/**
 * The requested token exchange subject_token_type: rfc8693#section-2.1
 */ const $26f732260e2f73c6$var$STS_SUBJECT_TOKEN_TYPE = 'urn:ietf:params:oauth:token-type:access_token';
/**
 ...
 * resources.
 */ class $26f732260e2f73c6$var$DownscopedClient extends $fbhxX.AuthClient {
    /**
     ...
     */ constructor(authClient, credentialAccessBoundary, additionalOptions, quotaProjectId){
        ...
        this.stsCredential = new $aYpZr.StsCredentials(`https://sts.${this.universeDomain}/v1/token`);
     ...
     */ async requestAsync(opts, reAuthRetried = false) {
        ...
        try {
            ...
            if (res) {
                ...
                const isReadableStream = res.config.data instanceof $14MHb$stream.Readable;
     ...
     */ async refreshAccessTokenAsync() {
        ...
        const stsCredentialsOptions = {
            grantType: $26f732260e2f73c6$var$STS_GRANT_TYPE,
            requestedTokenType: $26f732260e2f73c6$var$STS_REQUEST_TOKEN_TYPE,
            subjectToken: subjectToken,
            subjectTokenType: $26f732260e2f73c6$var$STS_SUBJECT_TOKEN_TYPE
        };
...
module.exports.DownscopedClient = $26f732260e2f73c6$var$DownscopedClient;
