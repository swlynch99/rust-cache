require("./abort-controller.f77e365e.js");
...
var $gwpJK$crypto = require("crypto");
var $gwpJK$stream = require("stream");
...
parcelRegister("r5NEV", function(module, exports) {
"use strict";
...
var $0517057b3ccd0aa4$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
...
var $0517057b3ccd0aa4$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
...
var $0517057b3ccd0aa4$var$__importStar = module.exports && module.exports.__importStar || function() {
    ...
    return function(mod) {
        ...
        var result = {};
        if (mod != null) {
            for(var k = ownKeys(mod), i = 0; i < k.length; i++)if (k[i] !== "default") $0517057b3ccd0aa4$var$__createBinding(result, mod, k[i]);
        }
        $0517057b3ccd0aa4$var$__setModuleDefault(result, mod);
        return result;
    };
}();
var $0517057b3ccd0aa4$var$__classPrivateFieldSet = module.exports && module.exports.__classPrivateFieldSet || function(receiver, state, value, kind, f) {
    if (kind === "m") throw new TypeError("Private method is not writable");
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
    return kind === "a" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value), value;
};
var $0517057b3ccd0aa4$var$__classPrivateFieldGet = module.exports && module.exports.__classPrivateFieldGet || function(receiver, state, kind, f) {
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a getter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
    return kind === "m" ? f : kind === "a" ? f.call(receiver) : f ? f.value : state.get(receiver);
};
var $0517057b3ccd0aa4$var$__importDefault = module.exports && module.exports.__importDefault || function(mod) {
    return mod && mod.__esModule ? mod : {
        "default": mod
    };
};
var $0517057b3ccd0aa4$var$_Upload_instances, $0517057b3ccd0aa4$var$_Upload_gcclGcsCmd, $0517057b3ccd0aa4$var$_Upload_resetLocalBuffersCache, $0517057b3ccd0aa4$var$_Upload_addLocalBufferCache;
Object.defineProperty(module.exports, "__esModule", {
    value: true
});
module.exports.Upload = module.exports.PROTOCOL_REGEX = void 0;
module.exports.upload = $0517057b3ccd0aa4$var$upload;
module.exports.createURI = $0517057b3ccd0aa4$var$createURI;
module.exports.checkUploadStatus = $0517057b3ccd0aa4$var$checkUploadStatus;

const $0517057b3ccd0aa4$var$abort_controller_1 = $0517057b3ccd0aa4$var$__importDefault((parcelRequire("d5dZL")));


const $0517057b3ccd0aa4$var$gaxios = $0517057b3ccd0aa4$var$__importStar((parcelRequire("47hCt")));

var $4gMhs = parcelRequire("4gMhs");


const $0517057b3ccd0aa4$var$async_retry_1 = $0517057b3ccd0aa4$var$__importDefault((parcelRequire("2NKCy")));

const $0517057b3ccd0aa4$var$uuid = $0517057b3ccd0aa4$var$__importStar((parcelRequire("81OEw")));
...
const $0517057b3ccd0aa4$var$NOT_FOUND_STATUS_CODE = 404;
const $0517057b3ccd0aa4$var$RESUMABLE_INCOMPLETE_STATUS_CODE = 308;
const $0517057b3ccd0aa4$var$packageJson = (0, $7OYF7.getPackageJSON)();
module.exports.PROTOCOL_REGEX = /^(\w*):\/\//;
class $0517057b3ccd0aa4$var$Upload extends $gwpJK$stream.Writable {
    constructor(cfg){
        var _a;
        super(cfg);
        $0517057b3ccd0aa4$var$_Upload_instances.add(this);
        this.numBytesWritten = 0;
        this.numRetries = 0;
        this.currentInvocationId = {
            checkUploadStatus: $0517057b3ccd0aa4$var$uuid.v4(),
            chunk: $0517057b3ccd0aa4$var$uuid.v4(),
            uri: $0517057b3ccd0aa4$var$uuid.v4()
        };
        /**
        ...
        $0517057b3ccd0aa4$var$_Upload_gcclGcsCmd.set(this, void 0);
        cfg = cfg || {};
        ...
        this.authClient = cfg.authClient || new $4gMhs.GoogleAuth(cfg.authConfig);
        const universe = cfg.universeDomain || $4gMhs.DEFAULT_UNIVERSE;
        ...
        if (cfg.apiEndpoint && cfg.apiEndpoint !== this.apiEndpoint) {
            ...
            const isDefaultUniverseDomain = hostname === $4gMhs.DEFAULT_UNIVERSE;
            ...
            const isSubDomainOfDefaultUniverse = hostname.slice(-($4gMhs.DEFAULT_UNIVERSE.length + 1)) === `.${$4gMhs.DEFAULT_UNIVERSE}`;
            if (!isDomain && !isDefaultUniverseDomain && !isSubDomainOfUniverse && !isSubDomainOfDefaultUniverse) // a custom, non-universe domain,
            // use gaxios
            this.authClient = $0517057b3ccd0aa4$var$gaxios;
        }
        ...
        if (cfg.key) {
            ...
            this.encryption = {
                key: base64Key,
                hash: (0, $gwpJK$crypto.createHash)('sha256').update(cfg.key).digest('base64')
            };
        }
        ...
        this.uri = cfg.uri;
        if (this.offset) // we're resuming an incomplete upload
        ...
        $0517057b3ccd0aa4$var$__classPrivateFieldSet(this, $0517057b3ccd0aa4$var$_Upload_gcclGcsCmd, cfg[$fJ9ES.GCCL_GCS_CMD_KEY], "f");
        this.once('writing', ()=>{
     ...
     */ prependLocalBufferToUpstream(keepLastBytes) {
        ...
        } else // we're keeping all of the local cache, simply use it as the initial buffer
        ...
        $0517057b3ccd0aa4$var$__classPrivateFieldGet(this, $0517057b3ccd0aa4$var$_Upload_instances, "m", $0517057b3ccd0aa4$var$_Upload_resetLocalBuffersCache).call(this);
    }
    /**
     ...
     */ async *upstreamIterator(limit = Infinity) {
        ...
        while(limit && await this.waitForNextChunk())// read until end or limit has been reached
    ...
    async createURIAsync() {
        ...
        let googAPIClient = `${(0, $dY7Uc.getRuntimeTrackingString)()} gccl/${$0517057b3ccd0aa4$var$packageJson.version}-${(0, $dY7Uc.getModuleFormat)()} gccl-invocation-id/${this.currentInvocationId.uri}`;
        if ($0517057b3ccd0aa4$var$__classPrivateFieldGet(this, $0517057b3ccd0aa4$var$_Upload_gcclGcsCmd, "f")) googAPIClient += ` gccl-gcs-cmd/${$0517057b3ccd0aa4$var$__classPrivateFieldGet(this, $0517057b3ccd0aa4$var$_Upload_gcclGcsCmd, "f")}`;
        ...
        const reqOpts = {
            ...
            data: metadata,
            headers: {
                'User-Agent': (0, $dY7Uc.getUserAgentString)(),
        ...
        const uri = await (0, $0517057b3ccd0aa4$var$async_retry_1.default)(async (bail)=>{
            var _a, _b, _c;
            try {
                const res = await this.makeRequest(reqOpts);
                // We have successfully got a URI we can now create a new invocation id
                this.currentInvocationId.uri = $0517057b3ccd0aa4$var$uuid.v4();
    ...
    async startUploading() {
        ...
        if (this.numBytesWritten < this.offset) {
            ...
            for await (const _chunk of this.upstreamIterator(fastForwardBytes))_chunk; // discard the data up until the point we want
            this.numBytesWritten = this.offset;
        }
        ...
        const requestStream = new $gwpJK$stream.Readable({
            read: async ()=>{
                ...
                if (result.value) {
                    ...
                    if (multiChunkMode) // save ever buffer used in the request in multi-chunk mode
                    $0517057b3ccd0aa4$var$__classPrivateFieldGet(this, $0517057b3ccd0aa4$var$_Upload_instances, "m", $0517057b3ccd0aa4$var$_Upload_addLocalBufferCache).call(this, result.value);
                    else {
                        $0517057b3ccd0aa4$var$__classPrivateFieldGet(this, $0517057b3ccd0aa4$var$_Upload_instances, "m", $0517057b3ccd0aa4$var$_Upload_resetLocalBuffersCache).call(this);
                        $0517057b3ccd0aa4$var$__classPrivateFieldGet(this, $0517057b3ccd0aa4$var$_Upload_instances, "m", $0517057b3ccd0aa4$var$_Upload_addLocalBufferCache).call(this, result.value);
                    }
        ...
        let googAPIClient = `${(0, $dY7Uc.getRuntimeTrackingString)()} gccl/${$0517057b3ccd0aa4$var$packageJson.version}-${(0, $dY7Uc.getModuleFormat)()} gccl-invocation-id/${this.currentInvocationId.chunk}`;
        if ($0517057b3ccd0aa4$var$__classPrivateFieldGet(this, $0517057b3ccd0aa4$var$_Upload_gcclGcsCmd, "f")) googAPIClient += ` gccl-gcs-cmd/${$0517057b3ccd0aa4$var$__classPrivateFieldGet(this, $0517057b3ccd0aa4$var$_Upload_gcclGcsCmd, "f")}`;
        const headers = {
            'User-Agent': (0, $dY7Uc.getUserAgentString)(),
            'x-goog-api-client': googAPIClient
        ...
        if (multiChunkMode) {
            ...
            // https://cloud.google.com/storage/docs/performing-resumable-uploads#chunked-upload
            for await (const chunk of this.upstreamIterator(expectedUploadSize))// This will conveniently track and keep the size of the buffers.
            // We will reach either the expected upload size or the remainder of the stream.
            $0517057b3ccd0aa4$var$__classPrivateFieldGet(this, $0517057b3ccd0aa4$var$_Upload_instances, "m", $0517057b3ccd0aa4$var$_Upload_addLocalBufferCache).call(this, chunk);
            ...
            if (typeof this.contentLength !== 'number' && isLastChunkOfUpload && !this.isPartialUpload) // Let's let the server know this is the last chunk of the object since we didn't set it before.
        ...
        } else headers['Content-Range'] = `bytes ${this.offset}-*/${this.contentLength}`;
        const reqOpts = {
            method: 'PUT',
            url: this.uri,
            headers: headers,
    ...
    async responseHandler(resp) {
        ...
        this.currentInvocationId.chunk = $0517057b3ccd0aa4$var$uuid.v4();
        const moreDataToUpload = await this.waitForNextChunk();
        const shouldContinueWithNextMultiChunkRequest = this.chunkSize && resp.status === $0517057b3ccd0aa4$var$RESUMABLE_INCOMPLETE_STATUS_CODE && resp.headers.range && moreDataToUpload;
        /**
         ...
         */ const shouldContinueUploadInAnotherRequest = this.isPartialUpload && resp.status === $0517057b3ccd0aa4$var$RESUMABLE_INCOMPLETE_STATUS_CODE && !moreDataToUpload;
        if (shouldContinueWithNextMultiChunkRequest) {
            ...
            } else // No bytes missing - no need to keep the local cache
            $0517057b3ccd0aa4$var$__classPrivateFieldGet(this, $0517057b3ccd0aa4$var$_Upload_instances, "m", $0517057b3ccd0aa4$var$_Upload_resetLocalBuffersCache).call(this);
            ...
            if (resp === null || resp === void 0 ? void 0 : resp.data) err.errors = [
     ...
     */ async checkUploadStatus(config = {}) {
        let googAPIClient = `${(0, $dY7Uc.getRuntimeTrackingString)()} gccl/${$0517057b3ccd0aa4$var$packageJson.version}-${(0, $dY7Uc.getModuleFormat)()} gccl-invocation-id/${this.currentInvocationId.checkUploadStatus}`;
        if ($0517057b3ccd0aa4$var$__classPrivateFieldGet(this, $0517057b3ccd0aa4$var$_Upload_gcclGcsCmd, "f")) googAPIClient += ` gccl-gcs-cmd/${$0517057b3ccd0aa4$var$__classPrivateFieldGet(this, $0517057b3ccd0aa4$var$_Upload_gcclGcsCmd, "f")}`;
        const opts = {
            method: 'PUT',
            url: this.uri,
        ...
        try {
            ...
            this.currentInvocationId.checkUploadStatus = $0517057b3ccd0aa4$var$uuid.v4();
            return resp;
        } catch (e) {
    ...
    async getAndSetOffset() {
        try {
            ...
            if (resp.status === $0517057b3ccd0aa4$var$RESUMABLE_INCOMPLETE_STATUS_CODE) {
    ...
    async makeRequest(reqOpts) {
        ...
        reqOpts.validateStatus = (status)=>{
            return this.isSuccessfulResponse(status) || status === $0517057b3ccd0aa4$var$RESUMABLE_INCOMPLETE_STATUS_CODE;
        };
    ...
    async makeRequestStream(reqOpts) {
        const controller = new $0517057b3ccd0aa4$var$abort_controller_1.default();
     ...
     */ attemptDelayedRetry(resp) {
        if (this.numRetries < this.retryOptions.maxRetries) {
            if (resp.status === $0517057b3ccd0aa4$var$NOT_FOUND_STATUS_CODE && this.numChunksReadInRequest === 0) this.startUploading();
            else {
                const retryDelay = this.getRetryDelay();
                if (retryDelay <= 0) {
            ...
            this.numRetries++;
        } else this.destroy(new Error(`Retry limit exceeded - ${JSON.stringify(resp.data)}`));
    }
    /**
...
module.exports.Upload = $0517057b3ccd0aa4$var$Upload;
$0517057b3ccd0aa4$var$_Upload_gcclGcsCmd = new WeakMap(), $0517057b3ccd0aa4$var$_Upload_instances = new WeakSet(), $0517057b3ccd0aa4$var$_Upload_resetLocalBuffersCache = function _Upload_resetLocalBuffersCache() {
    this.localWriteCache = [];
    this.localWriteCacheByteLength = 0;
}, $0517057b3ccd0aa4$var$_Upload_addLocalBufferCache = function _Upload_addLocalBufferCache(buf) {
    this.localWriteCache.push(buf);
    this.localWriteCacheByteLength += buf.byteLength;
};
function $0517057b3ccd0aa4$var$upload(cfg) {
    return new $0517057b3ccd0aa4$var$Upload(cfg);
}
function $0517057b3ccd0aa4$var$createURI(cfg, callback) {
    const up = new $0517057b3ccd0aa4$var$Upload(cfg);
 ...
 * @param cfg A configuration to use. `uri` is required.
 * @returns the current upload status
 */ function $0517057b3ccd0aa4$var$checkUploadStatus(cfg) {
    const up = new $0517057b3ccd0aa4$var$Upload(cfg);
    return up.checkUploadStatus();
}

});
parcelRegister("d5dZL", function(module, exports) {
module.exports = new URL("abort-controller.f77e365e.js", "file:" + __filename).toString();

});



//# sourceMappingURL=resumable-upload.48b29785.js.map
