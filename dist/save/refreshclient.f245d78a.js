...
var $gc8gA$querystring = require("querystring");
...
class $fecb67fb7cdf201f$var$UserRefreshClient extends $kdXrB.OAuth2Client {
    ...
    async fetchIdToken(targetAudience) {
        const res = await this.transporter.request({
            ...$fecb67fb7cdf201f$var$UserRefreshClient.RETRY_CONFIG,
            url: this.endpoints.oauth2TokenUrl,
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded'
            },
            method: 'POST',
            data: (0, $gc8gA$querystring.stringify)({
     ...
     */ static fromJSON(json) {
        const client = new $fecb67fb7cdf201f$var$UserRefreshClient();
        client.fromJSON(json);
        return client;
    }
}
module.exports.UserRefreshClient = $fecb67fb7cdf201f$var$UserRefreshClient;


//# sourceMappingURL=refreshclient.f245d78a.js.map
