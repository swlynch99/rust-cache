...
var $jkY3Z$querystring = require("querystring");
...
module.exports.getErrorFromOAuthErrorResponse = $ae2318366fb2df55$var$getErrorFromOAuthErrorResponse;


var $5DQIM = parcelRequire("5DQIM");
/** List of HTTP methods that accept request bodies. */ const $ae2318366fb2df55$var$METHODS_SUPPORTING_REQUEST_BODY = [
    'PUT',
    'POST',
    'PATCH'
];
 ...
 */ class $ae2318366fb2df55$var$OAuthClientAuthHandler {
    /**
     ...
     */ injectAuthenticatedRequestBody(opts) {
        ...
        if (((_a = this.clientAuthentication) === null || _a === void 0 ? void 0 : _a.confidentialClientType) === 'request-body') {
            ...
            // Inject authenticated request body.
            if ($ae2318366fb2df55$var$METHODS_SUPPORTING_REQUEST_BODY.indexOf(method) !== -1) {
                // Get content-type.
                let contentType;
                ...
                if (contentType === 'application/x-www-form-urlencoded') {
                    opts.data = opts.data || '';
                    const data = $jkY3Z$querystring.parse(opts.data);
                    Object.assign(data, {
                        client_id: this.clientAuthentication.clientId,
                        client_secret: this.clientAuthentication.clientSecret || ''
                    });
                    opts.data = $jkY3Z$querystring.stringify(data);
...
module.exports.OAuthClientAuthHandler = $ae2318366fb2df55$var$OAuthClientAuthHandler;
/**
 ...
 */ function $ae2318366fb2df55$var$getErrorFromOAuthErrorResponse(resp, err) {
    // Error response.
