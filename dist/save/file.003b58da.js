...
require("./mime.850b95e9.js");
require("./resumable-upload.399fd7be.js");
require("./storage.d0b9c38a.js");
require("./bucket.c6139490.js");
require("./acl.60a8c0f5.js");
require("./signer.361bfe46.js");
require("./util.97c9f8b9.js");
require("./duplexify.e7ab56b7.js");
require("./util.569826f4.js");
require("./crc32c.9e825062.js");
require("./hash-stream-validator.03a2fb6a.js");
require("./async-retry.125c023d.js");
var $7b4bv$crypto = require("crypto");
var $7b4bv$fs = require("fs");
var $7b4bv$stream = require("stream");
var $7b4bv$zlib = require("zlib");
...
parcelRegister("6C72h", function(module, exports) {
module.exports = new URL("resumable-upload.399fd7be.js", "file:" + __filename).toString();
...
var $6613de94b5c0a130$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
...
var $6613de94b5c0a130$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
...
var $6613de94b5c0a130$var$__importStar = module.exports && module.exports.__importStar || function() {
    ...
    return function(mod) {
        ...
        var result = {};
        if (mod != null) {
            for(var k = ownKeys(mod), i = 0; i < k.length; i++)if (k[i] !== "default") $6613de94b5c0a130$var$__createBinding(result, mod, k[i]);
        }
        $6613de94b5c0a130$var$__setModuleDefault(result, mod);
        return result;
    };
}();
var $6613de94b5c0a130$var$__classPrivateFieldGet = module.exports && module.exports.__classPrivateFieldGet || function(receiver, state, kind, f) {
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a getter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
    return kind === "m" ? f : kind === "a" ? f.call(receiver) : f ? f.value : state.get(receiver);
};
var $6613de94b5c0a130$var$__importDefault = module.exports && module.exports.__importDefault || function(mod) {
    return mod && mod.__esModule ? mod : {
        "default": mod
    };
};
var $6613de94b5c0a130$var$_File_instances, $6613de94b5c0a130$var$_File_validateIntegrity;
Object.defineProperty(module.exports, "__esModule", {
    value: true
});
module.exports.File = module.exports.FileExceptionMessages = module.exports.RequestError = module.exports.STORAGE_POST_POLICY_BASE_URL = module.exports.ActionToHTTPMethod = void 0;

var $c5iBM = parcelRequire("c5iBM");

var $gt46O = parcelRequire("gt46O");

const $6613de94b5c0a130$var$crypto = $6613de94b5c0a130$var$__importStar($7b4bv$crypto);

const $6613de94b5c0a130$var$fs = $6613de94b5c0a130$var$__importStar($7b4bv$fs);

const $6613de94b5c0a130$var$mime_1 = $6613de94b5c0a130$var$__importDefault((parcelRequire("fSIbj")));

const $6613de94b5c0a130$var$resumableUpload = $6613de94b5c0a130$var$__importStar((parcelRequire("6C72h")));


const $6613de94b5c0a130$var$zlib = $6613de94b5c0a130$var$__importStar($7b4bv$zlib);

var $5wzKh = parcelRequire("5wzKh");

var $gba7W = parcelRequire("gba7W");

var $gJs2S = parcelRequire("gJs2S");
var $7d7c03accbb4406a$exports = {};
$7d7c03accbb4406a$exports = new URL("signer.361bfe46.js", "file:" + __filename).toString();



var $5vqXE = parcelRequire("5vqXE");

const $6613de94b5c0a130$var$duplexify_1 = $6613de94b5c0a130$var$__importDefault((parcelRequire("k0CXW")));

var $liF6k = parcelRequire("liF6k");
var $fb7000d0160f9784$exports = {};
$fb7000d0160f9784$exports = new URL("crc32c.9e825062.js", "file:" + __filename).toString();


var $9f3e1c351a4bf325$exports = {};
$9f3e1c351a4bf325$exports = new URL("hash-stream-validator.03a2fb6a.js", "file:" + __filename).toString();



const $6613de94b5c0a130$var$async_retry_1 = $6613de94b5c0a130$var$__importDefault((parcelRequire("7yoQv")));
var $6613de94b5c0a130$var$ActionToHTTPMethod;
...
})($6613de94b5c0a130$var$ActionToHTTPMethod || (module.exports.ActionToHTTPMethod = $6613de94b5c0a130$var$ActionToHTTPMethod = {}));
/**
 * @deprecated - no longer used
 */ module.exports.STORAGE_POST_POLICY_BASE_URL = 'https://storage.googleapis.com';
/**
 * @private
 */ const $6613de94b5c0a130$var$GS_URL_REGEXP = /^gs:\/\/([a-z0-9_.-]+)\/(.+)$/;
/**
 * @private
 ...
 * standards.
 */ const $6613de94b5c0a130$var$COMPRESSIBLE_MIME_REGEX = new RegExp([
...
class $6613de94b5c0a130$var$RequestError extends Error {
}
module.exports.RequestError = $6613de94b5c0a130$var$RequestError;
const $6613de94b5c0a130$var$SEVEN_DAYS = 604800;
const $6613de94b5c0a130$var$GS_UTIL_URL_REGEX = /(gs):\/\/([a-z0-9_.-]+)\/(.+)/g;
const $6613de94b5c0a130$var$HTTPS_PUBLIC_URL_REGEX = /(https):\/\/(storage\.googleapis\.com)\/([a-z0-9_.-]+)\/(.+)/g;
var $6613de94b5c0a130$var$FileExceptionMessages;
...
})($6613de94b5c0a130$var$FileExceptionMessages || (module.exports.FileExceptionMessages = $6613de94b5c0a130$var$FileExceptionMessages = {}));
/**
 * A File object is created from your {@link Bucket} object using
 * {@link Bucket#file}.
 *
 * @class
 */ class $6613de94b5c0a130$var$File extends $c5iBM.ServiceObject {
    /**
     ...
     */ constructor(bucket, name, options = {}){
        ...
        $6613de94b5c0a130$var$_File_instances.add(this);
        this.bucket = bucket;
     ...
     */ copy(destination, optionsOrCallback, callback) {
        var _a, _b;
        const noDestinationError = new Error($6613de94b5c0a130$var$FileExceptionMessages.DESTINATION_NO_NAME);
        if (!destination) throw noDestinationError;
        let options = {};
        if (typeof optionsOrCallback === 'function') callback = optionsOrCallback;
        else if (optionsOrCallback) options = {
            ...optionsOrCallback
        };
        ...
        if (typeof destination === 'string') {
            const parsedDestination = $6613de94b5c0a130$var$GS_URL_REGEXP.exec(destination);
        ...
        } else if (destination instanceof $gba7W.Bucket) {
            destBucket = destination;
            destName = this.name;
        } else if (destination instanceof $6613de94b5c0a130$var$File) {
            destBucket = destination.bucket;
            destName = destination.name;
            newFile = destination;
        } else throw noDestinationError;
        const query = {};
        if (this.generation !== undefined) query.sourceGeneration = this.generation;
        if (options.token !== undefined) query.rewriteToken = options.token;
        ...
        if (newFile.encryptionKey !== undefined) this.setEncryptionKey(newFile.encryptionKey);
        else if (options.destinationKmsKeyName !== undefined) {
            query.destinationKmsKeyName = options.destinationKmsKeyName;
            delete options.destinationKmsKeyName;
        } else if (newFile.kmsKeyName !== undefined) query.destinationKmsKeyName = newFile.kmsKeyName;
     ...
     */ createReadStream(options = {}) {
        ...
        const throughStream = new $liF6k.PassThroughShim();
        let crc32c = true;
        let md5 = false;
        ...
        if (rangeRequest) {
            if (typeof options.validation === 'string' || options.validation === true) throw new Error($6613de94b5c0a130$var$FileExceptionMessages.INVALID_VALIDATION_FILE_RANGE);
        ...
        const onResponse = (err, _body, rawResponseStream)=>{
            ...
            if (shouldRunValidation) {
                ...
                validateStream = new $9f3e1c351a4bf325$exports.HashStreamValidator({
                    crc32c: crc32c,
                    md5: md5,
            ...
            if (md5 && !hashes.md5) {
                const hashError = new $6613de94b5c0a130$var$RequestError($6613de94b5c0a130$var$FileExceptionMessages.MD5_NOT_AVAILABLE);
            ...
            if (isCompressed && options.decompress) transformStreams.push($6613de94b5c0a130$var$zlib.createGunzip());
            (0, $7b4bv$stream.pipeline)(rawResponseStream, ...transformStreams, throughStream, onComplete);
        };
        ...
        const makeRequest = ()=>{
            ...
            if (options[$5vqXE.GCCL_GCS_CMD_KEY]) reqOpts[$5vqXE.GCCL_GCS_CMD_KEY] = options[$5vqXE.GCCL_GCS_CMD_KEY];
            this.requestStream(reqOpts).on('error', (err)=>{
                throughStream.destroy(err);
            }).on('response', (res)=>{
                throughStream.emit('response', res);
                $c5iBM.util.handleResp(null, res, null, onResponse);
            }).resume();
        };
     ...
     */ createResumableUpload(optionsOrCallback, callback) {
        ...
        if (((_a = options === null || options === void 0 ? void 0 : options.preconditionOpts) === null || _a === void 0 ? void 0 : _a.ifGenerationMatch) === undefined && ((_b = this.instancePreconditionOpts) === null || _b === void 0 ? void 0 : _b.ifGenerationMatch) === undefined && this.storage.retryOptions.idempotencyStrategy === $5wzKh.IdempotencyStrategy.RetryConditional || this.storage.retryOptions.idempotencyStrategy === $5wzKh.IdempotencyStrategy.RetryNever) retryOptions.autoRetry = false;
        $6613de94b5c0a130$var$resumableUpload.createURI({
            ...
            [$5vqXE.GCCL_GCS_CMD_KEY]: options[$5vqXE.GCCL_GCS_CMD_KEY]
        }, callback);
        this.storage.retryOptions.autoRetry = this.instanceRetryValue;
    }
    /**
    ...
    createWriteStream(options = {}) {
        ...
        if (!options.metadata.contentType || options.metadata.contentType === 'auto') {
            const detectedContentType = $6613de94b5c0a130$var$mime_1.default.getType(this.name);
            if (detectedContentType) options.metadata.contentType = detectedContentType;
        }
        let gzip = options.gzip;
        if (gzip === 'auto') gzip = $6613de94b5c0a130$var$COMPRESSIBLE_MIME_REGEX.test(options.metadata.contentType || '');
        ...
        if (options.offset) {
            if (md5) throw new RangeError($6613de94b5c0a130$var$FileExceptionMessages.MD5_RESUMED_UPLOAD);
            if (crc32c && !options.isPartialUpload && !options.resumeCRC32C) throw new RangeError($6613de94b5c0a130$var$FileExceptionMessages.MISSING_RESUME_CRC32C_FINAL_UPLOAD);
        }
        /**
        ...
        const writeStream = new $7b4bv$stream.Writable({
            final (cb) {
        ...
        const transformStreams = [];
        if (gzip) transformStreams.push($6613de94b5c0a130$var$zlib.createGzip());
        const emitStream = new $liF6k.PassThroughShim();
        let hashCalculatingStream = null;
        if (crc32c || md5) {
            const crc32cInstance = options.resumeCRC32C ? $fb7000d0160f9784$exports.CRC32C.from(options.resumeCRC32C) : undefined;
            hashCalculatingStream = new $9f3e1c351a4bf325$exports.HashStreamValidator({
                crc32c: crc32c,
        ...
        const fileWriteStream = (0, $6613de94b5c0a130$var$duplexify_1.default)();
        ...
        writeStream.once('writing', ()=>{
            ...
            (0, $7b4bv$stream.pipeline)(emitStream, ...transformStreams, fileWriteStream, async (e)=>{
                ...
                try {
                    ...
                    if (hashCalculatingStream && !metadataNotReady) await $6613de94b5c0a130$var$__classPrivateFieldGet(this, $6613de94b5c0a130$var$_File_instances, "m", $6613de94b5c0a130$var$_File_validateIntegrity).call(this, hashCalculatingStream, {
                        crc32c: crc32c,
                        md5: md5
                    });
                    pipelineCallback();
    ...
    delete(optionsOrCallback, cb) {
        ...
        this.disableAutoRetryConditionallyIdempotent_(this.methods.delete, $gba7W.AvailableServiceObjectMethods.delete, options);
     ...
     */ download(optionsOrCallback, cb) {
        ...
        if (destination) fileStream.on('error', callback).once('data', (data)=>{
            ...
            const writable = $6613de94b5c0a130$var$fs.createWriteStream(destination);
            writable.write(data);
            ...
            if (!receivedData) {
                ...
                try {
                    $6613de94b5c0a130$var$fs.writeFileSync(destination, data);
                    callback(null, data);
                } catch (e) {
                    callback(e, data);
                }
     ...
     */ setEncryptionKey(encryptionKey) {
        ...
        this.encryptionKeyHash = $6613de94b5c0a130$var$crypto.createHash('sha256')// eslint-disable-next-line @typescript-eslint/no-explicit-any
     ...
     */ static from(publicUrlOrGsUrl, storageInstance, options) {
        const gsMatches = [
            ...publicUrlOrGsUrl.matchAll($6613de94b5c0a130$var$GS_UTIL_URL_REGEX)
        ];
        const httpsMatches = [
            ...publicUrlOrGsUrl.matchAll($6613de94b5c0a130$var$HTTPS_PUBLIC_URL_REGEX)
        ];
        if (gsMatches.length > 0) {
            const bucket = new $gba7W.Bucket(storageInstance, gsMatches[0][2]);
            return new $6613de94b5c0a130$var$File(bucket, gsMatches[0][3], options);
        } else if (httpsMatches.length > 0) {
            const bucket = new $gba7W.Bucket(storageInstance, httpsMatches[0][3]);
            return new $6613de94b5c0a130$var$File(bucket, httpsMatches[0][4], options);
     ...
     */ getExpirationDate(callback) {
        this.getMetadata((err, metadata, apiResponse)=>{
            ...
            if (!metadata.retentionExpirationTime) {
                const error = new Error($6613de94b5c0a130$var$FileExceptionMessages.EXPIRATION_TIME_NA);
     ...
     */ generateSignedPostPolicyV2(optionsOrCallback, cb) {
        const args = (0, $liF6k.normalize)(optionsOrCallback, cb);
        let options = args.options;
        const callback = args.callback;
        const expires = new Date(options.expires);
        if (isNaN(expires.getTime())) throw new Error($5wzKh.ExceptionMessages.EXPIRATION_DATE_INVALID);
        if (expires.valueOf() < Date.now()) throw new Error($5wzKh.ExceptionMessages.EXPIRATION_DATE_PAST);
        ...
        if (Array.isArray(options.equals)) {
            if (!Array.isArray(options.equals[0])) options.equals = [
                options.equals
            ];
            options.equals.forEach((condition)=>{
                if (!Array.isArray(condition) || condition.length !== 2) throw new Error($6613de94b5c0a130$var$FileExceptionMessages.EQUALS_CONDITION_TWO_ELEMENTS);
                conditions.push([
                    'eq',
                    condition[0],
                    condition[1]
        ...
        if (Array.isArray(options.startsWith)) {
            if (!Array.isArray(options.startsWith[0])) options.startsWith = [
                options.startsWith
            ];
            options.startsWith.forEach((condition)=>{
                if (!Array.isArray(condition) || condition.length !== 2) throw new Error($6613de94b5c0a130$var$FileExceptionMessages.STARTS_WITH_TWO_ELEMENTS);
                conditions.push([
                    'starts-with',
                    condition[0],
                    condition[1]
        ...
        if (options.acl) conditions.push({
            acl: options.acl
        });
        if (options.successRedirect) conditions.push({
            success_action_redirect: options.successRedirect
        });
        if (options.successStatus) conditions.push({
        ...
        if (options.contentLengthRange) {
            ...
            if (typeof min !== 'number' || typeof max !== 'number') throw new Error($6613de94b5c0a130$var$FileExceptionMessages.CONTENT_LENGTH_RANGE_MIN_MAX);
            conditions.push([
        ...
        this.storage.authClient.sign(policyBase64, options.signingEndpoint).then((signature)=>{
            ...
            callback(new $7d7c03accbb4406a$exports.SigningError(err.message));
        });
    }
    /**
     ...
     */ generateSignedPostPolicyV4(optionsOrCallback, cb) {
        ...
        if (isNaN(expires.getTime())) throw new Error($5wzKh.ExceptionMessages.EXPIRATION_DATE_INVALID);
        if (expires.valueOf() < Date.now()) throw new Error($5wzKh.ExceptionMessages.EXPIRATION_DATE_PAST);
        if (expires.valueOf() - Date.now() > $6613de94b5c0a130$var$SEVEN_DAYS * 1000) throw new Error(`Max allowed expiration is seven days (${$6613de94b5c0a130$var$SEVEN_DAYS} seconds).`);
        options = Object.assign({}, options);
        let fields = Object.assign({}, options.fields);
        const now = new Date();
        const nowISO = (0, $liF6k.formatAsUTCISO)(now, true);
        const todayISO = (0, $liF6k.formatAsUTCISO)(now);
        const sign = async ()=>{
            const { client_email: client_email } = await this.storage.authClient.getCredentials();
            ...
            Object.entries(fields).forEach(([key, value])=>{
                if (!key.startsWith('x-ignore-')) conditions.push({
                    [key]: value
                });
            });
            delete fields.bucket;
            const expiration = (0, $liF6k.formatAsUTCISO)(expires, true, '-', ':');
            const policy = {
                conditions: conditions,
                expiration: expiration
            };
            const policyString = (0, $liF6k.unicodeJSONStringify)(policy);
            const policyBase64 = Buffer.from(policyString).toString('base64');
            try {
                ...
                throw new $7d7c03accbb4406a$exports.SigningError(err.message);
            }
        };
     ...
     */ getSignedUrl(cfg, callback) {
        const method = $6613de94b5c0a130$var$ActionToHTTPMethod[cfg.action];
        const extensionHeaders = (0, $liF6k.objectKeyToLowercase)(cfg.extensionHeaders || {});
        ...
        if (!this.signer) this.signer = new $7d7c03accbb4406a$exports.URLSigner(this.storage.authClient, this.bucket, this, this.storage);
     ...
     */ isPublic(callback) {
        ...
        $c5iBM.util.makeRequest({
            ...
            if (err) {
                const apiError = err;
                if (apiError.code === 403) callback(null, false);
                else callback(err);
     ...
     */ rotateEncryptionKey(optionsOrCallback, callback) {
        ...
        callback = typeof optionsOrCallback === 'function' ? optionsOrCallback : callback;
        let options = {};
        if (typeof optionsOrCallback === 'string' || optionsOrCallback instanceof Buffer) options = {
     ...
     */ save(data, optionsOrCallback, callback) {
        ...
        const returnValue = (0, $6613de94b5c0a130$var$async_retry_1.default)(async (bail)=>{
            return new Promise((resolve, reject)=>{
                ...
                else (0, $7b4bv$stream.pipeline)(data, writable, (err)=>{
                    if (err) {
                        if (typeof data !== 'function') // Only PipelineSourceFunction can be retried. Async-iterables
    ...
    setMetadata(metadata, optionsOrCallback, cb) {
        ...
        const options = typeof optionsOrCallback === 'object' ? optionsOrCallback : {};
        cb = typeof optionsOrCallback === 'function' ? optionsOrCallback : cb;
        this.disableAutoRetryConditionallyIdempotent_(this.methods.setMetadata, $gba7W.AvailableServiceObjectMethods.setMetadata, options);
     ...
     */ startResumableUpload_(dup, options = {}) {
        ...
        let uploadStream;
        try {
            uploadStream = $6613de94b5c0a130$var$resumableUpload.upload(cfg);
        } catch (error) {
            dup.destroy(error);
            this.storage.retryOptions.autoRetry = this.instanceRetryValue;
            return;
     ...
     */ startSimpleUpload_(dup, options = {}) {
        ...
        if (this.generation !== undefined) reqOpts.qs.ifGenerationMatch = this.generation;
        if (this.kmsKeyName !== undefined) reqOpts.qs.kmsKeyName = this.kmsKeyName;
        ...
        $c5iBM.util.makeWritableStream(dup, {
    ...
    coreOpts, methodType, localPreconditionOptions) {
        var _a, _b, _c, _d;
        if (typeof coreOpts === 'object' && ((_b = (_a = coreOpts === null || coreOpts === void 0 ? void 0 : coreOpts.reqOpts) === null || _a === void 0 ? void 0 : _a.qs) === null || _b === void 0 ? void 0 : _b.ifGenerationMatch) === undefined && (localPreconditionOptions === null || localPreconditionOptions === void 0 ? void 0 : localPreconditionOptions.ifGenerationMatch) === undefined && methodType === $gba7W.AvailableServiceObjectMethods.delete && this.storage.retryOptions.idempotencyStrategy === $5wzKh.IdempotencyStrategy.RetryConditional || this.storage.retryOptions.idempotencyStrategy === $5wzKh.IdempotencyStrategy.RetryNever) this.storage.retryOptions.autoRetry = false;
        if (typeof coreOpts === 'object' && ((_d = (_c = coreOpts === null || coreOpts === void 0 ? void 0 : coreOpts.reqOpts) === null || _c === void 0 ? void 0 : _c.qs) === null || _d === void 0 ? void 0 : _d.ifMetagenerationMatch) === undefined && (localPreconditionOptions === null || localPreconditionOptions === void 0 ? void 0 : localPreconditionOptions.ifMetagenerationMatch) === undefined && methodType === $gba7W.AvailableServiceObjectMethods.setMetadata && this.storage.retryOptions.idempotencyStrategy === $5wzKh.IdempotencyStrategy.RetryConditional || this.storage.retryOptions.idempotencyStrategy === $5wzKh.IdempotencyStrategy.RetryNever) this.storage.retryOptions.autoRetry = false;
    }
...
module.exports.File = $6613de94b5c0a130$var$File;
$6613de94b5c0a130$var$_File_instances = new WeakSet(), $6613de94b5c0a130$var$_File_validateIntegrity = /**
 *
    ...
    if (dataMismatch) {
        ...
        try {
            ...
            if (verify.md5 && !metadata.md5Hash) {
                ...
                message = $6613de94b5c0a130$var$FileExceptionMessages.MD5_NOT_AVAILABLE;
            } else {
                code = 'FILE_NO_UPLOAD';
                message = $6613de94b5c0a130$var$FileExceptionMessages.UPLOAD_MISMATCH;
            }
        } catch (e) {
            const error = e;
            code = 'FILE_NO_UPLOAD_DELETE';
            message = `${$6613de94b5c0a130$var$FileExceptionMessages.UPLOAD_MISMATCH_DELETE_FAIL}${error.message}`;
            errors.push(error);
        }
        const error = new $6613de94b5c0a130$var$RequestError(message);
        error.code = code;
        error.errors = errors;
        throw error;
    }
 ...
 */ (0, $gt46O.promisifyAll)($6613de94b5c0a130$var$File, {
    exclude: [
        'cloudStorageURI',
        'publicUrl',
        'request',
