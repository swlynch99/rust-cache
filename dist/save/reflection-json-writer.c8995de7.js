...
class $22c1c75fafd18535$export$b2626b487dec7942 {
    constructor(info){
        var _a;
     ...
     */ write(message, options) {
        ...
        for (const field of this.fields){
            ...
            (0, $iiDNV.assert)(jsonValue !== undefined);
        ...
        if (field.kind == 'map') {
            ...
            switch(field.V.kind){
                ...
                case "enum":
                    ...
                    for (const [entryKey, entryValue] of Object.entries(value)){
                        (0, $iiDNV.assert)(entryValue === undefined || typeof entryValue == 'number');
            ...
            switch(field.kind){
                ...
                case "enum":
                    ...
                    for(let i = 0; i < value.length; i++){
                        (0, $iiDNV.assert)(value[i] === undefined || typeof value[i] == 'number');
     ...
     */ enum(type, value, fieldName, optional, emitDefaultValues, enumAsInteger) {
        ...
        if (value === undefined) {
            (0, $iiDNV.assert)(optional);
            return undefined;
        }
        if (value === 0 && !emitDefaultValues && !optional) // we require 0 to be default value for all enums
        return undefined;
        (0, $iiDNV.assert)(typeof value == 'number');
        (0, $iiDNV.assert)(Number.isInteger(value));
    ...
    scalar(type, value, fieldName, optional, emitDefaultValues) {
        ...
        switch(type){
            ...
            case (0, $jcCg0.ScalarType).STRING:
                ...
                (0, $iiDNV.assert)(typeof value == 'string');
                return value;
            // bool:
            case (0, $jcCg0.ScalarType).BOOL:
                if (value === false) return ed ? false : undefined;
                (0, $iiDNV.assert)(typeof value == 'boolean');
                return value;
            // JSON value will be a decimal string. Either numbers or strings are accepted.
            case (0, $jcCg0.ScalarType).UINT64:
            case (0, $jcCg0.ScalarType).FIXED64:
                (0, $iiDNV.assert)(typeof value == 'number' || typeof value == 'string' || typeof value == 'bigint');
                let ulong = (0, $7crDo.PbULong).from(value);
            ...
            case (0, $jcCg0.ScalarType).BYTES:
                (0, $iiDNV.assert)(value instanceof Uint8Array);
                if (!value.byteLength) return ed ? "" : undefined;
                return (0, $9FSZ1.base64encode)(value);
        }
    }
}


//# sourceMappingURL=reflection-json-writer.c8995de7.js.map
