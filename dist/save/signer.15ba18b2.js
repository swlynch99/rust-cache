...
var $dBNrE$crypto = require("crypto");
var $dBNrE$url = require("url");
...
var $ddb6941ad6fc5d0a$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
...
var $ddb6941ad6fc5d0a$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
...
var $ddb6941ad6fc5d0a$var$__importStar = module.exports && module.exports.__importStar || function() {
    ...
    return function(mod) {
        ...
        var result = {};
        if (mod != null) {
            for(var k = ownKeys(mod), i = 0; i < k.length; i++)if (k[i] !== "default") $ddb6941ad6fc5d0a$var$__createBinding(result, mod, k[i]);
        }
        $ddb6941ad6fc5d0a$var$__setModuleDefault(result, mod);
        return result;
    };
}();
...
const $ddb6941ad6fc5d0a$var$crypto = $ddb6941ad6fc5d0a$var$__importStar($dBNrE$crypto);

const $ddb6941ad6fc5d0a$var$url = $ddb6941ad6fc5d0a$var$__importStar($dBNrE$url);

var $cZVWD = parcelRequire("cZVWD");

var $dY7Uc = parcelRequire("dY7Uc");
var $ddb6941ad6fc5d0a$var$SignerExceptionMessages;
...
})($ddb6941ad6fc5d0a$var$SignerExceptionMessages || (module.exports.SignerExceptionMessages = $ddb6941ad6fc5d0a$var$SignerExceptionMessages = {}));
/*
 * Default signing version for getSignedUrl is 'v2'.
 */ const $ddb6941ad6fc5d0a$var$DEFAULT_SIGNING_VERSION = 'v2';
const $ddb6941ad6fc5d0a$var$SEVEN_DAYS = 604800;
/**
 * @const {string}
 * @deprecated - unused
 */ module.exports.PATH_STYLED_HOST = 'https://storage.googleapis.com';
class $ddb6941ad6fc5d0a$var$URLSigner {
    ...
    getSignedUrl(cfg) {
        ...
        if (expiresInSeconds < accessibleAtInSeconds) throw new Error($ddb6941ad6fc5d0a$var$SignerExceptionMessages.EXPIRATION_BEFORE_ACCESSIBLE_DATE);
        let customHost;
        ...
        const config = Object.assign({}, cfg, {
            ...
            file: this.file ? (0, $dY7Uc.encodeURI)(this.file.name, false) : undefined
        });
        if (customHost) config.cname = customHost;
        const version = cfg.version || $ddb6941ad6fc5d0a$var$DEFAULT_SIGNING_VERSION;
        let promise;
        ...
        return promise.then((query)=>{
            ...
            const signedUrl = new $ddb6941ad6fc5d0a$var$url.URL(((_a = cfg.host) === null || _a === void 0 ? void 0 : _a.toString()) || config.cname || this.storage.apiEndpoint);
            signedUrl.pathname = this.getResourcePath(!!config.cname, this.bucket.name, config.file);
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            signedUrl.search = (0, $dY7Uc.qsStringify)(query);
    ...
    getSignedUrlV2(config) {
        ...
        const sign = async ()=>{
            ...
            try {
                ...
                const error = err;
                const signingErr = new $ddb6941ad6fc5d0a$var$SigningError(error.message);
    ...
    getSignedUrlV4(config) {
        ...
        if (expiresPeriodInSeconds > $ddb6941ad6fc5d0a$var$SEVEN_DAYS) throw new Error(`Max allowed expiration is seven days (${$ddb6941ad6fc5d0a$var$SEVEN_DAYS} seconds).`);
        const extensionHeaders = Object.assign({}, config.extensionHeaders);
        const fqdn = new $ddb6941ad6fc5d0a$var$url.URL(((_a = config.host) === null || _a === void 0 ? void 0 : _a.toString()) || config.cname || this.storage.apiEndpoint);
        ...
        if (sha256Header) {
            if (typeof sha256Header !== 'string' || !/[A-Fa-f0-9]{40}/.test(sha256Header)) throw new Error($ddb6941ad6fc5d0a$var$SignerExceptionMessages.X_GOOG_CONTENT_SHA256);
        ...
        const datestamp = (0, $dY7Uc.formatAsUTCISO)(config.accessibleAt);
        const credentialScope = `${datestamp}/auto/storage/goog4_request`;
        const sign = async ()=>{
            var _a;
            const credentials = await this.auth.getCredentials();
            const credential = `${credentials.client_email}/${credentialScope}`;
            const dateISO = (0, $dY7Uc.formatAsUTCISO)(config.accessibleAt ? config.accessibleAt : new Date(), true);
            const queryParams = {
            ...
            const hash = $ddb6941ad6fc5d0a$var$crypto.createHash('sha256').update(canonicalRequest).digest('hex');
            const blobToSign = [
                'GOOG4-RSA-SHA256',
                dateISO,
                credentialScope,
     ...
     */ getCanonicalHeaders(headers) {
        ...
        const sortedHeaders = (0, $dY7Uc.objectEntries)(headers)// Convert header names to lowercase
    ...
    getCanonicalQueryParams(query) {
        return (0, $dY7Uc.objectEntries)(query).map(([key, value])=>[
                (0, $dY7Uc.encodeURI)(key, true),
                (0, $dY7Uc.encodeURI)(value, true)
    ...
    parseExpires(expires, current = new Date()) {
        ...
        if (isNaN(expiresInMSeconds)) throw new Error($cZVWD.ExceptionMessages.EXPIRATION_DATE_INVALID);
        if (expiresInMSeconds < current.valueOf()) throw new Error($cZVWD.ExceptionMessages.EXPIRATION_DATE_PAST);
    ...
    parseAccessibleAt(accessibleAt) {
        ...
        if (isNaN(accessibleAtInMSeconds)) throw new Error($ddb6941ad6fc5d0a$var$SignerExceptionMessages.ACCESSIBLE_DATE_INVALID);
        return Math.floor(accessibleAtInMSeconds / 1000); // The API expects seconds.
    }
}
module.exports.URLSigner = $ddb6941ad6fc5d0a$var$URLSigner;
/**
 * Custom error type for errors related to getting signed errors and policies.
 *
 * @private
 */ class $ddb6941ad6fc5d0a$var$SigningError extends Error {
    constructor(){
        super(...arguments);
        this.name = 'SigningError';
    }
}
module.exports.SigningError = $ddb6941ad6fc5d0a$var$SigningError;


//# sourceMappingURL=signer.15ba18b2.js.map
