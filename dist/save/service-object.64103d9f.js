...
var $g91iD$events = require("events");
...
var $d65ddf9902d10435$exports = {};
$d65ddf9902d10435$exports = new URL("build.97320181.js", "file:" + __filename).toString();
...
class $a1861966785b6a1b$var$ServiceObject extends $g91iD$events.EventEmitter {
    /*
     * @constructor
     ...
     */ constructor(config){
        ...
        Object.getOwnPropertyNames($a1861966785b6a1b$var$ServiceObject.prototype).filter((methodName)=>{
            ...
            $a1861966785b6a1b$var$ServiceObject.prototype[methodName] && // This method isn't wanted.
    ...
    delete(optionsOrCallback, cb) {
        var _a;
        const [options, callback] = $5vqXE.util.maybeOptionsOrCallback(optionsOrCallback, cb);
        ...
        $a1861966785b6a1b$var$ServiceObject.prototype.request.call(this, reqOpts, (err, body, res)=>{
            if (err) {
    ...
    get(optionsOrCallback, cb) {
        // eslint-disable-next-line @typescript-eslint/no-this-alias
        const self = this;
        const [opts, callback] = $5vqXE.util.maybeOptionsOrCallback(optionsOrCallback, cb);
...
module.exports.ServiceObject = $a1861966785b6a1b$var$ServiceObject;
(0, $d65ddf9902d10435$exports.promisifyAll)($a1861966785b6a1b$var$ServiceObject, {
    exclude: [
        'getRequestInterceptors'
    ]
});
