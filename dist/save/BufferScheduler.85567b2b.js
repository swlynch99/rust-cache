require("./PooledBuffer.b2d2711c.js");
var $3Bgnu$events = require("events");

// Copyright (c) Microsoft Corporation.
// Licensed under the MIT License.

var $a393178468d11575$exports = {};
$a393178468d11575$exports = new URL("PooledBuffer.b2d2711c.js", "file:" + __filename).toString();


class $4a080b54da477495$export$fa926c67c806d36a {
    /**
     ...
     */ constructor(readable, bufferSize, maxBuffers, outgoingHandler, concurrency, encoding){
         ...
         */ this.emitter = new (0, $3Bgnu$events.EventEmitter)();
        /**
     ...
     */ shiftBufferFromUnresolvedDataArray(buffer) {
        if (!buffer) buffer = new (0, $a393178468d11575$exports.PooledBuffer)(this.bufferSize, this.unresolvedDataArray, this.unresolvedLength);
