...
parcelRegister("hItxW", function(module, exports) {
module.exports = new URL("esm-node.c0a21ef2.js", "file:" + __filename).toString();

});

"use strict";
var $d4d4683586a645ad$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
...
var $d4d4683586a645ad$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
...
var $d4d4683586a645ad$var$__importStar = module.exports && module.exports.__importStar || function() {
    ...
    return function(mod) {
        ...
        var result = {};
        if (mod != null) {
            for(var k = ownKeys(mod), i = 0; i < k.length; i++)if (k[i] !== "default") $d4d4683586a645ad$var$__createBinding(result, mod, k[i]);
        }
        $d4d4683586a645ad$var$__setModuleDefault(result, mod);
        return result;
    };
}();
...
var $61d1adf7ce8d2eff$exports = {};
$61d1adf7ce8d2eff$exports = new URL("build.f178b9b0.js", "file:" + __filename).toString();



const $d4d4683586a645ad$var$uuid = $d4d4683586a645ad$var$__importStar((parcelRequire("hItxW")));
var $7f43eb63e6ee7db9$exports = {};
$7f43eb63e6ee7db9$exports = new URL("util.5e6d5c35.js", "file:" + __filename).toString();



var $dY7Uc = parcelRequire("dY7Uc");
module.exports.DEFAULT_PROJECT_ID_TOKEN = '{{projectId}}';
class $d4d4683586a645ad$var$Service {
    /**
     ...
     */ constructor(config, options = {}){
        ...
        this.universeDomain = options.universeDomain || $61d1adf7ce8d2eff$exports.DEFAULT_UNIVERSE;
        this.customEndpoint = config.customEndpoint || false;
        this.makeAuthenticatedRequest = $7f43eb63e6ee7db9$exports.util.makeAuthenticatedRequestFactory({
            ...config,
    ...
    request_(reqOpts, callback) {
        ...
        let userAgent = (0, $dY7Uc.getUserAgentString)();
        if (this.providedUserAgent) userAgent = `${this.providedUserAgent} ${userAgent}`;
        reqOpts.headers = {
            ...reqOpts.headers,
            'User-Agent': userAgent,
            'x-goog-api-client': `${(0, $dY7Uc.getRuntimeTrackingString)()} gccl/${pkg.version}-${(0, $dY7Uc.getModuleFormat)()} gccl-invocation-id/${$d4d4683586a645ad$var$uuid.v4()}`
        };
        if (reqOpts[$7f43eb63e6ee7db9$exports.GCCL_GCS_CMD_KEY]) reqOpts.headers['x-goog-api-client'] += ` gccl-gcs-cmd/${reqOpts[$7f43eb63e6ee7db9$exports.GCCL_GCS_CMD_KEY]}`;
     ...
     */ request(reqOpts, callback) {
        $d4d4683586a645ad$var$Service.prototype.request_.call(this, reqOpts, callback);
    }
    /**
     * Make an authenticated API request.
     *
     ...
     */ requestStream(reqOpts) {
        ...
        return $d4d4683586a645ad$var$Service.prototype.request_.call(this, opts);
    }
}
module.exports.Service = $d4d4683586a645ad$var$Service;


//# sourceMappingURL=service.346b1c25.js.map
