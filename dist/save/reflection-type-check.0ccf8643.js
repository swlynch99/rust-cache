...
var $d887dd49a9c3d6f1$exports = {};
$d887dd49a9c3d6f1$exports = new URL("oneof.55aeae26.js", "file:" + __filename).toString();


class $f8f6abf66f063a24$export$909924fefdf89590 {
    constructor(info){
        var _a;
     ...
     */ is(message, depth, allowExcessProperties = false) {
        ...
        for (const name of data.oneofs){
            ...
            if (!(0, $d887dd49a9c3d6f1$exports.isOneofGroup)(group)) return false;
    ...
    field(arg, field, allowExcessProperties, depth) {
        ...
        switch(field.kind){
            ...
            case "enum":
                if (arg === undefined) return field.opt;
                if (repeated) return this.scalars(arg, (0, $7KezH.ScalarType).INT32, depth);
                return this.scalar(arg, (0, $7KezH.ScalarType).INT32);
            case "message":
            ...
            case "map":
                ...
                switch(field.V.kind){
                    ...
                    case "enum":
                        return this.scalars(Object.values(arg), (0, $7KezH.ScalarType).INT32, depth);
                    case "message":
    ...
    mapKeys(map, type, depth) {
        ...
        switch(type){
            ...
            default:
                return this.scalars(keys, type, depth, (0, $7KezH.LongType).STRING);
        }
    }
}
