...
var $e786d8e04953b476$exports = {};
$e786d8e04953b476$exports = new URL("oauth2client.de126385.js", "file:" + __filename).toString();


class $2d0c805ce7d30880$var$Compute extends $e786d8e04953b476$exports.OAuth2Client {
    /**
    ...
    refreshToken) {
        ...
        try {
            ...
            data = await $gRBfr.instance(instanceOptions);
        } catch (e) {
            if (e instanceof $XskYs.GaxiosError) {
     ...
     */ async fetchIdToken(targetAudience) {
        ...
        try {
            ...
            idToken = await $gRBfr.instance(instanceOptions);
        } catch (e) {
...
module.exports.Compute = $2d0c805ce7d30880$var$Compute;
