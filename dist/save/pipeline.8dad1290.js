...
const $052f51e302b5f9ca$var$ValidPhaseNames = new Set([
    "Deserialize",
    "Serialize",
    "Retry",
    "Sign"
 ...
 * @internal
 */ class $052f51e302b5f9ca$var$HttpPipeline {
    ...
    addPolicy(policy, options = {}) {
        ...
        if (options.phase && !$052f51e302b5f9ca$var$ValidPhaseNames.has(options.phase)) throw new Error(`Invalid phase name: ${options.phase}`);
        if (options.afterPhase && !$052f51e302b5f9ca$var$ValidPhaseNames.has(options.afterPhase)) throw new Error(`Invalid afterPhase name: ${options.afterPhase}`);
        this._policies.push({
            policy: policy,
            options: options
        });
    ...
    clone() {
        return new $052f51e302b5f9ca$var$HttpPipeline(this._policies);
    }
    static create() {
        return new $052f51e302b5f9ca$var$HttpPipeline();
    }
    orderPolicies() {
        /**
...
function $052f51e302b5f9ca$export$d1727d948a2aa6e7() {
    return $052f51e302b5f9ca$var$HttpPipeline.create();
}


//# sourceMappingURL=pipeline.8dad1290.js.map
