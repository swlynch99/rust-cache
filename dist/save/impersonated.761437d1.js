...
module.exports.Impersonated = module.exports.IMPERSONATED_ACCOUNT_TYPE = void 0;
...
module.exports.IMPERSONATED_ACCOUNT_TYPE = 'impersonated_service_account';
class $843a56a91b014229$var$Impersonated extends $kdXrB.OAuth2Client {
    /**
     ...
     */ constructor(options = {}){
        ...
        this.sourceClient = (_a = options.sourceClient) !== null && _a !== void 0 ? _a : new $kdXrB.OAuth2Client();
        ...
        const usingExplicitUniverseDomain = !!(0, $7miiN.originalOrCamelOptions)(options).get('universe_domain');
        if (!usingExplicitUniverseDomain) // override the default universe with the source's universe
        this.universeDomain = this.sourceClient.universeDomain;
        else if (this.sourceClient.universeDomain !== this.universeDomain) // non-default universe and is not matching the source - this could be a credential leak
     ...
     */ async sign(blobToSign) {
        ...
        const res = await this.sourceClient.request({
            ...$843a56a91b014229$var$Impersonated.RETRY_CONFIG,
            url: u,
            data: body,
            method: 'POST'
        });
     ...
     */ async refreshToken() {
        ...
        try {
            ...
            let status = 0;
            let message = '';
            if (error instanceof $47hCt.GaxiosError) {
...
module.exports.Impersonated = $843a56a91b014229$var$Impersonated;


//# sourceMappingURL=impersonated.761437d1.js.map
