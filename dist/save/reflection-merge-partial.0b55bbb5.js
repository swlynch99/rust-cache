 ...
 */ function $780403fdedc8eaaf$export$222be1b8ba523a3a(info, target, source) {
    let fieldValue, input = source, output; // where we want our field value to go
    for (let field of info.fields){
        let name = field.localName;
        if (field.oneof) {
            const group = input[field.oneof]; // this is the oneof`s group in the source
            if ((group === null || group === void 0 ? void 0 : group.oneofKind) == undefined) continue; // we skip this field, and all other members too
            ...
            if (fieldValue == undefined) continue; // skip further work on field, existing value is used as is
        }
...
//# sourceMappingURL=reflection-merge-partial.0b55bbb5.js.map
