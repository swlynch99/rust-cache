...
class $6e5b8c1d117b1cab$var$Impersonated extends $flpnV.OAuth2Client {
    /**
     ...
     */ constructor(options = {}){
        ...
        this.sourceClient = (_a = options.sourceClient) !== null && _a !== void 0 ? _a : new $flpnV.OAuth2Client();
        ...
        const usingExplicitUniverseDomain = !!(0, $4ZmfA.originalOrCamelOptions)(options).get('universe_domain');
     ...
     */ async sign(blobToSign) {
        ...
        const res = await this.sourceClient.request({
            ...$6e5b8c1d117b1cab$var$Impersonated.RETRY_CONFIG,
            url: u,
            data: body,
            method: 'POST'
        });
     ...
     */ async refreshToken() {
        ...
        try {
            ...
            let status = 0;
            let message = '';
            if (error instanceof $XskYs.GaxiosError) {
...
module.exports.Impersonated = $6e5b8c1d117b1cab$var$Impersonated;
