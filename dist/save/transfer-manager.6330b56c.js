...
var $7UR4G$path = require("path");
var $7UR4G$fs = require("fs");
var $7UR4G$crypto = require("crypto");
...
parcelRegister("1tNet", function(module, exports) {
"use strict";
/*!
 ...
 */ var $113eb0682a0f420c$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
...
var $113eb0682a0f420c$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
...
var $113eb0682a0f420c$var$__importStar = module.exports && module.exports.__importStar || function() {
    ...
    return function(mod) {
        ...
        var result = {};
        if (mod != null) {
            for(var k = ownKeys(mod), i = 0; i < k.length; i++)if (k[i] !== "default") $113eb0682a0f420c$var$__createBinding(result, mod, k[i]);
        }
        $113eb0682a0f420c$var$__setModuleDefault(result, mod);
        return result;
    };
}();
var $113eb0682a0f420c$var$__classPrivateFieldGet = module.exports && module.exports.__classPrivateFieldGet || function(receiver, state, kind, f) {
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a getter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
    return kind === "m" ? f : kind === "a" ? f.call(receiver) : f ? f.value : state.get(receiver);
};
var $113eb0682a0f420c$var$__importDefault = module.exports && module.exports.__importDefault || function(mod) {
    return mod && mod.__esModule ? mod : {
        "default": mod
    };
};
var $113eb0682a0f420c$var$_XMLMultiPartUploadHelper_instances, $113eb0682a0f420c$var$_XMLMultiPartUploadHelper_setGoogApiClientHeaders, $113eb0682a0f420c$var$_XMLMultiPartUploadHelper_handleErrorResponse;
...
const $113eb0682a0f420c$var$p_limit_1 = $113eb0682a0f420c$var$__importDefault((parcelRequire("emrrZ")));

const $113eb0682a0f420c$var$path = $113eb0682a0f420c$var$__importStar($7UR4G$path);
...
var $930fU = parcelRequire("930fU");

const $113eb0682a0f420c$var$async_retry_1 = $113eb0682a0f420c$var$__importDefault((parcelRequire("7yoQv")));
 ...
 */ const $113eb0682a0f420c$var$GCCL_GCS_CMD_FEATURE = {
...
const $113eb0682a0f420c$var$defaultMultiPartGenerator = (bucket, fileName, uploadId, partsMap)=>{
    return new $113eb0682a0f420c$var$XMLMultiPartUploadHelper(bucket, fileName, uploadId, partsMap);
};
class $113eb0682a0f420c$var$MultiPartUploadError extends Error {
...
module.exports.MultiPartUploadError = $113eb0682a0f420c$var$MultiPartUploadError;
/**
 * Class representing an implementation of MPU in the XML API. This class is not meant for public usage.
 *
 * @private
 *
 */ class $113eb0682a0f420c$var$XMLMultiPartUploadHelper {
    constructor(bucket, fileName, uploadId, partsMap){
        $113eb0682a0f420c$var$_XMLMultiPartUploadHelper_instances.add(this);
        this.authClient = bucket.storage.authClient || new $198ix.GoogleAuth();
        this.uploadId = uploadId || '';
        this.bucket = bucket;
        this.fileName = fileName;
        this.baseUrl = `https://${bucket.name}.${new URL(this.bucket.storage.apiEndpoint).hostname}/${fileName}`;
        this.xmlBuilder = new $930fU.XMLBuilder({
            arrayNodeName: 'Part'
        });
        this.xmlParser = new $930fU.XMLParser();
     ...
     */ async initiateUpload(headers = {}) {
        ...
        return (0, $113eb0682a0f420c$var$async_retry_1.default)(async (bail)=>{
            try {
                const res = await this.authClient.request({
                    headers: $113eb0682a0f420c$var$__classPrivateFieldGet(this, $113eb0682a0f420c$var$_XMLMultiPartUploadHelper_instances, "m", $113eb0682a0f420c$var$_XMLMultiPartUploadHelper_setGoogApiClientHeaders).call(this, headers),
                    method: 'POST',
                    url: url
                });
                ...
                $113eb0682a0f420c$var$__classPrivateFieldGet(this, $113eb0682a0f420c$var$_XMLMultiPartUploadHelper_instances, "m", $113eb0682a0f420c$var$_XMLMultiPartUploadHelper_handleErrorResponse).call(this, e, bail);
            }
        }, this.retryOptions);
    }
    /**
     ...
     */ async uploadPart(partNumber, chunk, validation) {
        ...
        let headers = $113eb0682a0f420c$var$__classPrivateFieldGet(this, $113eb0682a0f420c$var$_XMLMultiPartUploadHelper_instances, "m", $113eb0682a0f420c$var$_XMLMultiPartUploadHelper_setGoogApiClientHeaders).call(this);
        if (validation === 'md5') {
            const hash = (0, $7UR4G$crypto.createHash)('md5').update(chunk).digest('base64');
            headers = {
                'Content-MD5': hash
            };
        }
     ...
     */ async completeUpload() {
        ...
        return (0, $113eb0682a0f420c$var$async_retry_1.default)(async (bail)=>{
            try {
                const res = await this.authClient.request({
                    headers: $113eb0682a0f420c$var$__classPrivateFieldGet(this, $113eb0682a0f420c$var$_XMLMultiPartUploadHelper_instances, "m", $113eb0682a0f420c$var$_XMLMultiPartUploadHelper_setGoogApiClientHeaders).call(this),
                    url: url,
                    method: 'POST',
                    body: body
                });
...
$113eb0682a0f420c$var$_XMLMultiPartUploadHelper_instances = new WeakSet(), $113eb0682a0f420c$var$_XMLMultiPartUploadHelper_setGoogApiClientHeaders = function _XMLMultiPartUploadHelper_setGoogApiClientHeaders(headers = {}) {
    ...
    for (const [key, value] of Object.entries(headers)){
        if (key.toLocaleLowerCase().trim() === 'x-goog-api-client') {
            ...
            if (!value.includes($113eb0682a0f420c$var$GCCL_GCS_CMD_FEATURE.UPLOAD_SHARDED)) headers[key] = `${value} gccl-gcs-cmd/${$113eb0682a0f420c$var$GCCL_GCS_CMD_FEATURE.UPLOAD_SHARDED}`;
        } else if (key.toLocaleLowerCase().trim() === 'user-agent') userAgentFound = true;
    }
    // If the header isn't present, add it
    if (!headerFound) headers['x-goog-api-client'] = `${(0, $liF6k.getRuntimeTrackingString)()} gccl/${$113eb0682a0f420c$var$packageJson.version} gccl-gcs-cmd/${$113eb0682a0f420c$var$GCCL_GCS_CMD_FEATURE.UPLOAD_SHARDED}`;
    // If the User-Agent isn't present, add it
    if (!userAgentFound) headers['User-Agent'] = (0, $liF6k.getUserAgentString)();
    return headers;
}, $113eb0682a0f420c$var$_XMLMultiPartUploadHelper_handleErrorResponse = function _XMLMultiPartUploadHelper_handleErrorResponse(err, bail) {
 ...
 *
 */ class $113eb0682a0f420c$var$TransferManager {
    constructor(bucket){
        this.bucket = bucket;
    }
    /**
     ...
     */ async uploadManyFiles(filePathsOrDirectory, options = {}) {
        ...
        const limit = (0, $113eb0682a0f420c$var$p_limit_1.default)(options.concurrencyLimit || $113eb0682a0f420c$var$DEFAULT_PARALLEL_UPLOAD_LIMIT);
        const promises = [];
        let allPaths = [];
        ...
        for (const filePath of allPaths){
            const stat = await $7UR4G$fs.promises.lstat(filePath);
            if (stat.isDirectory()) continue;
            const passThroughOptionsCopy = {
                ...options.passthroughOptions,
                [$5vqXE.GCCL_GCS_CMD_KEY]: $113eb0682a0f420c$var$GCCL_GCS_CMD_FEATURE.UPLOAD_MANY
            };
            passThroughOptionsCopy.destination = options.customDestinationBuilder ? options.customDestinationBuilder(filePath, options) : filePath.split($113eb0682a0f420c$var$path.sep).join($113eb0682a0f420c$var$path.posix.sep);
            if (options.prefix) passThroughOptionsCopy.destination = $113eb0682a0f420c$var$path.posix.join(...options.prefix.split($113eb0682a0f420c$var$path.sep), passThroughOptionsCopy.destination);
     ...
     */ async downloadManyFiles(filesOrFolder, options = {}) {
        const limit = (0, $113eb0682a0f420c$var$p_limit_1.default)(options.concurrencyLimit || $113eb0682a0f420c$var$DEFAULT_PARALLEL_DOWNLOAD_LIMIT);
        const promises = [];
        let files = [];
        ...
        const stripRegexString = options.stripPrefix ? `^${options.stripPrefix}` : $113eb0682a0f420c$var$EMPTY_REGEX;
        const regex = new RegExp(stripRegexString, 'g');
        for (const file of files){
            const passThroughOptionsCopy = {
                ...options.passthroughOptions,
                [$5vqXE.GCCL_GCS_CMD_KEY]: $113eb0682a0f420c$var$GCCL_GCS_CMD_FEATURE.DOWNLOAD_MANY
            };
            if (options.prefix || passThroughOptionsCopy.destination) passThroughOptionsCopy.destination = $113eb0682a0f420c$var$path.join(options.prefix || '', passThroughOptionsCopy.destination || '', file.name);
            if (options.stripPrefix) passThroughOptionsCopy.destination = file.name.replace(regex, '');
            if (options.skipIfExists && (0, $7UR4G$fs.existsSync)(passThroughOptionsCopy.destination || '')) continue;
            promises.push(limit(async ()=>{
                const destination = passThroughOptionsCopy.destination;
                if (destination && destination.endsWith($113eb0682a0f420c$var$path.sep)) {
                    await $7UR4G$fs.promises.mkdir(destination, {
                        recursive: true
                    });
     ...
     */ async downloadFileInChunks(fileOrName, options = {}) {
        let chunkSize = options.chunkSizeBytes || $113eb0682a0f420c$var$DOWNLOAD_IN_CHUNKS_DEFAULT_CHUNK_SIZE;
        let limit = (0, $113eb0682a0f420c$var$p_limit_1.default)(options.concurrencyLimit || $113eb0682a0f420c$var$DEFAULT_PARALLEL_CHUNKED_DOWNLOAD_LIMIT);
        ...
        if (size < $113eb0682a0f420c$var$DOWNLOAD_IN_CHUNKS_FILE_SIZE_THRESHOLD) {
            limit = (0, $113eb0682a0f420c$var$p_limit_1.default)(1);
            chunkSize = size;
        }
        let start = 0;
        const filePath = options.destination || $113eb0682a0f420c$var$path.basename(file.name);
        const fileToWrite = await $7UR4G$fs.promises.open(filePath, 'w');
        while(start < size){
            ...
            promises.push(limit(async ()=>{
                const resp = await file.download({
                    ...
                    [$5vqXE.GCCL_GCS_CMD_KEY]: $113eb0682a0f420c$var$GCCL_GCS_CMD_FEATURE.DOWNLOAD_SHARDED
                });
        ...
        if (options.validation === 'crc32c' && fileInfo[0].metadata.crc32c) {
            const downloadedCrc32C = await $lEAcs.CRC32C.fromFile(filePath);
     ...
     *
     *
     */ async uploadFileInChunks(filePath, options = {}, generator = $113eb0682a0f420c$var$defaultMultiPartGenerator) {
        const chunkSize = options.chunkSizeBytes || $113eb0682a0f420c$var$UPLOAD_IN_CHUNKS_DEFAULT_CHUNK_SIZE;
        const limit = (0, $113eb0682a0f420c$var$p_limit_1.default)(options.concurrencyLimit || $113eb0682a0f420c$var$DEFAULT_PARALLEL_CHUNKED_UPLOAD_LIMIT);
        const maxQueueSize = options.maxQueueSize || options.concurrencyLimit || $113eb0682a0f420c$var$DEFAULT_PARALLEL_CHUNKED_UPLOAD_LIMIT;
        const fileName = options.uploadName || $113eb0682a0f420c$var$path.basename(filePath);
        ...
        try {
            ...
            const readStream = (0, $7UR4G$fs.createReadStream)(filePath, {
            ...
            if ((options.autoAbortFailure === undefined || options.autoAbortFailure) && mpuHelper.uploadId) try {
                ...
                throw new $113eb0682a0f420c$var$MultiPartUploadError(e.message, mpuHelper.uploadId, mpuHelper.partsMap);
            }
            throw new $113eb0682a0f420c$var$MultiPartUploadError(e.message, mpuHelper.uploadId, mpuHelper.partsMap);
        }
    }
    async *getPathsFromDirectory(directory) {
        const filesAndSubdirectories = await $7UR4G$fs.promises.readdir(directory, {
            withFileTypes: true
        });
        for (const curFileOrDirectory of filesAndSubdirectories){
            const fullPath = $113eb0682a0f420c$var$path.join(directory, curFileOrDirectory.name);
            curFileOrDirectory.isDirectory() ? yield* this.getPathsFromDirectory(fullPath) : yield fullPath;
        }
    }
}
module.exports.TransferManager = $113eb0682a0f420c$var$TransferManager;
