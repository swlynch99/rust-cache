require("./abort-controller.9096e7c9.js");
...
var $2SngO$crypto = require("crypto");
var $2SngO$stream = require("stream");
...
parcelRegister("2Npyc", function(module, exports) {
"use strict";
...
var $2093fa2fed88015f$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
...
var $2093fa2fed88015f$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
...
var $2093fa2fed88015f$var$__importStar = module.exports && module.exports.__importStar || function() {
    ...
    return function(mod) {
        ...
        var result = {};
        if (mod != null) {
            for(var k = ownKeys(mod), i = 0; i < k.length; i++)if (k[i] !== "default") $2093fa2fed88015f$var$__createBinding(result, mod, k[i]);
        }
        $2093fa2fed88015f$var$__setModuleDefault(result, mod);
        return result;
    };
}();
var $2093fa2fed88015f$var$__classPrivateFieldSet = module.exports && module.exports.__classPrivateFieldSet || function(receiver, state, value, kind, f) {
    if (kind === "m") throw new TypeError("Private method is not writable");
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
    return kind === "a" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value), value;
};
var $2093fa2fed88015f$var$__classPrivateFieldGet = module.exports && module.exports.__classPrivateFieldGet || function(receiver, state, kind, f) {
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a getter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
    return kind === "m" ? f : kind === "a" ? f.call(receiver) : f ? f.value : state.get(receiver);
};
var $2093fa2fed88015f$var$__importDefault = module.exports && module.exports.__importDefault || function(mod) {
    return mod && mod.__esModule ? mod : {
        "default": mod
    };
};
var $2093fa2fed88015f$var$_Upload_instances, $2093fa2fed88015f$var$_Upload_gcclGcsCmd, $2093fa2fed88015f$var$_Upload_resetLocalBuffersCache, $2093fa2fed88015f$var$_Upload_addLocalBufferCache;
Object.defineProperty(module.exports, "__esModule", {
    value: true
});
module.exports.Upload = module.exports.PROTOCOL_REGEX = void 0;
module.exports.upload = $2093fa2fed88015f$var$upload;
module.exports.createURI = $2093fa2fed88015f$var$createURI;
module.exports.checkUploadStatus = $2093fa2fed88015f$var$checkUploadStatus;

const $2093fa2fed88015f$var$abort_controller_1 = $2093fa2fed88015f$var$__importDefault((parcelRequire("7T6Nv")));


const $2093fa2fed88015f$var$gaxios = $2093fa2fed88015f$var$__importStar((parcelRequire("XskYs")));

var $198ix = parcelRequire("198ix");


const $2093fa2fed88015f$var$async_retry_1 = $2093fa2fed88015f$var$__importDefault((parcelRequire("7yoQv")));

const $2093fa2fed88015f$var$uuid = $2093fa2fed88015f$var$__importStar((parcelRequire("4LNNE")));
...
const $2093fa2fed88015f$var$NOT_FOUND_STATUS_CODE = 404;
const $2093fa2fed88015f$var$RESUMABLE_INCOMPLETE_STATUS_CODE = 308;
const $2093fa2fed88015f$var$packageJson = (0, $6lv1n.getPackageJSON)();
module.exports.PROTOCOL_REGEX = /^(\w*):\/\//;
class $2093fa2fed88015f$var$Upload extends $2SngO$stream.Writable {
    constructor(cfg){
        var _a;
        super(cfg);
        $2093fa2fed88015f$var$_Upload_instances.add(this);
        this.numBytesWritten = 0;
        this.numRetries = 0;
        this.currentInvocationId = {
            checkUploadStatus: $2093fa2fed88015f$var$uuid.v4(),
            chunk: $2093fa2fed88015f$var$uuid.v4(),
            uri: $2093fa2fed88015f$var$uuid.v4()
        };
        /**
        ...
        $2093fa2fed88015f$var$_Upload_gcclGcsCmd.set(this, void 0);
        cfg = cfg || {};
        ...
        this.authClient = cfg.authClient || new $198ix.GoogleAuth(cfg.authConfig);
        const universe = cfg.universeDomain || $198ix.DEFAULT_UNIVERSE;
        ...
        if (cfg.apiEndpoint && cfg.apiEndpoint !== this.apiEndpoint) {
            ...
            const isDefaultUniverseDomain = hostname === $198ix.DEFAULT_UNIVERSE;
            ...
            const isSubDomainOfDefaultUniverse = hostname.slice(-($198ix.DEFAULT_UNIVERSE.length + 1)) === `.${$198ix.DEFAULT_UNIVERSE}`;
            if (!isDomain && !isDefaultUniverseDomain && !isSubDomainOfUniverse && !isSubDomainOfDefaultUniverse) // a custom, non-universe domain,
            // use gaxios
            this.authClient = $2093fa2fed88015f$var$gaxios;
        }
        ...
        if (cfg.key) {
            ...
            this.encryption = {
                key: base64Key,
                hash: (0, $2SngO$crypto.createHash)('sha256').update(cfg.key).digest('base64')
            };
        }
        ...
        $2093fa2fed88015f$var$__classPrivateFieldSet(this, $2093fa2fed88015f$var$_Upload_gcclGcsCmd, cfg[$5vqXE.GCCL_GCS_CMD_KEY], "f");
        this.once('writing', ()=>{
     ...
     */ prependLocalBufferToUpstream(keepLastBytes) {
        ...
        $2093fa2fed88015f$var$__classPrivateFieldGet(this, $2093fa2fed88015f$var$_Upload_instances, "m", $2093fa2fed88015f$var$_Upload_resetLocalBuffersCache).call(this);
    }
    /**
    ...
    async createURIAsync() {
        ...
        let googAPIClient = `${(0, $liF6k.getRuntimeTrackingString)()} gccl/${$2093fa2fed88015f$var$packageJson.version}-${(0, $liF6k.getModuleFormat)()} gccl-invocation-id/${this.currentInvocationId.uri}`;
        if ($2093fa2fed88015f$var$__classPrivateFieldGet(this, $2093fa2fed88015f$var$_Upload_gcclGcsCmd, "f")) googAPIClient += ` gccl-gcs-cmd/${$2093fa2fed88015f$var$__classPrivateFieldGet(this, $2093fa2fed88015f$var$_Upload_gcclGcsCmd, "f")}`;
        ...
        const reqOpts = {
            ...
            data: metadata,
            headers: {
                'User-Agent': (0, $liF6k.getUserAgentString)(),
        ...
        const uri = await (0, $2093fa2fed88015f$var$async_retry_1.default)(async (bail)=>{
            var _a, _b, _c;
            try {
                const res = await this.makeRequest(reqOpts);
                // We have successfully got a URI we can now create a new invocation id
                this.currentInvocationId.uri = $2093fa2fed88015f$var$uuid.v4();
    ...
    async startUploading() {
        ...
        const requestStream = new $2SngO$stream.Readable({
            read: async ()=>{
                ...
                if (result.value) {
                    ...
                    $2093fa2fed88015f$var$__classPrivateFieldGet(this, $2093fa2fed88015f$var$_Upload_instances, "m", $2093fa2fed88015f$var$_Upload_addLocalBufferCache).call(this, result.value);
                    else {
                        $2093fa2fed88015f$var$__classPrivateFieldGet(this, $2093fa2fed88015f$var$_Upload_instances, "m", $2093fa2fed88015f$var$_Upload_resetLocalBuffersCache).call(this);
                        $2093fa2fed88015f$var$__classPrivateFieldGet(this, $2093fa2fed88015f$var$_Upload_instances, "m", $2093fa2fed88015f$var$_Upload_addLocalBufferCache).call(this, result.value);
                    }
        ...
        let googAPIClient = `${(0, $liF6k.getRuntimeTrackingString)()} gccl/${$2093fa2fed88015f$var$packageJson.version}-${(0, $liF6k.getModuleFormat)()} gccl-invocation-id/${this.currentInvocationId.chunk}`;
        if ($2093fa2fed88015f$var$__classPrivateFieldGet(this, $2093fa2fed88015f$var$_Upload_gcclGcsCmd, "f")) googAPIClient += ` gccl-gcs-cmd/${$2093fa2fed88015f$var$__classPrivateFieldGet(this, $2093fa2fed88015f$var$_Upload_gcclGcsCmd, "f")}`;
        const headers = {
            'User-Agent': (0, $liF6k.getUserAgentString)(),
            'x-goog-api-client': googAPIClient
        ...
        if (multiChunkMode) {
            ...
            $2093fa2fed88015f$var$__classPrivateFieldGet(this, $2093fa2fed88015f$var$_Upload_instances, "m", $2093fa2fed88015f$var$_Upload_addLocalBufferCache).call(this, chunk);
    ...
    async responseHandler(resp) {
        ...
        this.currentInvocationId.chunk = $2093fa2fed88015f$var$uuid.v4();
        const moreDataToUpload = await this.waitForNextChunk();
        const shouldContinueWithNextMultiChunkRequest = this.chunkSize && resp.status === $2093fa2fed88015f$var$RESUMABLE_INCOMPLETE_STATUS_CODE && resp.headers.range && moreDataToUpload;
        /**
         ...
         */ const shouldContinueUploadInAnotherRequest = this.isPartialUpload && resp.status === $2093fa2fed88015f$var$RESUMABLE_INCOMPLETE_STATUS_CODE && !moreDataToUpload;
     ...
     */ async checkUploadStatus(config = {}) {
        let googAPIClient = `${(0, $liF6k.getRuntimeTrackingString)()} gccl/${$2093fa2fed88015f$var$packageJson.version}-${(0, $liF6k.getModuleFormat)()} gccl-invocation-id/${this.currentInvocationId.checkUploadStatus}`;
        if ($2093fa2fed88015f$var$__classPrivateFieldGet(this, $2093fa2fed88015f$var$_Upload_gcclGcsCmd, "f")) googAPIClient += ` gccl-gcs-cmd/${$2093fa2fed88015f$var$__classPrivateFieldGet(this, $2093fa2fed88015f$var$_Upload_gcclGcsCmd, "f")}`;
        const opts = {
            method: 'PUT',
            url: this.uri,
        ...
        try {
            ...
            this.currentInvocationId.checkUploadStatus = $2093fa2fed88015f$var$uuid.v4();
            return resp;
        } catch (e) {
    ...
    async getAndSetOffset() {
        try {
            ...
            if (resp.status === $2093fa2fed88015f$var$RESUMABLE_INCOMPLETE_STATUS_CODE) {
    ...
    async makeRequest(reqOpts) {
        ...
        reqOpts.validateStatus = (status)=>{
            return this.isSuccessfulResponse(status) || status === $2093fa2fed88015f$var$RESUMABLE_INCOMPLETE_STATUS_CODE;
        };
    ...
    async makeRequestStream(reqOpts) {
        const controller = new $2093fa2fed88015f$var$abort_controller_1.default();
     ...
     */ attemptDelayedRetry(resp) {
        if (this.numRetries < this.retryOptions.maxRetries) {
            if (resp.status === $2093fa2fed88015f$var$NOT_FOUND_STATUS_CODE && this.numChunksReadInRequest === 0) this.startUploading();
            else {
                const retryDelay = this.getRetryDelay();
                if (retryDelay <= 0) {
...
module.exports.Upload = $2093fa2fed88015f$var$Upload;
$2093fa2fed88015f$var$_Upload_gcclGcsCmd = new WeakMap(), $2093fa2fed88015f$var$_Upload_instances = new WeakSet(), $2093fa2fed88015f$var$_Upload_resetLocalBuffersCache = function _Upload_resetLocalBuffersCache() {
    this.localWriteCache = [];
    this.localWriteCacheByteLength = 0;
}, $2093fa2fed88015f$var$_Upload_addLocalBufferCache = function _Upload_addLocalBufferCache(buf) {
    this.localWriteCache.push(buf);
    this.localWriteCacheByteLength += buf.byteLength;
};
function $2093fa2fed88015f$var$upload(cfg) {
    return new $2093fa2fed88015f$var$Upload(cfg);
}
function $2093fa2fed88015f$var$createURI(cfg, callback) {
    const up = new $2093fa2fed88015f$var$Upload(cfg);
 ...
 * @param cfg A configuration to use. `uri` is required.
 * @returns the current upload status
 */ function $2093fa2fed88015f$var$checkUploadStatus(cfg) {
    const up = new $2093fa2fed88015f$var$Upload(cfg);
    return up.checkUploadStatus();
}

});
parcelRegister("7T6Nv", function(module, exports) {
module.exports = new URL("abort-controller.9096e7c9.js", "file:" + __filename).toString();
