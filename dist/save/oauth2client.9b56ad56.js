...
var $hDSwE$querystring = require("querystring");
var $hDSwE$stream = require("stream");
...
module.exports.OAuth2Client = module.exports.ClientAuthentication = module.exports.CertificateFormat = module.exports.CodeChallengeMethod = void 0;

var $47hCt = parcelRequire("47hCt");


var $7f66aa30e6d75617$exports = {};
$7f66aa30e6d75617$exports = new URL("ecdsa-sig-formatter.1acc6ad0.js", "file:" + __filename).toString();



var $jVpvg = parcelRequire("jVpvg");
var $90770d794cc85d4c$exports = {};
$90770d794cc85d4c$exports = new URL("authclient.c802c873.js", "file:" + __filename).toString();


var $96bc58f5b03825fc$exports = {};
$96bc58f5b03825fc$exports = new URL("loginticket.b50b8763.js", "file:" + __filename).toString();


var $03ccb218890bc148$var$CodeChallengeMethod;
(function(CodeChallengeMethod) {
    CodeChallengeMethod["Plain"] = "plain";
    CodeChallengeMethod["S256"] = "S256";
})($03ccb218890bc148$var$CodeChallengeMethod || (module.exports.CodeChallengeMethod = $03ccb218890bc148$var$CodeChallengeMethod = {}));
var $03ccb218890bc148$var$CertificateFormat;
(function(CertificateFormat) {
    CertificateFormat["PEM"] = "PEM";
    CertificateFormat["JWK"] = "JWK";
})($03ccb218890bc148$var$CertificateFormat || (module.exports.CertificateFormat = $03ccb218890bc148$var$CertificateFormat = {}));
/**
 * The client authentication type. Supported values are basic, post, and none.
 * https://datatracker.ietf.org/doc/html/rfc7591#section-2
 */ var $03ccb218890bc148$var$ClientAuthentication;
...
})($03ccb218890bc148$var$ClientAuthentication || (module.exports.ClientAuthentication = $03ccb218890bc148$var$ClientAuthentication = {}));
class $03ccb218890bc148$var$OAuth2Client extends $90770d794cc85d4c$exports.AuthClient {
    constructor(optionsOrClientId, clientSecret, redirectUri){
        ...
        this.certificateCacheFormat = $03ccb218890bc148$var$CertificateFormat.PEM;
        ...
        this.clientAuthentication = opts.clientAuthentication || $03ccb218890bc148$var$ClientAuthentication.ClientSecretPost;
     ...
     */ generateAuthUrl(opts = {}) {
        ...
        return rootUrl + '?' + $hDSwE$querystring.stringify(opts);
    }
     ...
     */ async generateCodeVerifierAsync() {
        ...
        const crypto = (0, $jVpvg.createCrypto)();
    ...
    async getTokenAsync(options) {
        ...
        if (this.clientAuthentication === $03ccb218890bc148$var$ClientAuthentication.ClientSecretBasic) {
            const basic = Buffer.from(`${this._clientId}:${this._clientSecret}`);
            headers['Authorization'] = `Basic ${basic.toString('base64')}`;
        }
        if (this.clientAuthentication === $03ccb218890bc148$var$ClientAuthentication.ClientSecretPost) values.client_secret = this._clientSecret;
        const res = await this.transporter.request({
            ...$03ccb218890bc148$var$OAuth2Client.RETRY_CONFIG,
            method: 'POST',
            url: url,
            data: $hDSwE$querystring.stringify(values),
            headers: headers
        });
    ...
    async refreshTokenNoCache(refreshToken) {
        ...
        try {
            ...
            res = await this.transporter.request({
                ...
                method: 'POST',
                url: url,
                data: $hDSwE$querystring.stringify(data),
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                }
            });
        } catch (e) {
            if (e instanceof $47hCt.GaxiosError && e.message === 'invalid_grant' && ((_a = e.response) === null || _a === void 0 ? void 0 : _a.data) && /ReAuth/i.test(e.response.data.error_description)) e.message = JSON.stringify(e.response.data);
            throw e;
        }
        const tokens = res.data;
     ...
     */ static getRevokeTokenUrl(token) {
        return new $03ccb218890bc148$var$OAuth2Client().getRevokeTokenURL(token).toString();
    }
    /**
    ...
    async requestAsync(opts, reAuthRetried = false) {
        ...
        try {
            ...
            if (res) {
                ...
                const isReadableStream = res.config.data instanceof $hDSwE$stream.Readable;
     ...
     */ async getTokenInfo(accessToken) {
        const { data: data } = await this.transporter.request({
            ...$03ccb218890bc148$var$OAuth2Client.RETRY_CONFIG,
            method: 'POST',
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
    ...
    async getFederatedSignonCertsAsync() {
        ...
        const format = (0, $jVpvg.hasBrowserCrypto)() ? $03ccb218890bc148$var$CertificateFormat.JWK : $03ccb218890bc148$var$CertificateFormat.PEM;
        ...
        let url;
        switch(format){
            case $03ccb218890bc148$var$CertificateFormat.PEM:
                url = this.endpoints.oauth2FederatedSignonPemCertsUrl.toString();
                break;
            case $03ccb218890bc148$var$CertificateFormat.JWK:
        ...
        if (cacheControl) {
            ...
            if (regexResult && regexResult.length === 2) // Cache results with max-age (in seconds)
     ...
     */ async verifySignedJwtWithCertsAsync(jwt, certs, requiredAudience, issuers, maxExpiry) {
        const crypto = (0, $jVpvg.createCrypto)();
        if (!maxExpiry) maxExpiry = $03ccb218890bc148$var$OAuth2Client.DEFAULT_MAX_TOKEN_LIFETIME_SECS_;
        ...
        if (!Object.prototype.hasOwnProperty.call(certs, envelope.kid)) // If this is not present, then there's no reason to attempt verification
        throw new Error('No pem found for envelope: ' + JSON.stringify(envelope));
        const cert = certs[envelope.kid];
        if (envelope.alg === 'ES256') signature = $7f66aa30e6d75617$exports.joseToDer(signature, 'ES256').toString('base64');
        ...
        const earliest = iat - $03ccb218890bc148$var$OAuth2Client.CLOCK_SKEW_SECS_;
        const latest = exp + $03ccb218890bc148$var$OAuth2Client.CLOCK_SKEW_SECS_;
        ...
        return new $96bc58f5b03825fc$exports.LoginTicket(envelope, payload);
    }
    /**
...
module.exports.OAuth2Client = $03ccb218890bc148$var$OAuth2Client;
/**
 * @deprecated use instance's {@link OAuth2Client.endpoints}
 */ $03ccb218890bc148$var$OAuth2Client.GOOGLE_TOKEN_INFO_URL = 'https://oauth2.googleapis.com/tokeninfo';
/**
 * Clock skew - five minutes in seconds
 */ $03ccb218890bc148$var$OAuth2Client.CLOCK_SKEW_SECS_ = 300;
/**
 * The default max Token Lifetime is one day in seconds
 */ $03ccb218890bc148$var$OAuth2Client.DEFAULT_MAX_TOKEN_LIFETIME_SECS_ = 86400;


//# sourceMappingURL=oauth2client.9b56ad56.js.map
