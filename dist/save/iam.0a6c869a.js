...
var $c2993a27a2cf9510$var$IAMExceptionMessages;
...
})($c2993a27a2cf9510$var$IAMExceptionMessages || (module.exports.IAMExceptionMessages = $c2993a27a2cf9510$var$IAMExceptionMessages = {}));
/**
 ...
 * // bucket.iam
 * ```
 */ class $c2993a27a2cf9510$var$Iam {
    constructor(bucket){
     ...
     */ getPolicy(optionsOrCallback, callback) {
        const { options: options, callback: cb } = (0, $liF6k.normalize)(optionsOrCallback, callback);
        const qs = {};
     ...
     */ setPolicy(policy, optionsOrCallback, callback) {
        if (policy === null || typeof policy !== 'object') throw new Error($c2993a27a2cf9510$var$IAMExceptionMessages.POLICY_OBJECT_REQUIRED);
        const { options: options, callback: cb } = (0, $liF6k.normalize)(optionsOrCallback, callback);
        let maxRetries;
     ...
     */ testPermissions(permissions, optionsOrCallback, callback) {
        if (!Array.isArray(permissions) && typeof permissions !== 'string') throw new Error($c2993a27a2cf9510$var$IAMExceptionMessages.PERMISSIONS_REQUIRED);
        const { options: options, callback: cb } = (0, $liF6k.normalize)(optionsOrCallback, callback);
...
module.exports.Iam = $c2993a27a2cf9510$var$Iam;
/*! Developer Documentation
 *
 * All async methods (except for streams) will return a Promise in the event
 * that a callback is omitted.
 */ (0, $gt46O.promisifyAll)($c2993a27a2cf9510$var$Iam);
