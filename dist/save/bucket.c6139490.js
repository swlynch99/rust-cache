...
var $dJYlc$fs = require("fs");
var $dJYlc$path = require("path");
var $dJYlc$util = require("util");
var $dJYlc$stream = require("stream");
var $dJYlc$url = require("url");
...
parcelRegister("35ArF", function(module, exports) {
module.exports = new URL("mime.850b95e9.js", "file:" + __filename).toString();

});

parcelRegister("fnRHG", function(module, exports) {
module.exports = new URL("p-limit.4dbcc723.js", "file:" + __filename).toString();

});

parcelRegister("7SpAA", function(module, exports) {
module.exports = new URL("async-retry.125c023d.js", "file:" + __filename).toString();
...
var $bc758770783dbe28$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
...
var $bc758770783dbe28$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
...
var $bc758770783dbe28$var$__importStar = module.exports && module.exports.__importStar || function() {
    ...
    return function(mod) {
        ...
        var result = {};
        if (mod != null) {
            for(var k = ownKeys(mod), i = 0; i < k.length; i++)if (k[i] !== "default") $bc758770783dbe28$var$__createBinding(result, mod, k[i]);
        }
        $bc758770783dbe28$var$__setModuleDefault(result, mod);
        return result;
    };
}();
var $bc758770783dbe28$var$__importDefault = module.exports && module.exports.__importDefault || function(mod) {
...
var $dVuyA = parcelRequire("dVuyA");

var $gt46O = parcelRequire("gt46O");

const $bc758770783dbe28$var$fs = $bc758770783dbe28$var$__importStar($dJYlc$fs);

const $bc758770783dbe28$var$mime_1 = $bc758770783dbe28$var$__importDefault((parcelRequire("35ArF")));

const $bc758770783dbe28$var$path = $bc758770783dbe28$var$__importStar($dJYlc$path);

const $bc758770783dbe28$var$p_limit_1 = $bc758770783dbe28$var$__importDefault((parcelRequire("fnRHG")));


const $bc758770783dbe28$var$async_retry_1 = $bc758770783dbe28$var$__importDefault((parcelRequire("7SpAA")));

var $liF6k = parcelRequire("liF6k");
var $8cfa44144bb3883b$exports = {};
$8cfa44144bb3883b$exports = new URL("acl.60a8c0f5.js", "file:" + __filename).toString();


var $0d6ed5788464af53$exports = {};
$0d6ed5788464af53$exports = new URL("file.003b58da.js", "file:" + __filename).toString();


var $351c1915cde5f935$exports = {};
$351c1915cde5f935$exports = new URL("iam.0a6c869a.js", "file:" + __filename).toString();


var $ce00586b220787de$exports = {};
$ce00586b220787de$exports = new URL("notification.8ab07a71.js", "file:" + __filename).toString();



var $5wzKh = parcelRequire("5wzKh");

var $3HKfu = parcelRequire("3HKfu");


var $bc758770783dbe28$var$BucketActionToHTTPMethod;
(function(BucketActionToHTTPMethod) {
    BucketActionToHTTPMethod["list"] = "GET";
})($bc758770783dbe28$var$BucketActionToHTTPMethod || (module.exports.BucketActionToHTTPMethod = $bc758770783dbe28$var$BucketActionToHTTPMethod = {}));
var $bc758770783dbe28$var$AvailableServiceObjectMethods;
...
})($bc758770783dbe28$var$AvailableServiceObjectMethods || (module.exports.AvailableServiceObjectMethods = $bc758770783dbe28$var$AvailableServiceObjectMethods = {}));
var $bc758770783dbe28$var$BucketExceptionMessages;
...
})($bc758770783dbe28$var$BucketExceptionMessages || (module.exports.BucketExceptionMessages = $bc758770783dbe28$var$BucketExceptionMessages = {}));
/**
 ...
 * const bucket = storage.bucket('albums');
 * ```
 */ class $bc758770783dbe28$var$Bucket extends $c5iBM.ServiceObject {
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    getFilesStream(query) {
        // placeholder body, overwritten in constructor
        return new $dJYlc$stream.Readable();
    }
    constructor(storage, name, options){
        ...
        this.acl = new $8cfa44144bb3883b$exports.Acl({
            request: this.request.bind(this),
            pathPrefix: '/acl'
        });
        this.acl.default = new $8cfa44144bb3883b$exports.Acl({
            request: this.request.bind(this),
            pathPrefix: '/defaultObjectAcl'
        });
        this.crc32cGenerator = options.crc32cGenerator || this.storage.crc32cGenerator;
        this.iam = new $351c1915cde5f935$exports.Iam(this);
        this.getFilesStream = $dVuyA.paginator.streamify('getFiles');
     ...
     * ```
     */ get cloudStorageURI() {
        const uri = new $dJYlc$url.URL('gs://');
        uri.host = this.name;
        return uri;
    }
    /**
     ...
     */ combine(sources, destination, optionsOrCallback, callback) {
        var _a;
        if (!Array.isArray(sources) || sources.length === 0) throw new Error($bc758770783dbe28$var$BucketExceptionMessages.PROVIDE_SOURCE_FILE);
        if (!destination) throw new Error($bc758770783dbe28$var$BucketExceptionMessages.DESTINATION_FILE_NOT_SPECIFIED);
        let options = {};
        if (typeof optionsOrCallback === 'function') callback = optionsOrCallback;
        else if (optionsOrCallback) options = optionsOrCallback;
        this.disableAutoRetryConditionallyIdempotent_(this.methods.setMetadata, $bc758770783dbe28$var$AvailableServiceObjectMethods.setMetadata, options);
        const convertToFile = (file)=>{
            if (file instanceof $0d6ed5788464af53$exports.File) return file;
     ...
     */ createChannel(id, config, optionsOrCallback, callback) {
        if (typeof id !== 'string') throw new Error($bc758770783dbe28$var$BucketExceptionMessages.CHANNEL_ID_REQUIRED);
        let options = {};
        if (typeof optionsOrCallback === 'function') callback = optionsOrCallback;
        else if (optionsOrCallback) options = optionsOrCallback;
        this.request({
     ...
     */ createNotification(topic, optionsOrCallback, callback) {
        ...
        if (topicIsObject && $c5iBM.util.isCustomType(topic, 'pubsub/topic')) // eslint-disable-next-line @typescript-eslint/no-explicit-any
        topic = topic.name;
        if (typeof topic !== 'string') throw new Error($bc758770783dbe28$var$BucketExceptionMessages.TOPIC_NAME_REQUIRED);
        ...
        this.request({
            ...
            json: (0, $liF6k.convertObjKeysToSnakeCase)(body),
            qs: query,
            maxRetries: 0
        }, (err, apiResponse)=>{
            if (err) {
     ...
     */ deleteFiles(queryOrCallback, callback) {
        ...
        (async ()=>{
            try {
                let promises = [];
                const limit = (0, $bc758770783dbe28$var$p_limit_1.default)(MAX_PARALLEL_LIMIT);
     ...
     */ enableLogging(config, callback) {
        if (!config || typeof config === 'function' || typeof config.prefix === 'undefined') throw new Error($bc758770783dbe28$var$BucketExceptionMessages.CONFIGURATION_OBJECT_PREFIX_REQUIRED);
        let logBucket = this.id;
        if (config.bucket && config.bucket instanceof $bc758770783dbe28$var$Bucket) logBucket = config.bucket.id;
     ...
     * ```
     */ file(name, options) {
        if (!name) throw Error($bc758770783dbe28$var$BucketExceptionMessages.SPECIFY_FILE_NAME);
        return new $0d6ed5788464af53$exports.File(this, name, options);
    }
    /**
     ...
     */ getSignedUrl(cfg, callback) {
        const method = $bc758770783dbe28$var$BucketActionToHTTPMethod[cfg.action];
        const signConfig = {
            method: method,
            expires: cfg.expires,
            version: cfg.version,
        ...
        if (!this.signer) this.signer = new $3HKfu.URLSigner(this.storage.authClient, this, undefined, this.storage);
     ...
     */ lock(metageneration, callback) {
        ...
        if (metatype !== 'number' && metatype !== 'string') throw new Error($bc758770783dbe28$var$BucketExceptionMessages.METAGENERATION_NOT_PROVIDED);
        this.request({
            method: 'POST',
     ...
     */ makePrivate(optionsOrCallback, callback) {
        ...
        this.setMetadata(metadata, query, (err)=>{
            if (err) callback(err);
            const internalCall = ()=>{
                if (options.includeFiles) return (0, $dJYlc$util.promisify)(this.makeAllFilesPublicPrivate_).call(this, options);
     ...
     */ makePublic(optionsOrCallback, callback) {
        ...
        this.acl.add({
            ...
            if (req.includeFiles) return (0, $dJYlc$util.promisify)(this.makeAllFilesPublicPrivate_).call(this, req);
            return [];
     ...
     * ```
     */ notification(id) {
        if (!id) throw new Error($bc758770783dbe28$var$BucketExceptionMessages.SUPPLY_NOTIFICATION_ID);
        return new $ce00586b220787de$exports.Notification(this, id);
    }
    /**
     ...
     */ upload(pathString, optionsOrCallback, callback) {
        ...
        const upload = (numberOfRetries)=>{
            const returnValue = (0, $bc758770783dbe28$var$async_retry_1.default)(async (bail)=>{
                await new Promise((resolve, reject)=>{
                    ...
                    $bc758770783dbe28$var$fs.createReadStream(pathString).on('error', bail).pipe(writable).on('error', (err)=>{
        ...
        let newFile;
        if (options.destination instanceof $0d6ed5788464af53$exports.File) newFile = options.destination;
        ...
        newFile = this.file(options.destination, {
            ...
            const destination = $bc758770783dbe28$var$path.basename(pathString);
    ...
    methodType, localPreconditionOptions) {
        var _a, _b;
        if (typeof coreOpts === 'object' && ((_b = (_a = coreOpts === null || coreOpts === void 0 ? void 0 : coreOpts.reqOpts) === null || _a === void 0 ? void 0 : _a.qs) === null || _b === void 0 ? void 0 : _b.ifMetagenerationMatch) === undefined && (localPreconditionOptions === null || localPreconditionOptions === void 0 ? void 0 : localPreconditionOptions.ifMetagenerationMatch) === undefined && (methodType === $bc758770783dbe28$var$AvailableServiceObjectMethods.setMetadata || methodType === $bc758770783dbe28$var$AvailableServiceObjectMethods.delete) && this.storage.retryOptions.idempotencyStrategy === $5wzKh.IdempotencyStrategy.RetryConditional) this.storage.retryOptions.autoRetry = false;
        else if (this.storage.retryOptions.idempotencyStrategy === $5wzKh.IdempotencyStrategy.RetryNever) this.storage.retryOptions.autoRetry = false;
    }
}
module.exports.Bucket = $bc758770783dbe28$var$Bucket;
/*! Developer Documentation
 *
 * These methods can be auto-paginated.
 */ $dVuyA.paginator.extend($bc758770783dbe28$var$Bucket, 'getFiles');
/*! Developer Documentation
 *
 * All async methods (except for streams) will return a Promise in the event
 * that a callback is omitted.
 */ (0, $gt46O.promisifyAll)($bc758770783dbe28$var$Bucket, {
    exclude: [
        'cloudStorageURI',
        'request',
        'file',
