require("./orderedJs2Xml.79081e9f.js");
...
'use strict';
var $85eaccdd998e90bf$exports = {};
$85eaccdd998e90bf$exports = new URL("orderedJs2Xml.79081e9f.js", "file:" + __filename).toString();



var $aILZK = parcelRequire("aILZK");
const $2c058e35744f2412$var$defaultOptions = {
...
function $2c058e35744f2412$var$Builder(options) {
    this.options = Object.assign({}, $2c058e35744f2412$var$defaultOptions, options);
    if (this.options.ignoreAttributes === true || this.options.attributesGroupName) this.isAttribute = function() {
        return false;
    };
    else {
        this.ignoreAttributesFn = $aILZK(this.options.ignoreAttributes);
        this.attrPrefixLen = this.options.attributeNamePrefix.length;
        this.isAttribute = $2c058e35744f2412$var$isAttribute;
    }
    this.processTextOrObjNode = $2c058e35744f2412$var$processTextOrObjNode;
    if (this.options.format) {
        this.indentate = $2c058e35744f2412$var$indentate;
        this.tagEndChar = '>\n';
        this.newLine = '\n';
    } else {
...
$2c058e35744f2412$var$Builder.prototype.build = function(jObj) {
    if (this.options.preserveOrder) return $85eaccdd998e90bf$exports(jObj, this.options);
    else {
...
$2c058e35744f2412$var$Builder.prototype.j2x = function(jObj, level, ajPath) {
    let attrStr = '';
    let val = '';
...
$2c058e35744f2412$var$Builder.prototype.buildAttrPairStr = function(attrName, val) {
    val = this.options.attributeValueProcessor(attrName, '' + val);
    val = this.replaceEntitiesValue(val);
    if (this.options.suppressBooleanAttributes && val === "true") return ' ' + attrName;
    else return ' ' + attrName + '="' + val + '"';
};
function $2c058e35744f2412$var$processTextOrObjNode(object, key, level, ajPath) {
...
$2c058e35744f2412$var$Builder.prototype.buildObjectNode = function(val, key, attrStr, level) {
    if (val === "") {
...
$2c058e35744f2412$var$Builder.prototype.closeTag = function(key) {
    let closeTag = "";
...
function $2c058e35744f2412$var$buildEmptyObjNode(val, key, attrStr, level) {
...
$2c058e35744f2412$var$Builder.prototype.buildTextValNode = function(val, key, attrStr, level) {
...
$2c058e35744f2412$var$Builder.prototype.replaceEntitiesValue = function(textValue) {
...
function $2c058e35744f2412$var$indentate(level) {
    return this.options.indentBy.repeat(level);
}
function $2c058e35744f2412$var$isAttribute(name /*, options*/ ) {
    if (name.startsWith(this.options.attributeNamePrefix) && name !== this.options.textNodeName) return name.substr(this.attrPrefixLen);
    else return false;
}
module.exports = $2c058e35744f2412$var$Builder;
