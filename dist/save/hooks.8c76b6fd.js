...
parcelRegister("jawJy", function(module, exports) {
"use strict";
var $df4857b5bba64724$var$__awaiter = module.exports && module.exports.__awaiter || function(thisArg, _arguments, P, generator) {
...
function $df4857b5bba64724$var$chainHooks(...hooks) {
    if (hooks.length === 0) return null;
    if (hooks.length === 1) return hooks[0];
    const serverHook = {
        requestReceived (ctx) {
            return $df4857b5bba64724$var$__awaiter(this, void 0, void 0, function*() {
...
module.exports.chainHooks = $df4857b5bba64724$var$chainHooks;
function $df4857b5bba64724$var$isHook(object) {
...
module.exports.isHook = $df4857b5bba64724$var$isHook;
