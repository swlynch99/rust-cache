...
module.exports.getRetryConfig = $11d0c6d72115c976$var$getRetryConfig;
async function $11d0c6d72115c976$var$getRetryConfig(err) {
    let config = $11d0c6d72115c976$var$getConfig(err);
    ...
    const shouldRetryFn = config.shouldRetry || $11d0c6d72115c976$var$shouldRetryRequest;
    if (!await shouldRetryFn(err)) return {
        shouldRetry: false,
        config: err.config
    };
    const delay = $11d0c6d72115c976$var$getNextRetryDelay(config);
 ...
 */ function $11d0c6d72115c976$var$shouldRetryRequest(err) {
    var _a;
    const config = $11d0c6d72115c976$var$getConfig(err);
 ...
 */ function $11d0c6d72115c976$var$getConfig(err) {
 ...
 */ function $11d0c6d72115c976$var$getNextRetryDelay(config) {
    var _a;
