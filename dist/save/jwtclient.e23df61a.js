...
var $7e3dc3b619d465b4$exports = {};
$7e3dc3b619d465b4$exports = new URL("build.106964cf.js", "file:" + __filename).toString();


var $06fc8dab64bfb909$exports = {};
$06fc8dab64bfb909$exports = new URL("jwtaccess.d32d1331.js", "file:" + __filename).toString();
...
class $961860a30c35cd52$var$JWT extends $kdXrB.OAuth2Client {
     ...
     */ createScoped(scopes) {
        const jwt = new $961860a30c35cd52$var$JWT(this);
        jwt.scopes = scopes;
        return jwt;
    }
    /**
     ...
     */ async getRequestMetadataAsync(url) {
        ...
        const useSelfSignedJWT = !this.hasUserScopes() && url || this.useJWTAccessWithScope && this.hasAnyScopes() || this.universeDomain !== $4luEl.DEFAULT_UNIVERSE;
        if (this.subject && this.universeDomain !== $4luEl.DEFAULT_UNIVERSE) throw new RangeError(`Service Account user is configured for the credential. Domain-wide delegation is not supported in universes other than ${$4luEl.DEFAULT_UNIVERSE}`);
        if (!this.apiKey && useSelfSignedJWT) {
            if (this.additionalClaims && this.additionalClaims.target_audience) {
                ...
                // credentials.
                if (!this.access) this.access = new $06fc8dab64bfb909$exports.JWTAccess(this.email, this.key, this.keyId, this.eagerRefreshThresholdMillis);
                let scopes;
                if (this.hasUserScopes()) scopes = this.scopes;
                else if (!url) scopes = this.defaultScopes;
                const useScopes = this.useJWTAccessWithScope || this.universeDomain !== $4luEl.DEFAULT_UNIVERSE;
     ...
     */ async fetchIdToken(targetAudience) {
        ...
        const gtoken = new $7e3dc3b619d465b4$exports.GoogleToken({
            iss: this.email,
            sub: this.subject,
     ...
     */ createGToken() {
        if (!this.gtoken) this.gtoken = new $7e3dc3b619d465b4$exports.GoogleToken({
            iss: this.email,
            sub: this.subject,
            scope: this.scopes || this.defaultScopes,
            keyFile: this.keyFile,
...
module.exports.JWT = $961860a30c35cd52$var$JWT;


//# sourceMappingURL=jwtclient.e23df61a.js.map
