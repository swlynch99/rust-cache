...
var $5xQUF = parcelRequire("5xQUF");

var $4ZmfA = parcelRequire("4ZmfA");
const $d42d34faea6bc715$var$DEFAULT_HEADER = {
    alg: 'RS256',
    typ: 'JWT'
};
class $d42d34faea6bc715$var$JWTAccess {
    /**
     ...
     */ getRequestHeaders(url, additionalClaims, scopes) {
        ...
        const exp = $d42d34faea6bc715$var$JWTAccess.getExpirationTime(iat);
        let defaultClaims;
        ...
        const header = this.keyId ? {
            ...$d42d34faea6bc715$var$DEFAULT_HEADER,
            kid: this.keyId
        } : $d42d34faea6bc715$var$DEFAULT_HEADER;
        const payload = Object.assign(defaultClaims, additionalClaims);
        // Sign the jwt and add it to the cache
        const signedJWT = $5xQUF.sign({
            header: header,
            payload: payload,
            secret: this.key
        });
...
module.exports.JWTAccess = $d42d34faea6bc715$var$JWTAccess;
