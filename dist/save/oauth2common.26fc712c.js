...
var $8ZkuE$querystring = require("querystring");
...
module.exports.OAuthClientAuthHandler = void 0;
module.exports.getErrorFromOAuthErrorResponse = $fdb3b5108ceed5e8$var$getErrorFromOAuthErrorResponse;


var $jVpvg = parcelRequire("jVpvg");
/** List of HTTP methods that accept request bodies. */ const $fdb3b5108ceed5e8$var$METHODS_SUPPORTING_REQUEST_BODY = [
    'PUT',
    'POST',
    'PATCH'
];
 ...
 */ class $fdb3b5108ceed5e8$var$OAuthClientAuthHandler {
    /**
     ...
     */ injectAuthenticatedRequestBody(opts) {
        ...
        if (((_a = this.clientAuthentication) === null || _a === void 0 ? void 0 : _a.confidentialClientType) === 'request-body') {
            ...
            // Inject authenticated request body.
            if ($fdb3b5108ceed5e8$var$METHODS_SUPPORTING_REQUEST_BODY.indexOf(method) !== -1) {
                // Get content-type.
                let contentType;
                ...
                if (contentType === 'application/x-www-form-urlencoded') {
                    opts.data = opts.data || '';
                    const data = $8ZkuE$querystring.parse(opts.data);
                    Object.assign(data, {
                        client_id: this.clientAuthentication.clientId,
                        client_secret: this.clientAuthentication.clientSecret || ''
                    });
                    opts.data = $8ZkuE$querystring.stringify(data);
...
module.exports.OAuthClientAuthHandler = $fdb3b5108ceed5e8$var$OAuthClientAuthHandler;
/**
 ...
 */ function $fdb3b5108ceed5e8$var$getErrorFromOAuthErrorResponse(resp, err) {
    // Error response.
    ...
    if (err) {
        ...
        if (err.stack) // Copy error.stack if available.
        keys.push('stack');
        keys.forEach((key)=>{
...
//# sourceMappingURL=oauth2common.26fc712c.js.map
