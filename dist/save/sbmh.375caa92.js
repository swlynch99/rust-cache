var $cnCMP$nodeevents = require("node:events");
var $cnCMP$nodeutil = require("node:util");

'use strict';

var $17629135e3f09635$require$EventEmitter = $cnCMP$nodeevents.EventEmitter;

var $17629135e3f09635$require$inherits = $cnCMP$nodeutil.inherits;
function $17629135e3f09635$var$SBMH(needle) {
...
$17629135e3f09635$require$inherits($17629135e3f09635$var$SBMH, $17629135e3f09635$require$EventEmitter);
$17629135e3f09635$var$SBMH.prototype.reset = function() {
    this._lookbehind_size = 0;
    this.matches = 0;
    this._bufpos = 0;
};
$17629135e3f09635$var$SBMH.prototype.push = function(chunk, pos) {
...
$17629135e3f09635$var$SBMH.prototype._sbmh_feed = function(data) {
...
$17629135e3f09635$var$SBMH.prototype._sbmh_lookup_char = function(data, pos) {
    return pos < 0 ? this._lookbehind[this._lookbehind_size + pos] : data[pos];
};
$17629135e3f09635$var$SBMH.prototype._sbmh_memcmp = function(data, pos, len) {
    for(var i = 0; i < len; ++i){
        if (this._sbmh_lookup_char(data, pos + i) !== this._needle[i]) return false;
    }
    return true;
};
module.exports = $17629135e3f09635$var$SBMH;


//# sourceMappingURL=sbmh.375caa92.js.map
