module.exports = $c77a72d2f3a1e539$var$register;
function $c77a72d2f3a1e539$var$register(state, name, method, options) {
    ...
    if (Array.isArray(name)) return name.reverse().reduce(function(callback, name) {
        return $c77a72d2f3a1e539$var$register.bind(null, state, name, callback, options);
    }, method)();
