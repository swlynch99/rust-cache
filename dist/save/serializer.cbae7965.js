...
parcelRegister("15iyl", function(module, exports) {
module.exports = new URL("base64.068071cd.js", "file:" + __filename).toString();
...
const $c52898ab13cb975e$var$base64 = $8FaNO.__importStar((parcelRequire("15iyl")));
var $c3229a02361211eb$exports = {};
$c3229a02361211eb$exports = new URL("interfaces.2130312b.js", "file:" + __filename).toString();


var $80323d90e038aba7$exports = {};
$80323d90e038aba7$exports = new URL("utils.7d46fd23.js", "file:" + __filename).toString();


class $c52898ab13cb975e$var$SerializerImpl {
     ...
     */ serialize(mapper, object, objectName, options = {
        ...
        const updatedOptions = {
            xml: {
                ...
                xmlCharKey: (_c = options.xml.xmlCharKey) !== null && _c !== void 0 ? _c : $c3229a02361211eb$exports.XML_CHARKEY
            }
        };
        let payload = {};
        ...
        if (object === undefined || object === null) payload = object;
            ...
            else if (mapperType.match(/^(Number|String|Boolean|Object|Stream|Uuid)$/i) !== null) payload = $c52898ab13cb975e$var$serializeBasicTypes(mapperType, objectName, object);
            else if (mapperType.match(/^Enum$/i) !== null) {
                const enumMapper = mapper;
                payload = $c52898ab13cb975e$var$serializeEnumType(objectName, enumMapper.type.allowedValues, object);
            } else if (mapperType.match(/^(Date|DateTime|TimeSpan|DateTimeRfc1123|UnixTime)$/i) !== null) payload = $c52898ab13cb975e$var$serializeDateTypes(mapperType, object, objectName);
            else if (mapperType.match(/^ByteArray$/i) !== null) payload = $c52898ab13cb975e$var$serializeByteArrayType(objectName, object);
            else if (mapperType.match(/^Base64Url$/i) !== null) payload = $c52898ab13cb975e$var$serializeBase64UrlType(objectName, object);
            else if (mapperType.match(/^Sequence$/i) !== null) payload = $c52898ab13cb975e$var$serializeSequenceType(this, mapper, object, objectName, Boolean(this.isXML), updatedOptions);
            else if (mapperType.match(/^Dictionary$/i) !== null) payload = $c52898ab13cb975e$var$serializeDictionaryType(this, mapper, object, objectName, Boolean(this.isXML), updatedOptions);
            else if (mapperType.match(/^Composite$/i) !== null) payload = $c52898ab13cb975e$var$serializeCompositeType(this, mapper, object, objectName, Boolean(this.isXML), updatedOptions);
        }
        return payload;
    }
    /**
     ...
     */ deserialize(mapper, responseBody, objectName, options = {
        ...
        const mapperType = mapper.type.name;
        if (!objectName) objectName = mapper.serializedName;
        if (mapperType.match(/^Composite$/i) !== null) payload = $c52898ab13cb975e$var$deserializeCompositeType(this, mapper, responseBody, objectName, updatedOptions);
        else {
            if (this.isXML) {
                 ...
                 */ if (responseBody[$c3229a02361211eb$exports.XML_ATTRKEY] !== undefined && responseBody[xmlCharKey] !== undefined) responseBody = responseBody[xmlCharKey];
            }
            ...
            else if (mapperType.match(/^UnixTime$/i) !== null) payload = $c52898ab13cb975e$var$unixTimeToDate(responseBody);
            else if (mapperType.match(/^ByteArray$/i) !== null) payload = $c52898ab13cb975e$var$base64.decodeString(responseBody);
            else if (mapperType.match(/^Base64Url$/i) !== null) payload = $c52898ab13cb975e$var$base64UrlToByteArray(responseBody);
            else if (mapperType.match(/^Sequence$/i) !== null) payload = $c52898ab13cb975e$var$deserializeSequenceType(this, mapper, responseBody, objectName, updatedOptions);
            else if (mapperType.match(/^Dictionary$/i) !== null) payload = $c52898ab13cb975e$var$deserializeDictionaryType(this, mapper, responseBody, objectName, updatedOptions);
        }
 ...
 */ function $c52898ab13cb975e$var$createSerializer(modelMappers = {}, isXML = false) {
    return new $c52898ab13cb975e$var$SerializerImpl(modelMappers, isXML);
}
module.exports.createSerializer = $c52898ab13cb975e$var$createSerializer;
function $c52898ab13cb975e$var$trimEnd(str, ch) {
    let len = str.length;
    while(len - 1 >= 0 && str[len - 1] === ch)--len;
    return str.substr(0, len);
}
function $c52898ab13cb975e$var$bufferToBase64Url(buffer) {
    ...
    const str = $c52898ab13cb975e$var$base64.encodeByteArray(buffer);
    // Base64 to Base64Url.
    return $c52898ab13cb975e$var$trimEnd(str, "=").replace(/\+/g, "-").replace(/\//g, "_");
}
function $c52898ab13cb975e$var$base64UrlToByteArray(str) {
    ...
    return $c52898ab13cb975e$var$base64.decodeString(str);
}
function $c52898ab13cb975e$var$splitSerializeName(prop) {
    const classes = [];
    let partialclass = "";
    if (prop) {
...
function $c52898ab13cb975e$var$dateToUnixTime(d) {
    if (!d) return undefined;
    if (typeof d.valueOf() === "string") d = new Date(d);
    return Math.floor(d.getTime() / 1000);
}
function $c52898ab13cb975e$var$unixTimeToDate(n) {
    if (!n) return undefined;
    return new Date(n * 1000);
}
function $c52898ab13cb975e$var$serializeBasicTypes(typeName, objectName, value) {
    if (value !== null && value !== undefined) {
        if (typeName.match(/^Number$/i) !== null) {
            ...
            if (!(typeof value.valueOf() === "string" && (0, $80323d90e038aba7$exports.isValidUuid)(value))) throw new Error(`${objectName} with value "${value}" must be of type string and a valid uuid.`);
...
function $c52898ab13cb975e$var$serializeEnumType(objectName, allowedValues, value) {
...
function $c52898ab13cb975e$var$serializeByteArrayType(objectName, value) {
    if (value !== undefined && value !== null) {
        if (!(value instanceof Uint8Array)) throw new Error(`${objectName} must be of type Uint8Array.`);
        value = $c52898ab13cb975e$var$base64.encodeByteArray(value);
    }
    return value;
}
function $c52898ab13cb975e$var$serializeBase64UrlType(objectName, value) {
    if (value !== undefined && value !== null) {
        if (!(value instanceof Uint8Array)) throw new Error(`${objectName} must be of type Uint8Array.`);
        value = $c52898ab13cb975e$var$bufferToBase64Url(value);
    }
    return value;
}
function $c52898ab13cb975e$var$serializeDateTypes(typeName, value, objectName) {
    if (value !== undefined && value !== null) {
        if (typeName.match(/^Date$/i) !== null) {
            ...
            value = $c52898ab13cb975e$var$dateToUnixTime(value);
        } else if (typeName.match(/^TimeSpan$/i) !== null) {
            if (!(0, $80323d90e038aba7$exports.isDuration)(value)) throw new Error(`${objectName} must be a string in ISO 8601 format. Instead was "${value}".`);
        }
    }
    return value;
}
function $c52898ab13cb975e$var$serializeSequenceType(serializer, mapper, object, objectName, isXml, options) {
    var _a;
    ...
    for(let i = 0; i < object.length; i++){
        ...
        if (isXml && elementType.xmlNamespace) {
            ...
            if (elementType.type.name === "Composite") {
                ...
                tempArray[i][$c3229a02361211eb$exports.XML_ATTRKEY] = {
...
function $c52898ab13cb975e$var$serializeDictionaryType(serializer, mapper, object, objectName, isXml, options) {
    ...
    for (const key of Object.keys(object)){
        ...
        tempDictionary[key] = $c52898ab13cb975e$var$getXmlObjectValue(valueType, serializedValue, isXml, options);
    }
    // Add the namespace to the root element if needed
    if (isXml && mapper.xmlNamespace) {
        const xmlnsKey = mapper.xmlNamespacePrefix ? `xmlns:${mapper.xmlNamespacePrefix}` : "xmlns";
        const result = tempDictionary;
        result[$c3229a02361211eb$exports.XML_ATTRKEY] = {
 ...
 */ function $c52898ab13cb975e$var$resolveAdditionalProperties(serializer, mapper, objectName) {
    const additionalProperties = mapper.type.additionalProperties;
    if (!additionalProperties && mapper.type.className) {
        const modelMapper = $c52898ab13cb975e$var$resolveReferencedMapper(serializer, mapper, objectName);
 ...
 * @param mapper - the composite mapper to resolve
 * @param objectName - name of the object being serialized
 */ function $c52898ab13cb975e$var$resolveReferencedMapper(serializer, mapper, objectName) {
 ...
 * @param serializer - the serializer containing the entire set of mappers
 * @param mapper - the composite mapper to resolve
 */ function $c52898ab13cb975e$var$resolveModelProperties(serializer, mapper, objectName) {
...
function $c52898ab13cb975e$var$serializeCompositeType(serializer, mapper, object, objectName, isXml, options) {
    if ($c52898ab13cb975e$var$getPolymorphicDiscriminatorRecursively(serializer, mapper)) mapper = $c52898ab13cb975e$var$getPolymorphicMapper(serializer, mapper, object, "clientName");
    if (object !== undefined && object !== null) {
        const payload = {};
        const modelProps = $c52898ab13cb975e$var$resolveModelProperties(serializer, mapper, objectName);
        for (const key of Object.keys(modelProps)){
            ...
            if (serializer.isXML) {
                ...
                const paths = $c52898ab13cb975e$var$splitSerializeName(propertyMapper.serializedName);
                propName = paths.pop();
            ...
            if (parentObject !== undefined && parentObject !== null) {
                if (isXml && mapper.xmlNamespace) {
                    const xmlnsKey = mapper.xmlNamespacePrefix ? `xmlns:${mapper.xmlNamespacePrefix}` : "xmlns";
                    parentObject[$c3229a02361211eb$exports.XML_ATTRKEY] = Object.assign(Object.assign({}, parentObject[$c3229a02361211eb$exports.XML_ATTRKEY]), {
                        [xmlnsKey]: mapper.xmlNamespace
                    });
                }
                const propertyObjectName = propertyMapper.serializedName !== "" ? objectName + "." + propertyMapper.serializedName : objectName;
                let toSerialize = object[key];
                const polymorphicDiscriminator = $c52898ab13cb975e$var$getPolymorphicDiscriminatorRecursively(serializer, mapper);
                ...
                if (serializedValue !== undefined && propName !== undefined && propName !== null) {
                    const value = $c52898ab13cb975e$var$getXmlObjectValue(propertyMapper, serializedValue, isXml, options);
                    if (isXml && propertyMapper.xmlIsAttribute) {
                        // XML_ATTRKEY, i.e., $ is the key attributes are kept under in xml2js.
                        // This keeps things simple while preventing name collision
                        // with names in user documents.
                        parentObject[$c3229a02361211eb$exports.XML_ATTRKEY] = parentObject[$c3229a02361211eb$exports.XML_ATTRKEY] || {};
                        parentObject[$c3229a02361211eb$exports.XML_ATTRKEY][propName] = serializedValue;
        ...
        const additionalPropertiesMapper = $c52898ab13cb975e$var$resolveAdditionalProperties(serializer, mapper, objectName);
...
function $c52898ab13cb975e$var$getXmlObjectValue(propertyMapper, serializedValue, isXml, options) {
    ...
    if ([
        ...
        if (serializedValue[$c3229a02361211eb$exports.XML_ATTRKEY]) return serializedValue;
        else {
            const result = Object.assign({}, serializedValue);
            result[$c3229a02361211eb$exports.XML_ATTRKEY] = xmlNamespace;
            return result;
        }
    }
    const result = {};
...
function $c52898ab13cb975e$var$isSpecialXmlProperty(propertyName, options) {
    return [
        $c3229a02361211eb$exports.XML_ATTRKEY,
        options.xml.xmlCharKey
    ].includes(propertyName);
}
function $c52898ab13cb975e$var$deserializeCompositeType(serializer, mapper, responseBody, objectName, options) {
    var _a, _b;
    const xmlCharKey = (_a = options.xml.xmlCharKey) !== null && _a !== void 0 ? _a : $c3229a02361211eb$exports.XML_CHARKEY;
    if ($c52898ab13cb975e$var$getPolymorphicDiscriminatorRecursively(serializer, mapper)) mapper = $c52898ab13cb975e$var$getPolymorphicMapper(serializer, mapper, responseBody, "serializedName");
    const modelProps = $c52898ab13cb975e$var$resolveModelProperties(serializer, mapper, objectName);
    let instance = {};
    const handledPropertyNames = [];
    for (const key of Object.keys(modelProps)){
        const propertyMapper = modelProps[key];
        const paths = $c52898ab13cb975e$var$splitSerializeName(modelProps[key].serializedName);
        ...
        if (headerCollectionPrefix) {
            ...
            if (propertyMapper.xmlIsAttribute && responseBody[$c3229a02361211eb$exports.XML_ATTRKEY]) instance[key] = serializer.deserialize(propertyMapper, responseBody[$c3229a02361211eb$exports.XML_ATTRKEY][xmlName], propertyObjectName, options);
    ...
    if (additionalPropertiesMapper) {
        const isAdditionalProperty = (responsePropName)=>{
            for(const clientPropName in modelProps){
                const paths = $c52898ab13cb975e$var$splitSerializeName(modelProps[clientPropName].serializedName);
        ...
        for (const key of Object.keys(responseBody))if (instance[key] === undefined && !handledPropertyNames.includes(key) && !$c52898ab13cb975e$var$isSpecialXmlProperty(key, options)) instance[key] = responseBody[key];
    }
    return instance;
}
function $c52898ab13cb975e$var$deserializeDictionaryType(serializer, mapper, responseBody, objectName, options) {
...
function $c52898ab13cb975e$var$deserializeSequenceType(serializer, mapper, responseBody, objectName, options) {
    var _a;
...
function $c52898ab13cb975e$var$getIndexDiscriminator(discriminators, discriminatorValue, typeName) {
...
function $c52898ab13cb975e$var$getPolymorphicMapper(serializer, mapper, object, polymorphicPropertyName) {
    var _a;
    const polymorphicDiscriminator = $c52898ab13cb975e$var$getPolymorphicDiscriminatorRecursively(serializer, mapper);
    if (polymorphicDiscriminator) {
        ...
        if (discriminatorName) {
            ...
            if (typeof discriminatorValue === "string" && typeName) {
                const polymorphicMapper = $c52898ab13cb975e$var$getIndexDiscriminator(serializer.modelMappers.discriminators, discriminatorValue, typeName);
...
function $c52898ab13cb975e$var$getPolymorphicDiscriminatorRecursively(serializer, mapper) {
    return mapper.type.polymorphicDiscriminator || $c52898ab13cb975e$var$getPolymorphicDiscriminatorSafely(serializer, mapper.type.uberParent) || $c52898ab13cb975e$var$getPolymorphicDiscriminatorSafely(serializer, mapper.type.className);
}
function $c52898ab13cb975e$var$getPolymorphicDiscriminatorSafely(serializer, typeName) {
