...
var $awteo$querystring = require("querystring");
var $awteo$stream = require("stream");
...
var $3b16f7081ba76b19$exports = {};
$3b16f7081ba76b19$exports = new URL("ecdsa-sig-formatter.8673acb3.js", "file:" + __filename).toString();



var $5DQIM = parcelRequire("5DQIM");
var $e11b052d42a499e8$exports = {};
$e11b052d42a499e8$exports = new URL("authclient.6e6a5fff.js", "file:" + __filename).toString();


var $5122b3b0cd8c8642$exports = {};
$5122b3b0cd8c8642$exports = new URL("loginticket.6cd59f49.js", "file:" + __filename).toString();


var $b2bc8219e1c8cc9f$var$CodeChallengeMethod;
(function(CodeChallengeMethod) {
    CodeChallengeMethod["Plain"] = "plain";
    CodeChallengeMethod["S256"] = "S256";
})($b2bc8219e1c8cc9f$var$CodeChallengeMethod || (module.exports.CodeChallengeMethod = $b2bc8219e1c8cc9f$var$CodeChallengeMethod = {}));
var $b2bc8219e1c8cc9f$var$CertificateFormat;
(function(CertificateFormat) {
    CertificateFormat["PEM"] = "PEM";
    CertificateFormat["JWK"] = "JWK";
})($b2bc8219e1c8cc9f$var$CertificateFormat || (module.exports.CertificateFormat = $b2bc8219e1c8cc9f$var$CertificateFormat = {}));
/**
 * The client authentication type. Supported values are basic, post, and none.
 * https://datatracker.ietf.org/doc/html/rfc7591#section-2
 */ var $b2bc8219e1c8cc9f$var$ClientAuthentication;
...
})($b2bc8219e1c8cc9f$var$ClientAuthentication || (module.exports.ClientAuthentication = $b2bc8219e1c8cc9f$var$ClientAuthentication = {}));
class $b2bc8219e1c8cc9f$var$OAuth2Client extends $e11b052d42a499e8$exports.AuthClient {
    constructor(optionsOrClientId, clientSecret, redirectUri){
        ...
        this.certificateCacheFormat = $b2bc8219e1c8cc9f$var$CertificateFormat.PEM;
        ...
        this.clientAuthentication = opts.clientAuthentication || $b2bc8219e1c8cc9f$var$ClientAuthentication.ClientSecretPost;
     ...
     */ generateAuthUrl(opts = {}) {
        ...
        return rootUrl + '?' + $awteo$querystring.stringify(opts);
    }
     ...
     */ async generateCodeVerifierAsync() {
        ...
        const crypto = (0, $5DQIM.createCrypto)();
    ...
    async getTokenAsync(options) {
        ...
        if (this.clientAuthentication === $b2bc8219e1c8cc9f$var$ClientAuthentication.ClientSecretBasic) {
            const basic = Buffer.from(`${this._clientId}:${this._clientSecret}`);
            headers['Authorization'] = `Basic ${basic.toString('base64')}`;
        }
        if (this.clientAuthentication === $b2bc8219e1c8cc9f$var$ClientAuthentication.ClientSecretPost) values.client_secret = this._clientSecret;
        const res = await this.transporter.request({
            ...$b2bc8219e1c8cc9f$var$OAuth2Client.RETRY_CONFIG,
            method: 'POST',
            url: url,
            data: $awteo$querystring.stringify(values),
            headers: headers
        });
    ...
    async refreshTokenNoCache(refreshToken) {
        ...
        try {
            ...
            res = await this.transporter.request({
                ...
                method: 'POST',
                url: url,
                data: $awteo$querystring.stringify(data),
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                }
            });
        } catch (e) {
            if (e instanceof $XskYs.GaxiosError && e.message === 'invalid_grant' && ((_a = e.response) === null || _a === void 0 ? void 0 : _a.data) && /ReAuth/i.test(e.response.data.error_description)) e.message = JSON.stringify(e.response.data);
            throw e;
        }
        const tokens = res.data;
     ...
     */ static getRevokeTokenUrl(token) {
        return new $b2bc8219e1c8cc9f$var$OAuth2Client().getRevokeTokenURL(token).toString();
    }
    /**
    ...
    async requestAsync(opts, reAuthRetried = false) {
        ...
        try {
            ...
            if (res) {
                ...
                const isReadableStream = res.config.data instanceof $awteo$stream.Readable;
    ...
    async getFederatedSignonCertsAsync() {
        ...
        const format = (0, $5DQIM.hasBrowserCrypto)() ? $b2bc8219e1c8cc9f$var$CertificateFormat.JWK : $b2bc8219e1c8cc9f$var$CertificateFormat.PEM;
        ...
        let url;
        switch(format){
            case $b2bc8219e1c8cc9f$var$CertificateFormat.PEM:
                url = this.endpoints.oauth2FederatedSignonPemCertsUrl.toString();
                break;
            case $b2bc8219e1c8cc9f$var$CertificateFormat.JWK:
     ...
     */ async verifySignedJwtWithCertsAsync(jwt, certs, requiredAudience, issuers, maxExpiry) {
        const crypto = (0, $5DQIM.createCrypto)();
        if (!maxExpiry) maxExpiry = $b2bc8219e1c8cc9f$var$OAuth2Client.DEFAULT_MAX_TOKEN_LIFETIME_SECS_;
        ...
        if (envelope.alg === 'ES256') signature = $3b16f7081ba76b19$exports.joseToDer(signature, 'ES256').toString('base64');
        ...
        const earliest = iat - $b2bc8219e1c8cc9f$var$OAuth2Client.CLOCK_SKEW_SECS_;
        const latest = exp + $b2bc8219e1c8cc9f$var$OAuth2Client.CLOCK_SKEW_SECS_;
        ...
        return new $5122b3b0cd8c8642$exports.LoginTicket(envelope, payload);
    }
    /**
...
module.exports.OAuth2Client = $b2bc8219e1c8cc9f$var$OAuth2Client;
/**
 * @deprecated use instance's {@link OAuth2Client.endpoints}
 */ $b2bc8219e1c8cc9f$var$OAuth2Client.GOOGLE_TOKEN_INFO_URL = 'https://oauth2.googleapis.com/tokeninfo';
/**
 * Clock skew - five minutes in seconds
 */ $b2bc8219e1c8cc9f$var$OAuth2Client.CLOCK_SKEW_SECS_ = 300;
/**
 * The default max Token Lifetime is one day in seconds
 */ $b2bc8219e1c8cc9f$var$OAuth2Client.DEFAULT_MAX_TOKEN_LIFETIME_SECS_ = 86400;
