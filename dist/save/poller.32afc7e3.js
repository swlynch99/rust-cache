...
const $c83adff751121cb1$var$createStateProxy = ()=>({
        /**
 ...
 */ function $c83adff751121cb1$var$buildCreatePoller(inputs) {
    ...
    return async ({ init: init, poll: poll }, options)=>{
        const { processResult: processResult, updateState: updateState, withOperationLocation: withOperationLocationCallback, intervalInMs: intervalInMs = $7aNHL.POLL_INTERVAL_IN_MS, restoreFrom: restoreFrom } = options || {};
        const stateProxy = $c83adff751121cb1$var$createStateProxy();
        ...
        const state = restoreFrom ? (0, $2rqCk.deserializeState)(restoreFrom) : await (0, $2rqCk.initOperation)({
            init: init,
            ...
            pollUntilDone: (pollOptions)=>resultPromise !== null && resultPromise !== void 0 ? resultPromise : resultPromise = (async ()=>{
                    ...
                    try {
                        if (!poller.isDone()) {
                            ...
                            while(!poller.isDone()){
                                await (0, $hACYf.delay)(currentPollIntervalInMs, {
                                    abortSignal: abortSignal
                                });
                                await poller.poll({
                                    abortSignal: abortSignal
...
module.exports.buildCreatePoller = $c83adff751121cb1$var$buildCreatePoller;


//# sourceMappingURL=poller.32afc7e3.js.map
