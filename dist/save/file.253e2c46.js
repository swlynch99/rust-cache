...
require("./build.da3d7c56.js");
require("./mime.784b9fa4.js");
require("./resumable-upload.48b29785.js");
require("./storage.0f1f4d5d.js");
require("./bucket.192ef05d.js");
require("./acl.df1f4474.js");
require("./signer.15ba18b2.js");
...
var $cOS4v$crypto = require("crypto");
var $cOS4v$fs = require("fs");
var $cOS4v$stream = require("stream");
var $cOS4v$zlib = require("zlib");
...
parcelRegister("42qVt", function(module, exports) {
module.exports = new URL("resumable-upload.48b29785.js", "file:" + __filename).toString();
...
var $fd3965bb0bee5f84$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
...
var $fd3965bb0bee5f84$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
...
var $fd3965bb0bee5f84$var$__importStar = module.exports && module.exports.__importStar || function() {
    ...
    return function(mod) {
        ...
        var result = {};
        if (mod != null) {
            for(var k = ownKeys(mod), i = 0; i < k.length; i++)if (k[i] !== "default") $fd3965bb0bee5f84$var$__createBinding(result, mod, k[i]);
        }
        $fd3965bb0bee5f84$var$__setModuleDefault(result, mod);
        return result;
    };
}();
var $fd3965bb0bee5f84$var$__classPrivateFieldGet = module.exports && module.exports.__classPrivateFieldGet || function(receiver, state, kind, f) {
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a getter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
    return kind === "m" ? f : kind === "a" ? f.call(receiver) : f ? f.value : state.get(receiver);
};
var $fd3965bb0bee5f84$var$__importDefault = module.exports && module.exports.__importDefault || function(mod) {
    return mod && mod.__esModule ? mod : {
        "default": mod
    };
};
var $fd3965bb0bee5f84$var$_File_instances, $fd3965bb0bee5f84$var$_File_validateIntegrity;
...
var $f9fHL = parcelRequire("f9fHL");

var $e4oRo = parcelRequire("e4oRo");

const $fd3965bb0bee5f84$var$crypto = $fd3965bb0bee5f84$var$__importStar($cOS4v$crypto);

const $fd3965bb0bee5f84$var$fs = $fd3965bb0bee5f84$var$__importStar($cOS4v$fs);

const $fd3965bb0bee5f84$var$mime_1 = $fd3965bb0bee5f84$var$__importDefault((parcelRequire("4iAkX")));

const $fd3965bb0bee5f84$var$resumableUpload = $fd3965bb0bee5f84$var$__importStar((parcelRequire("42qVt")));


const $fd3965bb0bee5f84$var$zlib = $fd3965bb0bee5f84$var$__importStar($cOS4v$zlib);

var $cZVWD = parcelRequire("cZVWD");

var $uE4AQ = parcelRequire("uE4AQ");

var $9zJxF = parcelRequire("9zJxF");
var $3642efee3bcb3705$exports = {};
$3642efee3bcb3705$exports = new URL("signer.15ba18b2.js", "file:" + __filename).toString();



var $fJ9ES = parcelRequire("fJ9ES");

const $fd3965bb0bee5f84$var$duplexify_1 = $fd3965bb0bee5f84$var$__importDefault((parcelRequire("iqI8d")));

var $dY7Uc = parcelRequire("dY7Uc");
var $47884115a02b0acf$exports = {};
$47884115a02b0acf$exports = new URL("crc32c.ee191616.js", "file:" + __filename).toString();


var $e86cad2b7cb426a1$exports = {};
$e86cad2b7cb426a1$exports = new URL("hash-stream-validator.8ed0277b.js", "file:" + __filename).toString();



const $fd3965bb0bee5f84$var$async_retry_1 = $fd3965bb0bee5f84$var$__importDefault((parcelRequire("2NKCy")));
var $fd3965bb0bee5f84$var$ActionToHTTPMethod;
...
})($fd3965bb0bee5f84$var$ActionToHTTPMethod || (module.exports.ActionToHTTPMethod = $fd3965bb0bee5f84$var$ActionToHTTPMethod = {}));
/**
 * @deprecated - no longer used
 */ module.exports.STORAGE_POST_POLICY_BASE_URL = 'https://storage.googleapis.com';
/**
 * @private
 */ const $fd3965bb0bee5f84$var$GS_URL_REGEXP = /^gs:\/\/([a-z0-9_.-]+)\/(.+)$/;
/**
 * @private
 ...
 * standards.
 */ const $fd3965bb0bee5f84$var$COMPRESSIBLE_MIME_REGEX = new RegExp([
...
class $fd3965bb0bee5f84$var$RequestError extends Error {
}
module.exports.RequestError = $fd3965bb0bee5f84$var$RequestError;
const $fd3965bb0bee5f84$var$SEVEN_DAYS = 604800;
const $fd3965bb0bee5f84$var$GS_UTIL_URL_REGEX = /(gs):\/\/([a-z0-9_.-]+)\/(.+)/g;
const $fd3965bb0bee5f84$var$HTTPS_PUBLIC_URL_REGEX = /(https):\/\/(storage\.googleapis\.com)\/([a-z0-9_.-]+)\/(.+)/g;
var $fd3965bb0bee5f84$var$FileExceptionMessages;
...
})($fd3965bb0bee5f84$var$FileExceptionMessages || (module.exports.FileExceptionMessages = $fd3965bb0bee5f84$var$FileExceptionMessages = {}));
/**
 * A File object is created from your {@link Bucket} object using
 * {@link Bucket#file}.
 *
 * @class
 */ class $fd3965bb0bee5f84$var$File extends $f9fHL.ServiceObject {
    /**
     ...
     */ constructor(bucket, name, options = {}){
        ...
        $fd3965bb0bee5f84$var$_File_instances.add(this);
        this.bucket = bucket;
     ...
     */ copy(destination, optionsOrCallback, callback) {
        var _a, _b;
        const noDestinationError = new Error($fd3965bb0bee5f84$var$FileExceptionMessages.DESTINATION_NO_NAME);
        ...
        callback = callback || $f9fHL.util.noop;
        let destBucket;
        let destName;
        let newFile;
        if (typeof destination === 'string') {
            const parsedDestination = $fd3965bb0bee5f84$var$GS_URL_REGEXP.exec(destination);
        ...
        } else if (destination instanceof $uE4AQ.Bucket) {
            destBucket = destination;
            destName = this.name;
        } else if (destination instanceof $fd3965bb0bee5f84$var$File) {
     ...
     */ createReadStream(options = {}) {
        ...
        const throughStream = new $dY7Uc.PassThroughShim();
        let crc32c = true;
        let md5 = false;
        ...
        if (rangeRequest) {
            if (typeof options.validation === 'string' || options.validation === true) throw new Error($fd3965bb0bee5f84$var$FileExceptionMessages.INVALID_VALIDATION_FILE_RANGE);
        ...
        const onResponse = (err, _body, rawResponseStream)=>{
            ...
            if (shouldRunValidation) {
                ...
                validateStream = new $e86cad2b7cb426a1$exports.HashStreamValidator({
                    crc32c: crc32c,
                    md5: md5,
            ...
            if (md5 && !hashes.md5) {
                const hashError = new $fd3965bb0bee5f84$var$RequestError($fd3965bb0bee5f84$var$FileExceptionMessages.MD5_NOT_AVAILABLE);
            ...
            if (isCompressed && options.decompress) transformStreams.push($fd3965bb0bee5f84$var$zlib.createGunzip());
            (0, $cOS4v$stream.pipeline)(rawResponseStream, ...transformStreams, throughStream, onComplete);
        };
        ...
        const makeRequest = ()=>{
            ...
            if (options[$fJ9ES.GCCL_GCS_CMD_KEY]) reqOpts[$fJ9ES.GCCL_GCS_CMD_KEY] = options[$fJ9ES.GCCL_GCS_CMD_KEY];
            this.requestStream(reqOpts).on('error', (err)=>{
                throughStream.destroy(err);
            }).on('response', (res)=>{
                throughStream.emit('response', res);
                $f9fHL.util.handleResp(null, res, null, onResponse);
            }).resume();
        };
     ...
     */ createResumableUpload(optionsOrCallback, callback) {
        ...
        $fd3965bb0bee5f84$var$resumableUpload.createURI({
            ...
            [$fJ9ES.GCCL_GCS_CMD_KEY]: options[$fJ9ES.GCCL_GCS_CMD_KEY]
        }, callback);
        this.storage.retryOptions.autoRetry = this.instanceRetryValue;
    }
    /**
    ...
    createWriteStream(options = {}) {
        ...
        if (!options.metadata.contentType || options.metadata.contentType === 'auto') {
            const detectedContentType = $fd3965bb0bee5f84$var$mime_1.default.getType(this.name);
            if (detectedContentType) options.metadata.contentType = detectedContentType;
        }
        let gzip = options.gzip;
        if (gzip === 'auto') gzip = $fd3965bb0bee5f84$var$COMPRESSIBLE_MIME_REGEX.test(options.metadata.contentType || '');
        ...
        if (options.offset) {
            if (md5) throw new RangeError($fd3965bb0bee5f84$var$FileExceptionMessages.MD5_RESUMED_UPLOAD);
            if (crc32c && !options.isPartialUpload && !options.resumeCRC32C) throw new RangeError($fd3965bb0bee5f84$var$FileExceptionMessages.MISSING_RESUME_CRC32C_FINAL_UPLOAD);
        }
        /**
        ...
        const writeStream = new $cOS4v$stream.Writable({
            final (cb) {
        ...
        const transformStreams = [];
        if (gzip) transformStreams.push($fd3965bb0bee5f84$var$zlib.createGzip());
        const emitStream = new $dY7Uc.PassThroughShim();
        let hashCalculatingStream = null;
        if (crc32c || md5) {
            const crc32cInstance = options.resumeCRC32C ? $47884115a02b0acf$exports.CRC32C.from(options.resumeCRC32C) : undefined;
            hashCalculatingStream = new $e86cad2b7cb426a1$exports.HashStreamValidator({
                crc32c: crc32c,
        ...
        const fileWriteStream = (0, $fd3965bb0bee5f84$var$duplexify_1.default)();
        ...
        writeStream.once('writing', ()=>{
            ...
            (0, $cOS4v$stream.pipeline)(emitStream, ...transformStreams, fileWriteStream, async (e)=>{
                ...
                try {
                    ...
                    if (hashCalculatingStream && !metadataNotReady) await $fd3965bb0bee5f84$var$__classPrivateFieldGet(this, $fd3965bb0bee5f84$var$_File_instances, "m", $fd3965bb0bee5f84$var$_File_validateIntegrity).call(this, hashCalculatingStream, {
                        crc32c: crc32c,
                        md5: md5
                    });
                    pipelineCallback();
    ...
    delete(optionsOrCallback, cb) {
        ...
        this.disableAutoRetryConditionallyIdempotent_(this.methods.delete, $uE4AQ.AvailableServiceObjectMethods.delete, options);
     ...
     */ download(optionsOrCallback, cb) {
        ...
        if (destination) fileStream.on('error', callback).once('data', (data)=>{
            ...
            const writable = $fd3965bb0bee5f84$var$fs.createWriteStream(destination);
            writable.write(data);
            ...
            if (!receivedData) {
                ...
                try {
                    $fd3965bb0bee5f84$var$fs.writeFileSync(destination, data);
                    callback(null, data);
                } catch (e) {
                    callback(e, data);
                }
     ...
     */ setEncryptionKey(encryptionKey) {
        ...
        this.encryptionKeyHash = $fd3965bb0bee5f84$var$crypto.createHash('sha256')// eslint-disable-next-line @typescript-eslint/no-explicit-any
     ...
     */ static from(publicUrlOrGsUrl, storageInstance, options) {
        const gsMatches = [
            ...publicUrlOrGsUrl.matchAll($fd3965bb0bee5f84$var$GS_UTIL_URL_REGEX)
        ];
        const httpsMatches = [
            ...publicUrlOrGsUrl.matchAll($fd3965bb0bee5f84$var$HTTPS_PUBLIC_URL_REGEX)
        ];
        if (gsMatches.length > 0) {
            const bucket = new $uE4AQ.Bucket(storageInstance, gsMatches[0][2]);
            return new $fd3965bb0bee5f84$var$File(bucket, gsMatches[0][3], options);
        } else if (httpsMatches.length > 0) {
            const bucket = new $uE4AQ.Bucket(storageInstance, httpsMatches[0][3]);
            return new $fd3965bb0bee5f84$var$File(bucket, httpsMatches[0][4], options);
     ...
     */ getExpirationDate(callback) {
        this.getMetadata((err, metadata, apiResponse)=>{
            ...
            if (!metadata.retentionExpirationTime) {
                const error = new Error($fd3965bb0bee5f84$var$FileExceptionMessages.EXPIRATION_TIME_NA);
     ...
     */ generateSignedPostPolicyV2(optionsOrCallback, cb) {
        const args = (0, $dY7Uc.normalize)(optionsOrCallback, cb);
        let options = args.options;
        const callback = args.callback;
        const expires = new Date(options.expires);
        if (isNaN(expires.getTime())) throw new Error($cZVWD.ExceptionMessages.EXPIRATION_DATE_INVALID);
        if (expires.valueOf() < Date.now()) throw new Error($cZVWD.ExceptionMessages.EXPIRATION_DATE_PAST);
        ...
        if (Array.isArray(options.equals)) {
            ...
            options.equals.forEach((condition)=>{
                if (!Array.isArray(condition) || condition.length !== 2) throw new Error($fd3965bb0bee5f84$var$FileExceptionMessages.EQUALS_CONDITION_TWO_ELEMENTS);
                conditions.push([
                    'eq',
                    condition[0],
                    condition[1]
        ...
        if (Array.isArray(options.startsWith)) {
            ...
            options.startsWith.forEach((condition)=>{
                if (!Array.isArray(condition) || condition.length !== 2) throw new Error($fd3965bb0bee5f84$var$FileExceptionMessages.STARTS_WITH_TWO_ELEMENTS);
                conditions.push([
                    'starts-with',
                    condition[0],
                    condition[1]
        ...
        if (options.contentLengthRange) {
            ...
            if (typeof min !== 'number' || typeof max !== 'number') throw new Error($fd3965bb0bee5f84$var$FileExceptionMessages.CONTENT_LENGTH_RANGE_MIN_MAX);
            conditions.push([
        ...
        this.storage.authClient.sign(policyBase64, options.signingEndpoint).then((signature)=>{
            ...
            callback(new $3642efee3bcb3705$exports.SigningError(err.message));
        });
    }
    /**
     ...
     */ generateSignedPostPolicyV4(optionsOrCallback, cb) {
        ...
        if (isNaN(expires.getTime())) throw new Error($cZVWD.ExceptionMessages.EXPIRATION_DATE_INVALID);
        if (expires.valueOf() < Date.now()) throw new Error($cZVWD.ExceptionMessages.EXPIRATION_DATE_PAST);
        if (expires.valueOf() - Date.now() > $fd3965bb0bee5f84$var$SEVEN_DAYS * 1000) throw new Error(`Max allowed expiration is seven days (${$fd3965bb0bee5f84$var$SEVEN_DAYS} seconds).`);
        options = Object.assign({}, options);
        let fields = Object.assign({}, options.fields);
        const now = new Date();
        const nowISO = (0, $dY7Uc.formatAsUTCISO)(now, true);
        const todayISO = (0, $dY7Uc.formatAsUTCISO)(now);
        const sign = async ()=>{
            ...
            const expiration = (0, $dY7Uc.formatAsUTCISO)(expires, true, '-', ':');
            const policy = {
                conditions: conditions,
                expiration: expiration
            };
            const policyString = (0, $dY7Uc.unicodeJSONStringify)(policy);
            const policyBase64 = Buffer.from(policyString).toString('base64');
            try {
                ...
                throw new $3642efee3bcb3705$exports.SigningError(err.message);
            }
        };
     ...
     */ getSignedUrl(cfg, callback) {
        const method = $fd3965bb0bee5f84$var$ActionToHTTPMethod[cfg.action];
        const extensionHeaders = (0, $dY7Uc.objectKeyToLowercase)(cfg.extensionHeaders || {});
        ...
        if (!this.signer) this.signer = new $3642efee3bcb3705$exports.URLSigner(this.storage.authClient, this.bucket, this, this.storage);
     ...
     */ save(data, optionsOrCallback, callback) {
        ...
        const returnValue = (0, $fd3965bb0bee5f84$var$async_retry_1.default)(async (bail)=>{
            return new Promise((resolve, reject)=>{
                ...
                else (0, $cOS4v$stream.pipeline)(data, writable, (err)=>{
                    if (err) {
    ...
    setMetadata(metadata, optionsOrCallback, cb) {
        ...
        const options = typeof optionsOrCallback === 'object' ? optionsOrCallback : {};
        cb = typeof optionsOrCallback === 'function' ? optionsOrCallback : cb;
        this.disableAutoRetryConditionallyIdempotent_(this.methods.setMetadata, $uE4AQ.AvailableServiceObjectMethods.setMetadata, options);
     ...
     */ startResumableUpload_(dup, options = {}) {
        ...
        let uploadStream;
        try {
            uploadStream = $fd3965bb0bee5f84$var$resumableUpload.upload(cfg);
        } catch (error) {
            dup.destroy(error);
            this.storage.retryOptions.autoRetry = this.instanceRetryValue;
            return;
     ...
     */ startSimpleUpload_(dup, options = {}) {
        ...
        $f9fHL.util.makeWritableStream(dup, {
...
module.exports.File = $fd3965bb0bee5f84$var$File;
$fd3965bb0bee5f84$var$_File_instances = new WeakSet(), $fd3965bb0bee5f84$var$_File_validateIntegrity = /**
 *
    ...
    if (dataMismatch) {
        ...
        try {
            ...
            if (verify.md5 && !metadata.md5Hash) {
                ...
                message = $fd3965bb0bee5f84$var$FileExceptionMessages.MD5_NOT_AVAILABLE;
            } else {
                code = 'FILE_NO_UPLOAD';
                message = $fd3965bb0bee5f84$var$FileExceptionMessages.UPLOAD_MISMATCH;
            }
        } catch (e) {
            const error = e;
            code = 'FILE_NO_UPLOAD_DELETE';
            message = `${$fd3965bb0bee5f84$var$FileExceptionMessages.UPLOAD_MISMATCH_DELETE_FAIL}${error.message}`;
            errors.push(error);
        }
        const error = new $fd3965bb0bee5f84$var$RequestError(message);
        error.code = code;
        error.errors = errors;
        throw error;
    }
 ...
 */ (0, $e4oRo.promisifyAll)($fd3965bb0bee5f84$var$File, {
    exclude: [
        'cloudStorageURI',
        'publicUrl',
        'request',
...
//# sourceMappingURL=file.253e2c46.js.map
