...
module.exports.getRetryConfig = $3c6a4ae1699b6150$var$getRetryConfig;
async function $3c6a4ae1699b6150$var$getRetryConfig(err) {
    let config = $3c6a4ae1699b6150$var$getConfig(err);
    if (!err || !err.config || !config && !err.config.retry) return {
        shouldRetry: false
    };
    config = config || {};
    ...
    const shouldRetryFn = config.shouldRetry || $3c6a4ae1699b6150$var$shouldRetryRequest;
    if (!await shouldRetryFn(err)) return {
        shouldRetry: false,
        config: err.config
    };
    const delay = $3c6a4ae1699b6150$var$getNextRetryDelay(config);
 ...
 */ function $3c6a4ae1699b6150$var$shouldRetryRequest(err) {
    var _a;
    const config = $3c6a4ae1699b6150$var$getConfig(err);
 ...
 */ function $3c6a4ae1699b6150$var$getConfig(err) {
 ...
 */ function $3c6a4ae1699b6150$var$getNextRetryDelay(config) {
    var _a;
...
//# sourceMappingURL=retry.475c0efb.js.map
